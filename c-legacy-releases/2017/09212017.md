...
* Adição de mova documentação, [Políticas de segurança de conteúdo e serviço da Experience Cloud ID](https://marketing.adobe.com/resources/help/pt_BR/mcvid/?f=mcvid-csp.html), que explica como adicionar chamadas para domínios da Adobe usados pelo serviço de ID à lista de permissões.
...
* Correção de um erro que impedia que o [Audience Lab](https://marketing.adobe.com/resources/help/en_US/aam/?f=audience-lab.html) fosse carregado em tempo hábil. (AAM-32249)
