...
<table id="table_0225913B8D5D4B52982ED2E7F2095EEE"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Quebre os silos e aproveite todos os seus ‪ de dados externos em ‪ Adobe Campaign em tempo real com os conectores de Federated Data Acces ‪, agora também compatíveis com SAP HANA. A ‪ de acesso a dados de ‪ federados permite que os usuários conectem vários bancos de dados ‪ externos diferentes ‪ com o Adobe Campaign. Dados do Query em tempo real de qualquer fonte sem importar ‪ conjunto de dados ‪ ou armazená-los na plataforma do Adobe Campaign. </p> </td> 
  </tr> 
  <tr> 
