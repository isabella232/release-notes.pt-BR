...
* Nova documentação adicionada, [Políticas de segurança de conteúdo e o serviço da Marketing Cloud ID](https://docs.adobe.com/content/help/en/id-service/using/reference/csp.html), que explica como incluir chamadas na lista de permissões para domínios do Adobe usados pelo serviço da ID.
...
O Salesforce recentemente descontinuou a integração do ExactTarget Data Connector. Por causa desta decisão, o assistente ExactTarget não está mais acessível na interface dos Data Connectors para novas implementações.
...
* Correção de um erro que impedia o [Audience Lab](https://marketing.adobe.com/resources/help/en_US/aam/audience-lab.html) de carregar em tempo hábil. (AAM-32249)
