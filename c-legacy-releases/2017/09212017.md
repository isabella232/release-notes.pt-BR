...
Consulte a documentação de produto dos [Serviços da Marketing Cloud ID](https://marketing.adobe.com/resources/help/pt_BR/mcvid/).
...
Os clientes do Analytics podem implementar integrações personalizadas para o ExactTarget usando recursos e APIs padrão do Analytics, incluindo Classificações, Fontes de dados, Regras de processamento e exportações do Data Warehouse. Os envolvimentos com a equipe de consultoria da Adobe podem ser considerados conforme necessário.
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>As dimensões baseadas no carimbo de data e hora foram adicionadas prontas para uso na Analysis Workspace. As dimensões incluem: </p> 
  ...
  <tr> 
   <td colname="col01"> </td> 
   <td colname="col1"> </td> 
   <td colname="col2"> <p> A Adobe Analytics Cloud agora pode rastrear o desempenho de assistentes inteligentes habilitados para voz como a Amazon Alexa, o Google Assistant, o Microsoft Cortana e a Apple Siri. </p> <p>Consulte as <a href="https://marketing.adobe.com/resources/help/en_US/reference/voice-analytics-faq.html" format="html" scope="external">Perguntas frequentes </a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7FBF4B0EBC384CCBA1640F06FA379EAA"> 
      <li id="li_EB0401D8344340209AF1AFEABE440A34"> Correção de um problema que fazia com que os segmentos que usavam "java_enabled" não fossem tratados corretamente para trabalhos do Data Warehouse. (AN-147372) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_7B50E9D0E6D340C1A589CE0713767285"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Com esse aprimoramento de Subscrição em massa, agora você pode armazenar informações de subscrição (origem e data) diretamente no banco de dados do Adobe Campaign Standard por meio da atividade do Subscrição no serviço em um fluxo de trabalho. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_0225913B8D5D4B52982ED2E7F2095EEE"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> Agora é possível enviar dados comportamentais do Adobe Campaign Standard para o Adobe Campaign v7, permitindo que profissionais de marketing e analistas de dados criem uma visualização de 360° de campanhas de marketing; criar audiências e segmentos avançados que incorporem dados comportamentais ACS; e medir com mais eficácia o ROI das atividades de marketing. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> Conector SAP HANA </p> </td> 
   <td colname="col2"> <p>Quebre os silos e aproveite todos os seus ‪ de dados externos em ‪ Adobe Campaign em tempo real com os conectores de Federated Data Acces ‪, agora também compatíveis com SAP HANA. A ‪ de acesso aos dados de ‪ federados permite que os usuários conectem vários bancos de dados ‪ externos diferentes ‪ com o Adobe Campaign. Dados do Query em tempo real de qualquer fonte sem importar ‪ conjunto de dados ‪ ou armazená-los na plataforma do Adobe Campaign. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> Conector Hadoop via HiveSQL </p> </td> 
   <td colname="col2"> <p>Quando se trata de lidar com grandes conjuntos de dados, o Hadoop tem a vantagem sobre os sistemas de gerenciamento de banco de dados relacionais e seu valor para qualquer empresa continuará a aumentar à medida que os dados não estruturados crescem. O Adobe Campaign pode aproveitar o poder do Hadoop através do Hadoop Connector via HiveSQL, onde os clientes podem acessar schemas diretamente da interface do usuário do Adobe Campaign para criar audiências avançadas e altamente segmentadas de maneira rápida, flexível e escalonável. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_536113431FD540D18F1CD8FDBD06FDAC"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col3"> <p>Esta versão fornece novos recursos de automação e delivery para clientes do Dynamic Media e é a primeira versão direcionada para clientes existentes do Dynamic Media Classic (S7)-AEM para transição para o Dynamic Media. </p> <p> 
  ...
  <tr> 
   <td colname="col2"> <p> Editor de regras de formulários </p> </td> 
   <td colname="col3"> <p>O Serviço de configuração de formulários adaptativos permite limitar o acesso do editor de regras aos usuários com base em sua função ou função. </p> <p>Consulte <a href="https://helpx.adobe.com/aem-forms/6-3/rule-editor-access-user-groups.html" format="https" scope="external">Conceder acesso ao editor de regras para grupos de usuários selecionados </a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p>Ajuste do desempenho dos formulários </p> </td> 
   <td colname="col3"> <p>Você pode excluir arquivos e pastas do AEM Forms do aplicativo de varredura de vírus ao acessar para melhorar o desempenho do servidor Forms. </p> <p>Consulte <a href="https://helpx.adobe.com/aem-forms/6-3/performance-tuning-aem-forms.html" format="https" scope="external">Ajuste de desempenho do servidor AEM Forms </a>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>O AEM Forms fornece um pacote de configuração que você pode usar para integrar rapidamente o Dynamics 365 com o Forms. O pacote inclui uma configuração de serviço em nuvem e um modelo de dados de formulário com entidades e serviços pré-configurados do Dynamics 365. </p> <p>Consulte <a href="https://helpx.adobe.com/aem-forms/6-3/ms-dynamics-odata-configuration.html" format="https" scope="external">Configuração do Microsoft Dynamics 365 OData </a>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>O novo tutorial de Introdução do desenvolvedor 6.3 está disponível com base nas seguintes tecnologias AEM mais recentes: </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Quando um componente em uma página da Web é renderizado, você pode gerar um elemento HTML, envolvendo o componente renderizado dentro dele mesmo. Para desenvolvedores, a lógica clara e simples do AEM oferta para controlar as tags de decoração que envolvem componentes incluídos. </p> <p>Consulte <a href="https://docs.adobe.com/docs/en/aem/6-3/develop/components/decoration-tag.html" format="https" scope="external">Tag de decoração </a>. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_39E9A53B4A1A465589547638A29CB34C"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> (campanhas do Bing Ads com públicos alvos de remarketing) A Advertising Cloud oferece suporte ao seguinte: </p> 
