...
Consulte [Android SDK 4.x para soluções da Experience Cloud](https://marketing.adobe.com/resources/help/pt_BR/mobile/android/) e [iOS SDK 4.x para soluções da Experience Cloud](https://marketing.adobe.com/resources/help/pt_BR/mobile/ios/) para obter a documentação do SDK. Para visualizar as notas de versão de versões anteriores, abra as *Notas de versões anteriores* no painel à esquerda.
...
<table id="table_DAFBC066DDA74493BDC42AB40E85E04C"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Anteriormente, se você fizesse logon por meio da Experience Cloud e navegasse para o Analytics, não era possível usar o recurso “obter link do projeto” na Analysis Workspace. Corrigimos esse erro. Ainda é necessário salvar o projeto antes de que essa opção seja disponibilizada. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"></td> 
...
* Aprimoramentos às [!UICONTROL Regras de mesclagem de perfil]: todos os dispositivos qualificados para um segmento em tempo real usando uma Regra de mesclagem de perfil criada com a opção gráfico do dispositivo (Cooperativa de gráficos de dispositivo da Adobe ou um gráfico do dispositivo externo) não serão incluídos na contagem da população total do segmento. Além disso, as IDs desses dispositivos qualificados também serão enviadas a qualquer destino em lote configurado para esse segmento. Consulte [Perguntas frequentes sobre Regras de mesclagem de perfil e Gráfico de dispositiv](https://marketing.adobe.com/resources/help/pt_BR/aam/profile-merge-faq.html) e [Dados de preenchimento de características e segmentos no Construtor de segmento](https://marketing.adobe.com/resources/help/pt_BR/aam/segment-builder-data.html). (AAM-27726)
* Arquivos CSV de dados de sequência de caracteres delimitada por aspas para [!UICONTROL Relatórios de sobreposição]. Consulte [Arquivos CSV para relatórios de sobreposição](https://marketing.adobe.com/resources/help/pt_BR/aam/?f=overlap-csv-files.html).
