...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>(Portfólios com a configuração para "Modelo e otimizar pesquisa em uma base intradiária") A Advertising Cloud agora leva os dados da receita em consideração ao alterar lances e orçamentos de campanha para atender às tendências intradiárias. Anteriormente, somente os dados de cliques eram considerados. </p> <p>Agora, as ofertas são aumentadas durante as partes do dia de maior desempenho. </p> </td> 
  </tr> 
  <tr> 
