...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>As opções de «Otimizar ajustes de lances automaticamente» permitem que a Advertising Cloud altere automaticamente as configurações de ajuste de lances para grupos de anúncios no portfólio quando o portfólio estiver otimizado para otimizar o desempenho. A Advertising Cloud pode otimizar ajustes de lances para Google, Bing e Yahoo! segmentos de tablets e computadores; segmentos de RLSAs do Google; e segmentos de localização do Google. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"></td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>(Contas do Bing Merchant Center com URLs finais) Um campo “Modelo de rastreamento” é disponibilizado para grupos de produtos em modelos e em bulksheets do Bing Shopping. </p> <p>No rastreamento de conversão da Marketing Cloud, você não precisa inserir um valor se tiver um modelo de rastreamento no nível da conta, campanha ou grupo de anúncios. </p> </td> 
  </tr> 
  <tr> 
