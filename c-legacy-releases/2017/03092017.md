...
* Os métodos da API da pasta e características foram migrados para o Swagger. Consulte [Migração do código de API do Audience Manager](https://marketing.adobe.com/resources/help/pt_BR/aam/c_api_swagger.html). (AAM-28221 e AAM-27133)
...
Esta versão corrige um erro que evitava que ` GA.submitUniversalAnalytics` enviasse dados aos servidores de coleta de dados. Consulte [GA.submitUniversalAnalytics](https://marketing.adobe.com/resources/help/pt_BR/aam/dil-google-universal-analytics.html). (MCID-354)

**Documentação nova e revisada**

**Novo menu**

[Uso da pré-busca DNS com diferentes Soluções e Serviços da Experience Cloud](https://marketing.adobe.com/resources/help/pt_BR/mcloud/dns-prefetch.html) descreve como você pode usar a pré-busca DNS para reduzir o tempo de carregamento de página.

**Revisado**

* [Códigos de erro DCS, mensagens e exemplos](https://marketing.adobe.com/resources/help/pt_BR/aam/dcs_error_codes.html) inclui avisos de integração
* [Nome de arquivo de dados de saída](https://marketing.adobe.com/resources/help/pt_BR/aam/c_name_reqs_outbound.html) inclui o parâmetro opcional` PID-ALIAS`.
* [Exibição do resumo de segmento](https://marketing.adobe.com/resources/help/pt_BR/aam/c_segment_summary.html) inclui intervalos de retrospectiva de relatório.
* [DIL Create](https://marketing.adobe.com/resources/help/en_US/aam/r_dil_create.html) inclui novas informações sobre a propriedade` containerNSID`.
* [Métricas de público-alvo endereçável](https://marketing.adobe.com/resources/help/pt_BR/aam/addressable-audience-metrics.html) inclui definições e organização de conteúdo revisadas.
...
* [Página inicial de Ajuda do Adobe Experience Manager](https://docs.adobe.com)
