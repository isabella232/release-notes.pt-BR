...
>[!IMPORTANT]
>
>O Launch está sendo lançado de forma incremental para os clientes da Adobe Experience Cloud. Se você desejar obter acesso antecipado, insira as informações necessárias no [Formulário de lançamento do Launch](https://adobe.allegiancetech.com/cgi-bin/qwebcorporate.dll?WVFJ3K).
...
* A partir de março de 2018, uma Adobe ID será necessária para fazer logon porque o processo de logon do Adobe Analytics não será mais suportado. [Mais…](https://marketing.adobe.com/resources/help/pt_BR/mobile/gs_signin.html).
