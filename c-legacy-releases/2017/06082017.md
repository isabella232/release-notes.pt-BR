...
Novos recursos e correções na Adobe Experience Cloud (anteriormente chamada de Marketing Cloud).
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Na versão 4.13.6, os seguintes aprimoramentos de SDK foram feitos para iOS e Android: </p> 
    <ul id="ul_B4DC25FD25B745A6BB39B8965D22ECAD"> 
     <li id="li_17282AB9A66A4484917CB9B703AA6DE8">No Serviço da Marketing Cloud ID, as APIs <span class="varname">syncIdentifiers</span> agora permitem a substituição de um valor atual para uma ID. </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_DAB0360A2EB74CE7B7D9D20D19C3F6AE"> 
     ...
     <li id="li_B64C547F580041AFBF081AFF40C58BCF">Correção de um problema que causava um erro de criação de segmento ao marcar “Transformar em público da Marketing Cloud.” (AN-142218, AN-143300) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7CC12EBCEBD943B1B329594D13DCF66C"> 
      ...
      <li id="li_A672990027F54771A41AFEABCFC8E243">Correção de um problema no qual a opção “Vincular a este relatório” estava indisponível quando o usuário fazia logon por meio da Marketing Cloud. (AN-118492) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7C375006CB8A4723B3FC07A8FF7FF6E6"> 
      ...
      <li id="li_BC279F05086144CE8BE0A9A60C5FE865">Correção de um problema que impedia o login no Report Builder usando o login por SSO da Marketing Cloud. (AN-138557) </li> 
