...
Learn more about the [Adobe Experience Cloud](https://www.adobe.com/br/experience-cloud.html) announcement at the 2017 Adobe Summit.
...
As fórmulas de caso de uso mostram como implementar e implantar workflows e integrações entre soluções. Mais vídeos práticos e fórmulas de autoajuda estarão disponíveis em breve.
...
<table id="table_7888822703184513A437A3CEFC599CAA"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> No Analysis Workspace, você pode aplicar a métrica de Pessoas para identificar visitantes em seus dispositivos. </p> <p>Saiba mais sobre como obter acesso à métrica de Pessoas na documentação do <a href="https://marketing.adobe.com/resources/help/pt_BR/mcdc/mcdc-people.html" format="html" scope="external">Adobe Experience Cloud Device Co-op</a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"></td> 
   <td colname="col1"> <p>Modelo de Pessoas </p> </td> 
   <td colname="col2"> <p>Observação: o modelo de Pessoas e a respectiva métrica de Pessoas estão disponíveis para uso somente como parte do <a href="https://marketing.adobe.com/resources/help/pt_BR/mcdc/mcdc-people.html" format="html" scope="external">Adobe Experience Cloud Device Co-op </a>. </p> <p>O modelo é baseado na métrica de Pessoas, que é uma versão deduplicada da métrica de Visitantes únicos. A métrica de Pessoas fornece uma medida da frequência com que os consumidores que usam vários dispositivos interagem com sua marca. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"></td> 
   <td colname="col1"> <p>Funcionalidade de desfazer e refazer aprimorada </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Esta versão foi lançada em 10 de abril de 2017. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"></td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Esta versão foi lançada em 20 de março de 2017. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"></td> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_8A8B70BF95EE4E9D895043277974ED74"> 
     ...
     <li id="li_56DAE7B163764192B2731FA1D45D499D">Correção de um problema com alertas inteligentes que não acionavam notificações por email ou telefone. (AN-135483) </li> 
     ...
     <li id="li_BBB9F3D8177A4FB1B0E66FA053E02F79">Correção de um problema que resultava em um erro somente no idioma japonês ao tentar criar segmentos. (AN-139916) </li> 
     <li id="li_9424DBAF511C4273AC52EF4016697E3C">Correção de um problema que disparava alertas incorretamente devido ao fuso horário não estar atualizado. (AN-134390) </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_9DD79A9FD0014CA285E372FAD2BF9FE2"> 
     ...
     <li id="li_3067A6CC3B6544DDA2D0307E68EFC501">Correção de um problema que ocorria ao detalhar uma métrica de % por uma dimensão. A métrica para a dimensão associada resultava em um decimal em vez de uma porcentagem. (AN-141122) </li> 
     ...
     <li id="li_65CC26F8EA214077B10BE18906958E02">Correção de um problema que fazia com que gráficos de linha recarregassem e exibissem informações ilegíveis quando vinculados a células de detalhamento. (AN-140057) </li> 
     ...
     <li id="li_35D4F40C41414D5F82398C3CFA54EB1D">Correção de um problema em que as métricas calculadas formatadas no tempo não exibiam as informações corretas. (AN-139688) </li> 
     ...
     <li id="li_DCE679F7FEDA437DBA0EB4C553BDE61D">Foi corrigido o problema que ocorria quando, depois de tendenciar uma seleção, você alterava a tabela oculta gerada automaticamente em <span class="uicontrol">Exibir fonte de dados </span>. As alterações nessa tabela não foram salvas. (AN-139341, AN-136031) </li> 
     ...
     <li id="li_7C5BD4DD52204E589364EB2BBE904814">Correção de um problema que fazia com que qualquer alteração em um espaço de trabalho agendado disparasse o envio de emails para recipient. (AN-131167) </li> 
     <li id="li_B7D4FB84083F43949039D8E714D3D7BC">Correção de um problema em que a moeda incorreta era exibida para um conjunto de relatórios. (AN-126230) </li> 
     <li id="li_F7D90FC5E62F4FCBB3FAFFC23637B3EA">Correção de um problema que impedia que relatórios .pdf ou .csv fossem compartilhados por email. (AN-125437) </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7CC12EBCEBD943B1B329594D13DCF66C"> 
      <li id="li_09FB915FD48F476BAEC68102C2C56D40">Correção de um problema com erros de Página não encontrada ao compartilhar links para um relatório e alterar o tipo de relatório para Tendência/Classificado. (AN-133515) </li> 
      <li id="li_22A36506B82A4404B03B00F8D9D7CE92">Correção de um problema ao tentar criar um novo conjunto de relatórios duplicando configurações de um conjunto de relatórios existente. (AN-137797) </li> 
      <li id="li_2E955336BE30493E894DE94D7EE6BD6D">Correção de um problema em que os conjuntos de relatórios de rollup não manipulavam segmentos. Ao avançar, as solicitações de rollup ignorarão os segmentos. (AN-137333) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_BB3A5CC8E3D84478B8358145E7CD7CF0"> 
      <li id="li_50F784B717AA4B0EB56823BEE7BDB9F1">Correção de um problema com intervalos de datas que ocorria ao usar a dimensão Dia. (AN-139559) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_BCA85EDE14C2445C8C10BDD77ED342A6"> 
      <li id="li_FD1E9A3A72564BE293BBAF1BD13A0339">Correção de um problema com rótulos de conjunto de relatórios atribuídos a solicitações que não eram atualizadas. (AN-139276) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_0B70B5AEE69143D9A5FFA290478E845D"> 
      <li id="li_4188BBF771B4437AA5FF3240C46FB1D3">Correção de um problema que ocorria quando, por exemplo, nenhum clique em links era coletado para um intervalo de datas selecionado. Isso fazia com que a barra de ferramentas do Activity Map ficasse travada. (AN-140163, AN-140119, AN-136186) </li> 
      ...
      <li id="li_AB99880B33E7451BA5DB26F46DA816BF">Foi corrigido o problema em que, em algumas páginas da Web, o tempo de carregamento de tags do Analytics no carregamento da página provocava uma condição de corrida que impedia o <span class="keyword">Activity Map</span> de iniciar adequadamente após o logon. Esse problema impedia que o aplicativo exibisse sobreposições, a menos que o usuário atualizasse a página da Web após o logon. (AN-139325) </li> 
      <li id="li_A4A1CD597F5A49A797C4CA4513598E4D">Correção de um problema que fazia com que sobreposições de bolha não fossem posicionadas corretamente. (AN-131969, AN-124094) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Análise de vídeo </p> </td> 
   <td colname="col2"> <p>Além das regras de processamento existentes, uma sessão de vídeo será fechada mesmo se: </p> <p> 
     <ul id="ul_66AFFF96E4A546F1B59A50567E1651F3"> 
      <li id="li_6A990D453B1640F8A28D3B1CA9EFC926">Não há dados de visitante disponíveis (MCID ou ID de Visitante). <p>A alternativa ao mecanismo <span class="codeph">s_vi</span>. </p></li> 
     ...
     </ul> </p> <p>Essas atualizações estão no serviço de processamento do Video Analytics e não exigem alterações na implementação do player ou no relatórios do Analytics. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_A50E675542D94AB3B1206ECAC3C39BC8"> 
      <li id="li_A5C2F2B605694CE6B31BF547D7E15462"> Correção de problemas de segmento: 
       <ul id="ul_8FA1BE67BC124B4CBE56327F16C11BA6"> 
        <li id="li_4595D1ABE37C48B0976B3232CC4D6ADB">Espaço em branco cortado das sequências de regras do segmento (AN-140432). </li> 
        <li id="li_2DB5D7A7EE77439AB22DACB02FAC8038">Adição de aparamento ausente dos operadores "NOT CONTAINS ONE/ALL OF". </li> 
       </ul></li> 
      <li id="li_94115FD800EF4DF891D0AF616CE8AD83">Corrigido o bug na filtragem de segmentos de visita/visitante aninhados (AN-116275). </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <b> <span class="keyword"> AppMeasurement</span> para JavaScript</b> </p> <p>Versão 2.1.0 </p> 
    <ul id="ul_80BCF27E492246AD883ABD5B417004E1"> 
     ...
     <li id="li_CB1E4CAC306B473FBFC2E50B440568B1"> API de Visitante 2.1.0 reincluída. (AN-140873) </li> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> Obtenha dados de características e segmentos reais e estimados à medida que você constrói segmentos. Leia mais sobre o recurso na documentação do <a href="https://docs.adobe.com/content/help/pt-BR/audience-manager/user-guide/features/segments/segment-builder-data.html" format="https" scope="external">Audience Manager</a>. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Melhorias na pesquisa e filtragem de características </p> </td> 
   <td colname="col2"> <p>Aprimoramos a interface do usuário em busca e filtragem de características. Consulte a documentação do <a href="https://marketing.adobe.com/resources/help/en_US/aam/c_tb_dashboard.html" format="https" scope="external">Painel de traços</a> para obter mais informações. </p> </td> 
  </tr> 
  <tr> 
...
* Correção de um problema em que, para alguns clientes, a string de URL completa não era salva ao mapear um URL para um destino de URL. (AAM-28510)
* Correção de um problema nas Regras de mesclagem de Perfis para usuários RBAC, em que os usuários sem permissões para características de visualização exibiam uma página em branco em vez da mensagem de aviso de que eles não tinham permissões para visualização na página. (AAM-28361)
* Correção de um problema em que, para alguns clientes, a página Lista Características contivesse links quebrados para Fontes de dados. (AAM-29174)
* Aprimoramos o recurso Link do Perfil. The feature now links an [Audience Manager UUID](https://docs.adobe.com/content/help/pt-BR/audience-manager/user-guide/reference/ids-in-aam.html) to another three Audience Manager UUIDs, for a total of 4 Audience Manager UUIDs in a cluster. (AAM-28808)
* Agora nós expomos as IDs de segmento de teste ([SID e csegID](https://docs.adobe.com/content/help/pt-BR/audience-manager/user-guide/reference/ids-in-aam.html)) com um parâmetro de consulta testSegments=true nas APIs a seguir (AAM-27591):
   * ` .../v1/segments`
   * ` .../v1/destinations/<destinationId>/mappings`

* Os métodos de APIs de segmentos foram migrados para o Swagger. See [Audience Manager API Code Migration](https://marketing.adobe.com/resources/help/en_US/aam/c_api_swagger.html). (AAM-28601)
* Foram removidos alguns pequenos erros visuais na Audiência endereçável para destinos DAID. (AAM-28679)
* Correção de um problema na página Administração do usuário em que nenhuma mensagem de erro era exibida quando um cliente tentava criar um novo usuário para uma empresa, com um nome de usuário que já estava sendo usado. (AAM-28945)
...
* Correção de um problema na interface Admin do Audience Manager em que uma ID de usuário final do Audience Marketplace não podia ser adicionada a uma empresa. (AAM-28953)

## [!DNL Social]

**Correções**

* Workflows de publicação: Correção de um problema em que os usuários que ignoravam um fluxo de trabalho de aprovação ainda recebiam notificações de aprovação. Somente os usuários que forem aprovadores em um fluxo de trabalho receberão uma mensagem para aprovar uma publicação.
* Publicar em qualquer lugar: Correção de um problema em que os usuários não eram avisados quando um upload de foto ou vídeo excedia os limites de tamanho da API de determinada plataforma.
* Publicar em qualquer lugar: Corrigido um problema no qual postagens de álbum de fotos direcionadas no Facebook eram postadas sem fotos.
* Calendário do conteúdo: Correção de um problema em que os usuários não conseguiam editar a hora de uma postagem secundária programada.
* Calendário do conteúdo: Corrigido um problema ao publicar vídeos no Twitter, onde emoticons e texto não eram exibidos.
* Relatórios: Correção de um problema que gerava um erro ao baixar o relatório Visão geral da moderação.
* Detalhes da propriedade do Facebook: Correção de um problema com a obtenção de dados de fãs por localização geográfica para propriedades do Facebook.
* Moderação: Correção de um problema em que os usuários não conseguiam gravar comentários de várias linhas para propriedades ou autores.
* Moderação: Correção de um problema em que a página Detalhes do autor não exibia o histórico completo de interações com o autor.
* Propriedades: Correção de um problema em que os usuários não recebiam emails de notificação quando as propriedades se tornavam não autorizadas.
* Tags sociais: Correção de um problema em que algumas tags aplicadas a publicações do LinkedIn não eram exibidas na Análise de publicações.
...
O Adobe lançou um Boletim [de Segurança para Adobe Campaign](https://helpx.adobe.com/security/products/campaign/apsb17-09.html) v6.11 para Windows e Linux.
...
<table id="table_B8FB3E741CFF4C3AA561C191182484ED">
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> Recursos aprimorados da edição de imagens com o Creative SDK </p> </td> 
   <td colname="col2"> <p>Agora você tem acesso a um conjunto completo de recursos capacitados pelo Creative SDK para aprimorar suas imagens diretamente no editor de conteúdo ao editar emails ou landings page. </p> <p> Esses recursos não exigem a aquisição de soluções adicionais de Creative Cloud. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> Notificações por push transacionais </p> </td> 
   <td colname="col2"> <p> O canal do aplicativo móvel foi adicionado aos recursos de mensagens transacionais da Adobe Campaign. Três canais agora são suportados para mensagens transacionais: email, SMS e notificações por push. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> Notificações por push recorrentes </p> </td> 
   <td colname="col2"> <p> Agora você pode usar notificações por push recorrentes em um fluxo de trabalho. As notificações recorrentes permitem que você envie o mesmo delivery de notificação por push do aplicativo móvel várias vezes para o mesmo público alvo ou para uma audiência dinâmica em uma frequência específica (diário, mensal etc.). </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> Conector S3 (Simple Armazenamento Service) da Amazon </p> </td> 
   <td colname="col2"> <p> O conector do Serviço de Armazenamento Simples (S3) da Amazon agora pode ser usado para importar ou exportar dados para a Adobe Campaign. Ele pode ser configurado em uma atividade de workflow. A configuração é feita em uma conta externa. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> Integração Dreamweaver ao vivo </p> </td> 
   <td colname="col2"> <p>A integração entre a Adobe Campaign e a Dreamweaver está em execução. Agora, ele funciona com a última versão oficial do Dreamweaver (17.0.2). </p> <p>Requer a instalação da extensão de Integração do Adobe Campaign pelo <a href="https://adobe.ly/acdw_addon" format="http" scope="external">Adobe Add-ons </a>. </p> <p> Para obter mais informações, assista ao vídeo <a href="https://docs.campaign.adobe.com/doc/standard/en/Videos/ACS_Dreamweaver.mp4" format="mp4" scope="external">Integração do Dreamweaver e do Adobe Campaign Standard</a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_536113431FD540D18F1CD8FDBD06FDAC"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col2"> <p>Pacotes de Correções Cumulativas do AEM Oak </p> </td> 
   <td colname="col3"> <p>Os pacotes de correção cumulativos do Oak AEM mais recentes recomendados estão disponíveis nos seguintes locais: </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p> Em 25 de abril de 2017, das 9h às 10h MST, junte-se ao superusuário da comunidade do AEM Lokesh BS, membro da comunidade do ano de 2015-2016, para uma discussão sobre “Criação de layouts responsivos usando Bootstrap e Angular JS no Experience Manager”. </p> <p>Você aprenderá AEM técnicas de desenvolvimento que podem ser aplicadas aos seus projetos AEM. Lokesh fornecerá demonstrações e responderá suas perguntas. Como um desenvolvedor AEM, esta é uma sessão que você não quer perder. Você pode <a href="https://communities.adobe.com/content/usergenerated/content/cush/en/communities/aem_technologistsdevelopersarchitects/events/_jcr_content/par/calendar/ask_the_aem_communit_7.form.html/content/cush/en/communities/aem_technologistsdevelopersarchitects/events/upcoming-event-detail" format="https" scope="external">confirmar sua presença aqui </a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Uma nova versão do feed de dados reversos do Advertising Cloud para o Analytics melhora significativamente a precisão dos dados. Todos os anunciantes com uma integração do Analytics serão atualizados para o novo feed reverso nas próximas semanas. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Pesquisa </p> </td> 
   <td colname="col2"> <p>Agora você pode criar audiências do Google (listas de remarketing para anúncios de pesquisa) usando listas de email ou segmentos de suas audiências Adobe Experience Cloud existentes: </p> <p> 
     <ul id="ul_9F69C50A39CE45928E98F7AC1015C807"> 
      <li id="li_B56CA061540B4414861918CAFCB81397">listas de e-mail da Adobe Campaign: O seu gerente de conta o ajudará a configurar um fluxo de trabalho para criar e atualizar uma audiência de lista de cliente do Google a partir de uma lista de email dentro da Campanha. </li> 
      <li id="li_FA9DE45045324D5781BAF8FB113E274B">Segmentos do Adobe Audience Manager: (Beta somente para anunciantes incluir na lista de permissões) Do Campanha Beta &amp;gt; Audiência &amp;gt; Audiência, você pode criar uma audiência baseada em tags do site do Google a partir de qualquer um de seus segmentos de Audience Manager que tenham o Advertising Cloud como destino. Isso pode incluir segmentos do Adobe Analytics publicados na Adobe Experience Cloud e segmentos criados no Adobe Experience Cloud usando o serviço principal de Pessoas. A Advertising Cloud enviará automaticamente um URL de rastreamento do Google de volta para os segmentos de Audience Manager para que o Google possa rastrear a audiência. </li> 
     </ul> </p> <p>A Advertising Cloud não armazena dados do cliente de suas listas de e-mail ou segmentos de Audience Manager para criar ou editar uma audiência do Google. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Beta de campanhas de pesquisa </p> </td> 
   <td colname="col2"> <p>(Somente anunciantes beta incluir na lista de permissões) Uma nova interface do usuário do Search Beta estará disponível na semana seguinte ao lançamento, com: </p> <p> 
     <ul id="ul_4D73AB12C2524DD4B0D72AFF1EC5FC0B"> 
      <li id="li_226EDEA6C6404A3B886E7C1E0F25EA77">Novas grades, trilhos esquerdos, filtros, barras de ferramentas e ações em massa. </li> 
      ...
      <li id="li_649DA70ACC7A4A46B2EF91C9C028DE26">Um menu Audiência, com Biblioteca, Públicos alvos e Exclusões. A Biblioteca lista todas as suas audiências do Google (listas de remarketing) e você pode criar audiências do Google usando segmentos da Adobe Audience Manager. Você pode usar qualquer uma das audiências no Google campanha como públicos alvos de nível de grupo de anúncios e exclusões de nível de campanha e grupo de anúncios. </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Gerenciamento de campanhas avançadas de busca (ACM) </p> </td> 
   <td colname="col2"> <p>Os modelos de anúncios de texto do Bing Ads incluem uma nova configuração de idioma em nível de grupo de anúncios. </p> </td> 
  </tr> 
  <tr> 
