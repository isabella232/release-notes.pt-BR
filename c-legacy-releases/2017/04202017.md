  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_0B70B5AEE69143D9A5FFA290478E845D"> 
      <li id="li_4188BBF771B4437AA5FF3240C46FB1D3">Correção de um problema que ocorria quando, por exemplo, nenhum clique em links era coletado para um intervalo de datas selecionado. Isso fazia com que a barra de ferramentas do Activity Map ficasse presa em um estado suspenso. (AN-140163, AN-140119, AN-136186) </li> 
...
* Os métodos de APIs de segmentos foram migrados para o Swagger. Consulte Migração [de código da API do](https://marketing.adobe.com/resources/help/en_US/aam/c_api_swagger.html)Audience Manager. (AAM-28601)
...
* Correção de um problema na interface de administrador do Audience Manager em que uma ID de usuário final do Audience Marketplace não podia ser adicionada a uma empresa. (AAM-28953)
...
A Adobe lançou um Boletim [de segurança para Adobe Campaign](https://helpx.adobe.com/security/products/campaign/apsb17-09.html) v6.11 para Windows e Linux.
...
<table id="table_B8FB3E741CFF4C3AA561C191182484ED">
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Agora você tem acesso a um conjunto completo de recursos capacitados pelo Creative SDK para aprimorar suas imagens diretamente no editor de conteúdo ao editar emails ou landings page. </p> <p> Esses recursos não exigem a aquisição de soluções adicionais da Creative Cloud. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> Notificações por push transacionais </p> </td> 
   <td colname="col2"> <p> O aplicativo móvel foi adicionado aos recursos de mensagens transacionais do Adobe Campaign. Três canais agora são suportados para mensagens transacionais: email, SMS e notificações por push. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> O conector do Amazon Simple Armazenamento Service (S3) agora pode ser usado para importar ou exportar dados para o Adobe Campaign. Ele pode ser configurado em uma atividade de workflow. A configuração é feita em uma conta externa. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> Integração do Dreamweaver ativa </p> </td> 
   <td colname="col2"> <p>A integração entre o Adobe Campaign e o Dreamweaver está agora em execução. Agora funciona com a última versão oficial do Dreamweaver (17.0.2). </p> <p>Requer a instalação da extensão de Integração do Adobe Campaign pelo <a href="https://adobe.ly/acdw_addon" format="http" scope="external">Adobe Add-ons </a>. </p> <p> Para obter mais informações, assista ao vídeo <a href="https://docs.campaign.adobe.com/doc/standard/en/Videos/ACS_Dreamweaver.mp4" format="mp4" scope="external">Integração do Dreamweaver e do Adobe Campaign Standard</a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_536113431FD540D18F1CD8FDBD06FDAC"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Os Pacotes de correção cumulativos do AEM Oak mais recentes recomendados estão disponíveis nos seguintes locais: </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p> Em 25 de abril de 2017, das 9h às 10h MST, junte-se ao superusuário da comunidade do AEM Lokesh BS, membro da comunidade do ano de 2015-2016, para uma discussão sobre “Criação de layouts responsivos usando Bootstrap e Angular JS no Experience Manager”. </p> <p>Você aprenderá técnicas de desenvolvimento do AEM que podem ser aplicadas a seus projetos do AEM. Lokesh fornecerá demonstrações e responderá suas perguntas. Como desenvolvedor do AEM, esta é uma sessão que você não deseja perder. Você pode <a href="https://communities.adobe.com/content/usergenerated/content/cush/en/communities/aem_technologistsdevelopersarchitects/events/_jcr_content/par/calendar/ask_the_aem_communit_7.form.html/content/cush/en/communities/aem_technologistsdevelopersarchitects/events/upcoming-event-detail" format="https" scope="external">confirmar sua presença aqui </a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Agora você pode criar audiências do Google (listas de remarketing para anúncios de pesquisa) usando listas de email ou segmentos de suas audiências existentes da Adobe Experience Cloud: </p> <p> 
     <ul id="ul_9F69C50A39CE45928E98F7AC1015C807"> 
      <li id="li_B56CA061540B4414861918CAFCB81397">listas de e-mail de Adobe Campaign: O seu gerente de conta o ajudará a configurar um fluxo de trabalho para criar e atualizar uma audiência de lista de cliente do Google a partir de uma lista de email dentro da Campanha. </li> 
      <li id="li_FA9DE45045324D5781BAF8FB113E274B">Segmentos do Adobe Audience Manager: (Beta somente para anunciantes permitidos) Do Campanha Beta &amp;gt; Audiência &amp;gt; Audiência, você pode criar uma audiência baseada em tags do site do Google a partir de qualquer segmento do Audience Manager que tenha a Advertising Cloud como destino. Isso pode incluir segmentos do Adobe Analytics publicados na Adobe Experience Cloud e segmentos criados na Adobe Experience Cloud usando o serviço principal de Pessoas. A Advertising Cloud enviará automaticamente um URL de rastreamento do Google de volta para os segmentos do Audience Manager para que o Google possa rastrear a audiência. </li> 
     </ul> </p> <p>A Advertising Cloud não armazena dados do cliente de suas listas de email ou segmentos do Audience Manager usados para criar ou editar uma audiência do Google. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Beta de campanhas de pesquisa </p> </td> 
   <td colname="col2"> <p>(Beta somente para anunciantes permitidos) Uma nova interface do usuário do Search Beta estará disponível na semana seguinte ao lançamento, com: </p> <p> 
     <ul id="ul_4D73AB12C2524DD4B0D72AFF1EC5FC0B"> 
      ...
      <li id="li_649DA70ACC7A4A46B2EF91C9C028DE26">Um menu Audiência, com Biblioteca, Públicos alvos e Exclusões. A Biblioteca lista todas as audiências do Google (listas de remarketing) e você pode criar audiências do Google usando segmentos do Adobe Audience Manager. Você pode usar qualquer uma das audiências no Google campanha como públicos alvos de nível de grupo de anúncios e exclusões de nível de campanha e grupo de anúncios. </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
