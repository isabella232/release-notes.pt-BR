...
Saiba mais sobre o anúncio da [Adobe Experience Cloud](https://www.adobe.com/br/experience-cloud.html) no Adobe Summit 2017.
...
* Aprimoramos o recurso Vínculo de perfil. Agora o recurso vincula um [UUID do Audience Manager](https://marketing.adobe.com/resources/help/pt_BR/aam/ids-in-aam.html) a outros três UUIDs do Audience Manager, para um total de quatro UUIDs do Audience Manager em um cluster. (AAM-28808)
* Agora mostramos as IDs de segmento de teste ( [SID e csegID](https://marketing.adobe.com/resources/help/pt_BR/aam/ids-in-aam.html)) com um parâmetro de consulta testSegments=true nas APIs a seguir (AAM -27591):
   * ` .../v1/segments`
   * ` .../v1/destinations/<destinationId>/mappings`

* Os métodos de APIs de segmentos foram migrados para o Swagger. Consulte [Migração do código de API do Audience Manager](https://marketing.adobe.com/resources/help/pt_BR/aam/c_api_swagger.html). (AAM-28601)
...
A Adobe lançou um [Boletim de segurança do Adobe Campaign](https://helpx.adobe.com/br/security/products/campaign/apsb17-09.html) v6.11 para Windows e Linux.
