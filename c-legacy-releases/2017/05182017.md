...
[Compreender a sincronização de ID e as taxas de correspondência](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-match-rates.html) inclui novas informações sobre a chamada ` cm.eversttech.net` que o serviço de ID faz ao [!DNL  Adobe Advertising Cloud].
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Quando a opção para otimizar automaticamente os ajustes de oferta de lista de recomercialização ou localização estiver ativada, a Ad Cloud agora altera os ajustes de lance relevantes para as campanhas relevantes no portfólio otimizado, conforme necessário, como parte do processo de otimização. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"></td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>(Contas do Google) O serviço principal Adobe Mobile agora está integrado como um parceiro de medição móvel (MMP). Uma configuração de nível de anunciante permite especificar o Adobe Mobile Services como o MMP do anunciante. </p> <p>Quando um anunciante usa o serviço principal Adobe Mobile, o aplicativo instala configurações de extensão do aplicativo e dos anúncios, incluindo uma URL de postback. Uma vez por aplicativo, insira manualmente esta URL de postback para eventos de instalação e outros eventos do aplicativo nas configurações do aplicativo. </p> <p>O serviço principal móvel envia os dados da Advertising Cloud para cada evento de instalação ou outro evento no aplicativo ao passar o URL de postback quando a Advertising Cloud recebe postbacks, os eventos rastreados estão disponíveis como propriedades de transação. Para incluir as propriedades da transação nas suas exibições e relatórios ou configurar a otimização dos objetivos do seu portfólio para propriedades específicas da transação, você deve disponibilizar as propriedades da transação para portfólios, relatórios e exibições. </p> </td> 
  </tr> 
  <tr> 
