...
de desempenho, consulte [Adobe Mobile Services](https://docs.adobe.com/content/help/en/mobile-services/using/home.html) para obter a documentação do produto. Para visualizar as notas de versão de versões anteriores, abra as *Notas de versões anteriores* no painel à esquerda.
...
* Nova configuração, ` isCoopSafe`, adicionada. Essa é uma configuração booleana opcional que determina se o DIL envia dados ao [!DNL  Adobe Marketing Cloud Device Co-op]. Consulte [isCoopSafe](https://marketing.adobe.com/resources/help/en_US/aam/dil-coopsafe.html). (CORE-4334)
