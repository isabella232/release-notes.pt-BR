...
* Pequenas correções de erros e aprimoramentos
de desempenhos
...
Em 22 de agosto, o Adobe Analytics habilitará a [Segmentação geográfica](https://marketing.adobe.com/resources/help/pt_BR/reference/reports_geosegmentation.html) para todos os clientes. Essa alteração antecipa a futura remoção das configurações de segmentação geográfica no Admin Console.
...
* Os usuários vinculados a [IDs de organização](https://marketing.adobe.com/resources/help/pt_BR/aam/ids-in-aam.html) agora podem fazer logon na interface do usuário do Audience Manager com a Adobe ID em vez de nome de usuário e senha. (AAM-28161)
...
[DIL](https://marketing.adobe.com/resources/help/en_US/aam/dil-overview.html) é o código de coleta de dados da API do Audience Manager. A versão de agosto apresenta a adição de DIL à versão 6.11.

* Nova configuração, ` isCoopSafe`, adicionada. Essa é uma configuração booleana opcional que determina se o DIL envia dados ao [!DNL  Adobe Marketing Cloud Device Co-op]. Consulte [isCoopSafe](https://marketing.adobe.com/resources/help/pt_BR/aam/?f=dil-coopsafe.html). (CORE-4334)

**Importantes atualizações de documentação**

Redigimos a documentação sobre como trabalhar com nossas APIs do Servidor de coleta de dados (DCS). Comece com os [Métodos API do servidor DCS e código](https://marketing.adobe.com/resources/help/pt_BR/aam/dcs-intro.html) e evolua para operações mais avançadas com nossas APIs DCS.
...
* [Regras de escuta](https://marketing.adobe.com/resources/help/pt_BR/social/c_settings_rules.html): as regras ficam inativas automaticamente após 6 meses. Regras expiradas podem ser encontradas na guia [!UICONTROL Inativas] do [!UICONTROL Construtor de regras] e podem ser renovadas por 6 meses, individualmente ou em massa.
