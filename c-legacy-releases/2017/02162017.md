---
description: Nova interface do Feed de dados do Analytics; detalhamento da Analysis Workspace por localização fixa em tabelas; correções gerais para as versões de manutenção na Adobe Marketing Cloud.
keywords: notas de versão
seo-description: Nova interface do Feed de dados do Analytics; detalhamento da Analysis Workspace por localização fixa em tabelas; correções gerais para as versões de manutenção na Adobe Marketing Cloud.
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_9DD79A9FD0014CA285E372FAD2BF9FE2"> 
      <li id="li_BE8C3497AA9A4FCA855130A0C7157F12">Correção de um problema que fazia com que a predefinição <span class="term"></span> de calendário Months meses atrás não mostrasse nenhum dado. (AN-137808) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7CC12EBCEBD943B1B329594D13DCF66C"> 
      ...
      <li id="li_EE874B3A8F77478F818663664AA2752E">Corrigido um problema que impedia que a Data de logon do usuário não fosse atualizada no Admin Console após o usuário fazer logon por meio do logon único da Marketing Cloud. (AN-130665) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> <b> <span class="keyword"> AppMeasurement</span> para JavaScript</b> </p> 
    ...
    </ul> <p> <b>Consulte também:</b> <a href="../../c-legacy-releases/2017/02162017.md#mcvid" format="dita" scope="local"> Serviço de ID da Marketing Cloud</a>(antigo <span class="term">serviço de ID de visitante</span>) </p> </td> 
  </tr> 
 </tbody> 
</table>
