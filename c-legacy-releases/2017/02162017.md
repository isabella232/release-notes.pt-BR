...
[Uso da pré-busca DNS com diferentes Soluções e Serviços da Experience Cloud](https://marketing.adobe.com/resources/help/pt_BR/mcloud/dns-prefetch.html)
...
* Atualizado o diagrama Venn para explicar os termos de Público-alvo. Consulte a [Documentação de público-alvo endereçável](https://marketing.adobe.com/resources/help/pt_BR/aam/addressable-audiences.html). (AAM-27559)
* Adicionada uma nova macro de conteúdo &lt;DPUUIDS&gt; em arquivos de dados de saída. Consulte [Modelo de saída do Macros](https://marketing.adobe.com/resources/help/pt_BR/aam/outbound-template-macros.html) e [Exemplos de saída do Macro](https://marketing.adobe.com/resources/help/pt_BR/aam/outbound-macro-examples.html). (AAM-28000)
...
Consulte as [Notas de versão do Primetime](https://help.adobe.com/pt_BR/primetime/release_notes/index.html) para obter as informações mais recentes da versão.
...
* Página inicial das Notas de versão: [Notas de versão do Adobe Experience Manager 6.2](https://docs.adobe.com/docs/en/aem/6-2/release-notes.html)
