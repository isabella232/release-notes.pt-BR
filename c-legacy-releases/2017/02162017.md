 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Historicamente, os administradores do feed de dados dependiam do Atendimento ao cliente da Adobe para obterem uma atualização de status sobre as tarefas do feed de dados, ou alterarem seus feeds de dados. A interface do feed de dados do usuário está disponível para todos os administradores do Adobe Analytics. </p> <p>Use a interface do Feed de dados do Analytics para: </p> <p> 
     ...
     </ul> </p> <p>O nome de serviço do feed de dados foi alterado de <span class="term">Feeds de dados de sequência de cliques </span>para <span class="term">Feed de dados do Analytics</span>. </p> <p>Consulte <a href="https://marketing.adobe.com/resources/help/en_US/reference/analytics-data-feed.html" format="https" scope="external">Feeds de dados do Analytics</a> para obter mais informações. </p> </td> 
  </tr> 
  <tr> 
...
* Corrigida uma falha na interface em que estávamos fazendo chamadas erroneamente para a API de segmentos em vez de fazermos chamadas para a API de fontes de dados para obter um nome *`MergeRule`* name. (AAM-27473)
