...
* Atualizações de Dimension entre para segmentos sequenciais. Assim como a lógica Instância entre que identifica correspondências entre container, a Dimension Entre agora inclui uma função de restrição de dimensão que fornece lógica com base em valores de dimensão, determinando correspondências com base em valores específicos (linhas de tabela) para rastrear se uma dimensão selecionada está definida (ou não) e permitir que você forneça a lógica de segmento com base nesses valores de dimensão.
