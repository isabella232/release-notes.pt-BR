...
<table id="table_EB3FFBA2DF904546A5185EC9A63BBA98"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>A página <a href="https://marketing.adobe.com/resources/help/en_US/mcloud/groups.html" format="https" scope="external">Gerenciamento de grupo</a> foi reprojetada como uma interface administrativa que permite criar grupos, adicionar usuários aos grupos e aplicar permissões nas soluções da Marketing Cloud. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Mapeamento One-to-many </p> </td> 
   <td colname="col2"> <p>Caso tenha várias soluções e empresas, poderá mapear vários produtos e serviços para uma única empresa ao vincular contas da solução na Marketing Cloud. </p> <p>Consulte <a href="https://marketing.adobe.com/resources/help/en_US/mcloud/organizations.html" format="https" scope="external">Contas e empresas </a>. </p> </td> 
  </tr> 
  <tr> 
...
Consulte a documentação do produto da [Marketing Cloud e dos principais serviços](https://marketing.adobe.com/resources/help/en_US/mcloud/) para obter mais informações.
...
* Correção de um problema de pasta de ativos que impedia [!DNL  Marketing Cloud] que [!DNL  Adobe Campaign] os ativos exibissem hierarquias idênticas de pastas.
...
>[!NOTE]
>
>O acesso do data warehouse da Versão 14 será removido nesta versão.[Saiba mais](https://marketing.adobe.com/resources/help/en_US/reference/?f=whatsnew_segments)
...
* Correção de um problema que fazia [!DNL  SAINT] com que as classificações ficassem incorretas após [!DNL  Adobe Social] a ativação inicial.
