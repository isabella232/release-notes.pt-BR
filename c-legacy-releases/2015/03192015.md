...
### Interface da Experience Cloud 15.3.2 {#marketing_cloud_interface}
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> Alteração do separador entre as dimensões e as classificações de um caractere sublinhado (_) para ||. Essa mudança tem implicações de compatibilidade para um usuário do Report Builder 5.0 que abre uma pasta de trabalho do Report Builder v5.1 com solicitações de classificação. <a href="https://docs.adobe.com/content/help/en/analytics/analyze/report-builder/troubleshoot.html" format="https" scope="external"> Mais... </a> </td> 
  </tr> 
 </tbody> 
</table>
...
* Correção de um problema em que, nos emails de recuperação de senha, o domínio do remetente da Adobe (omniture.com) não correspondia ao valor *`From`* (adobe.com). Isso resultava no bloqueio dos emails e o usuário nunca os recebia. As seleções de menu *`From`* foi alterado para [!DNL  httpd@omniture.com].
