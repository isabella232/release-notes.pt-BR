...
<table id="table_EB3FFBA2DF904546A5185EC9A63BBA98"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Se você capturar os dados de clientes de empresas em um banco de dados do gerenciamento de CRM (relacionamento com o cliente), é possível fazer upload desses dados para a Experience Cloud. </p> <p>Assim que os dados estiverem na Marketing Cloud, é possível criar um segmento de público-alvo no <span class="wintitle"> Analytics </span> que inclua os atributos do cliente na definição do segmento e, em seguida, compartilhar esse segmento de público-alvo com o Target. </p> <p>Consulte <a href="https://marketing.adobe.com/resources/help/en_US/mcloud/index.html?f=attributes" format="https" scope="external">Atributos do cliente</a> na ajuda da Experience Cloud. </p> <p>Saiba mais sobre como <a href="https://marketing.adobe.com/resources/help/en_US/mcloud/index.html?f=core_services" format="https" scope="external">Ativar suas soluções para os principais serviços </a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_03055471A9624B40B122C0E2CD295AA9"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> <span class="term"> O Gerenciamento de aquisição </span> e <span class="term"> as Mensagens </span> no aplicativo agora estão acessíveis somente aos usuários do grupo de administração do aplicativo <span class="wintitle"></span> móvel, gerenciado por meio das Ferramentas administrativas no <span class="wintitle"> Analytics </span>. Isso permite que as empresas gerenciem quem tem acesso a esses recursos. <a href="https://marketing.adobe.com/resources/help/en_US/mobile/index.html?f=t_admin_group" format="https" scope="external"> Mais... </a></p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> </p> </td> 
   <td colname="col2"> <p>Caso você tenha várias empresas do <span class="wintitle">Analytics</span> quando realizar o logon no Mobile Services usando sua Adobe ID, é possível alternar entre elas no Mobile Services. </p> <p>Para mudar de empresa, clique no ícone do usuário na parte superior direita do cabeçalho. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> Agora, você tem acesso a eVars e eventos adicionais. O número exato depende do produto do Adobe <span class="wintitle"> Analytics </span> que você contratou. <a href="https://marketing.adobe.com/resources/help/en_US/sc/implement/evars_events.html" format="https" scope="external"> Mais… </a> </td> 
  </tr> 
  <tr> 
