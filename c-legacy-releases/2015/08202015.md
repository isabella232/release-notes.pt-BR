...
* Correção de um bug que impedia o [!UICONTROL Serviço de ID do visitante] de configurar apropriadamente um cookie de domínio multiparte e de nível superior. Por exemplo, se você tem um domínio como ` my_company.co.uk`, em determinadas circunstâncias o [!UICONTROL Serviço de ID do visitante] definiria um cookie somente em ` co.uk`. (AN-104683)
   ...
   * Ativação de um [período de carência](https://marketing.adobe.com/resources/help/pt_BR/mcvid/?f=mcvid_grace_period.htmlor)*ou* estão usando cookies primários e os usuários bloqueiam cookies de terceiros.
...
* A nova documentação descreve como transferir dados de uma conta do Google Doubleclick Campaign Manager (DCM) para o [!DNL  Audience Manager]. Consulte [Importar arquivos DCM para o Audience Manager](https://marketing.adobe.com/resources/help/pt_BR/aam/?f=t_dcmlogs.html).
* A nova documentação descreve como trabalhar com as [!UICONTROL Ferramentas de gerenciamento em massa]. Consulte [Ferramentas de armazenamento em massa](https://marketing.adobe.com/resources/help/pt_BR/aam/?f=c_bulk.html) para obter mais informações.
* Revisão da [Integração do Master Marketing Profile](https://marketing.adobe.com/resources/help/pt_BR/aam/?f=c_mmp.html) para atualizar a variável de dados de contexto. Essa variável deveria terminar com um sublinhado. Antes, ela terminava com um ponto final.

**Problemas conhecidos**

[!DNL  Analytics] os clientes precisam definir um código de integração ao usar o [Master Marketing Profile](https://marketing.adobe.com/resources/help/pt_BR/aam/?f=c_mmp.html) e transmitir IDs declaradas para [!DNL  Audience Manager] com o [Serviço de ID de visitante](https://marketing.adobe.com/resources/help/pt_BR/mcvid/?f=mcvid_service.html). Consulte [Ativação de cliente para mesclagem de perfil](https://marketing.adobe.com/resources/help/pt_BR/aam/?f=c_profile_merge_enablement.html do cliente Mesclar perfis) para obter detalhes.
