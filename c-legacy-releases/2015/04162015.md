...
* Correção de um problema que impedia o logon único entre o [!DNL  Marketing Cloud] e o [!DNL  Media Optimizer].
...
* O recurso de Aplicativos sociais foi substituído oficialmente no Adobe Social versão 15.4.1.0 (abril de 2015). Isso inclui a remoção de métricas, dados e métodos de API relativos ao aplicativo. Em caso de dúvidas, entre em contato com o Gerente de contas sociais. Para obter detalhes completos, consulte os [Aplicativos do Adobe Social - Planilha de descontinuação](https://helpx.adobe.com/br/social/kb/social-applications---deprecation-fact.html).
