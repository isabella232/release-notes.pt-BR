...
* Correção de um problema que impedia o logon único entre o [!DNL  Marketing Cloud] e [!DNL  Media Optimizer].

**Problemas conhecidos**

* Um problema conhecido impede que o público-alvo compartilhe conjuntos de relatórios que não são de propriedade da [!DNL Analytics] conta vinculada. Estamos nos esforçando para solucionar os problemas
...
* Correção de uma discrepância entre os dados de Relatórios e [!DNL Analytics] do data warehouse adicionando suporte para *` campaign instances`* uma métrica de segmentação ao data warehouse.
