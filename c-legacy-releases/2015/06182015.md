...
* As orientações a seguir foram reorganizadas e melhoradas:
   ...
   * [Guia do usuário do Adobe Mobile Services](https://marketing.adobe.com/resources/help/pt_BR/mobile/)
   * [iOS SDK 4. x para Guia de administração de soluções da Experience Cloud](https://marketing.adobe.com/resources/help/pt_BR/mobile/ios/)
...
O Analytics Premium oferece estes novos recursos adicionais na versão [Data Workbench 6.4](https://marketing.adobe.com/resources/help/pt_BR/insight/whatsnew/):
...
* Suporte do estado autenticado. Na ID de visitante da Experience Cloud, a API de visitante aceita várias IDs do cliente para o mesmo visitante, juntamente com um identificador do tipo de cliente para diferenciar o escopo das diferentes IDs do cliente e *` authStates`*.
...
* Estamos aperfeiçoando a documentação da API com o Swagger. Consulte a seção [API Docs do Audience Manager](https://bank.demdex.com/portal/swagger/index.html) para conhecer métodos novos e revisados.
* Adição da nova documentação sobre as [IDs de visitante da Experience Cloud](https://marketing.adobe.com/resources/help/pt_BR/aam/?f=c_visitor_id_versions.html). Às vezes, pode ser necessário ter uma ID de visitante ao criar ou editar uma fonte de dados.
...
Consulte [Notas de versão do Adobe Social](https://marketing.adobe.com/resources/help/pt_BR/social/c_rel_notes.html) para obter mais informações.
