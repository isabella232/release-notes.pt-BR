...
Os clientes devem ter o [!DNL  Analytics—Mobile Apps] ou [!DNL  Analytics Premium] para usar a seguinte funcionalidade:

* Mensagens no aplicativo
* Rastreamento de Campanha de aquisição
...
* A expiração para rastrear campanhas de aquisição mudou de visita para visitante para todos os clientes. Essa alteração facilita a atribuição da campanha para postar a atividade de download no visitante de todas as visitas, em vez de apenas a primeira visita.
* Os seguintes guias foram reorganizados e aprimorados:

   * [Guia do usuário do Adobe Mobile Services](https://docs.adobe.com/content/help/pt-BR/mobile-services/using/home.html)
   * [iOS SDK 4.x para o Guia do administrador das soluções da Marketing Cloud](https://docs.adobe.com/content/help/pt-BR/mobile-services/ios/overview.html)
...
A versão de 18 de junho de 2015 do Video Stream Analytics (heartbeat) inclui as seguintes alterações:
...
<table id="table_193CB58F22D14FE4AB4759418A00848B"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Métricas do Video Core </p> </td> 
     ...
     <ul id="ul_F49FF181E93744F8BAD180B994073F20"> 
      ...
      <li id="li_8913320B99114DE881B5F4E8B3BD0D84"> <p> <b>Caminho do vídeo</b> </p> 
       <ul id="ul_CCC6EA9299644D48935146DDD988DE36"> 
        <li id="li_70DBC48AD34A4893B7FB2C92DA0F2E72"> <p>Esta é uma variável de solução. </p> </li> 
        <li id="li_5146C2C8E86F4DACB07A99E7939B360F"> <p>A profundidade máxima do caminho é três. </p> </li> 
       </ul> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Qualidade do vídeo </p> </td> 
...
* Os nomes de variáveis e eventos foram alterados para melhor refletir os propósitos dos componentes (vídeo, conteúdo, anúncios). O vídeo agora inclui o conteúdo principal e os anúncios.
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>As métricas calculadas agora permitem métricas segmentadas, matemática mais avançada e a capacidade de organizar e compartilhar métricas. </p> <p>Você pode criar novas métricas que se aplicam historicamente sem atualizar sua implementação, compartilhar e preparar métricas para remover a confusão e fazer análise estatística básica. É possível comparar segmentos com muito mais facilidade. </p> <p>Você pode aplicar essas novas métricas em qualquer lugar nos Reports &amp; Analytics, na Analysis Workspace, no Report Builder e na Ad Hoc Analysis. </p> <p> <a href="https://marketing.adobe.com/resources/help/pt_BR/analytics/calcmetrics/" format="https" scope="external"> Mais... </a> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Analysis Workspace - Análise de forma livre </td> 
   <td colname="col2"> <p>A Análise de forma livre permite que você arraste e solte dimensões, métricas e segmentos para criar qualquer relatório que desejar. Você pode analisar seus dados de acordo com suas necessidades específicas, fornecendo uma tela para criar query usando métricas, dimensões, segmentos, linhas do tempo e outros valores de detalhamento de análise relevantes. </p> <p>Os recursos mais recentes incluem: </p> <p> 
     <ul id="ul_F5C624FACEEF4839BD1A9AE10C437085"> 
      ...
      <li id="li_22D58E07B0BB43C5A50F16523DC7B647"> <p> <b>Melhorias nas permissões:</b> o acesso à Analysis Workspace pode ser concedido para usuários não administrativos através da área de permissões do grupo de usuários em Ferramentas administrativas. </p> </li> 
     </ul> </p> <p> <a href="https://docs.adobe.com/content/help/pt-BR/analytics/analyze/analysis-workspace/home.html" format="https" scope="external"> No momento, a Análise de forma livre</a> está em um beta aberto suportado principalmente pela equipe da comunidade do Analytics. Para obter informações atualizadas e fazer perguntas sobre a Análise de forma livre, consulte o <a href="https://help-forums.adobe.com/content/adobeforums/en/analytics-forum/freeform-analysis.html" format="http" scope="external">fórum da Análise de forma livre (beta)</a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Substituição SFTP da Data Warehouse </td> 
   <td colname="col2"> O SFTP agora oferece suporte para substituição na transmissão. Recomendamos que você atualize seu servidor SFTP para uma versão que suporte a renomeação. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Aumento do limite das regras de processamento </td> 
   <td colname="col2"> <p>O número de regras de processamento permitidas aumentou de 100 para 150. Além disso, o tamanho permitido do XML da regra de processamento aumentou para 4 MB (de 65 KB). Essa alteração de tamanho impede um erro que estava sendo emitido quando a limitação XML foi excedida. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <span class="uicontrol"> Ferramentas administrativas</span> &gt; <span class="uicontrol">Report Suites</span> &gt; <span class="uicontrol">Editar configurações</span> &gt; <span class="uicontrol">Geral</span> &gt; <span class="uicontrol">Configurações de privacidade </span> </p> <p> Esse recurso permite que os clientes da Adobe Analytics respeitem a intenção de um usuário de interromper o processamento para fins de criação de perfis. As orientações legislativas e regulamentares expressaram que a ação de um usuário para bloquear cookies é a mesma ação de um usuário para opt out da criação de perfis. Ao ativar esse recurso, os dados coletados em navegadores de desktop e móveis nos quais o usuário definiu seu navegador para bloquear todos os cookies serão excluídos dos relatórios do Analytics. Se a Adobe não reconhecer o navegador da Web, os dados serão incluídos nos relatórios do Analytics. </p> <p> <a href="https://docs.adobe.com/content/help/en/core-services/interface/ec-cookies/browser-cookie-settings.html" format="https" scope="external"> Mais... </a> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
O Analytics Premium oferece esses novos recursos adicionais na versão da [Data Workbench 6.4](https://docs.adobe.com/content/help/pt-BR/data-workbench/using/release-notes/release-notes.html):
...
<table id="table_FE8C9A73676345CDA450CE84111A2B72"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> Nova instalação da estação de trabalho </td> 
   <td colname="col2"> Configure a Data Workbench (cliente) usando um assistente de instalação passo a passo. Baixe, defina opções, instale o workbench e sincronize com os servidores. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Experiência de configuração de workstation aprimorada </td> 
   <td colname="col2"> Após a instalação da estação de trabalho, o espaço de trabalho <b>Configurar conexões ao servidor</b> será aberto com informações adicionais sobre como instalar um certificado e inserir informações de conexão do servidor no arquivo Insight.cfg. Você também pode visualização o status da conexão aos servidores e selecionar perfis. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Camada de apresentação </td> 
   <td colname="col2"> Anotar e esclarecer visualizações usando uma sobreposição de apresentação. Adicione chamadas de texto, setas, imagens e codificação por cores para destacar e esclarecer seus dados e, em seguida, compartilhar com outras pessoas. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Novo assistente de Dimension de métrica </td> 
   <td colname="col2"> Use um assistente passo a passo para facilitar a criação de dimensões de métrica. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Administração de usuários do acesso de membros do grupo </td> 
   <td colname="col2"> Os administradores podem dar aos usuários da estação de trabalho a capacidade parcial de gerenciar controles de acesso para grupos personalizados. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Impedir alterações em perfis </td> 
   <td colname="col2"> Evite que os perfis sejam substituídos por usuários que trabalham nos gerentes de Perfis, Dimension, Relatórios, Espaços de trabalho, Métricas ou Filtros. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> Informações de registro atualizadas </td> 
   <td colname="col2"> A análise de big data agora usa uma estrutura de log expandida "L4" que fornece a capacidade de configurar o logon com base na necessidade. A implementação padrão que acompanha o pacote 6.4 fornece informações vitais sobre o processamento de software. O registro pode ser expandido com informações adicionais para solucionar problemas de eventos do servidor e ajudar a analisar problemas subjacentes, incluindo informações adicionais para servidor associado, cliente e servidor de relatório. <p>Para obter suporte adicional na implementação de registro L4 adicional, entre em contato com seu gerente de conta. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Novo arquivo cfg para opções de registro do ExportIntegration.exe </td> 
   <td colname="col2"> <p>Um novo arquivo de configuração de httpLoggingEI.cfg (localizado em <span class="filepath">server\Admin\Export\httpLoggingEI.cfg</span>) permite interromper o logon de INFO para o arquivo HTTP.log durante as exportações da Integração de exportação. (As exportações de CRS, TNT e MMP já capturam o logon profundo em arquivos de log de exportação individuais.) </p> <p>Uma configuração verdadeira start o registro INFO (para teste e relatórios detalhado) para o arquivo HTTP.log, e uma configuração falsa para o registro detalhado. Para uma configuração falsa, somente mensagens de nível AVISO/ERRO serão enviadas para o arquivo HTTP.log. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Recurso de zoom para visualizações de gráfico </td> 
   <td colname="col2"> Use o recurso de zoom para obter uma melhor exibição dos rótulos de métricas quando os valores atingirem uma diferença maior. Anteriormente, o rótulo desaparecia com a alteração no contraste dos valores - por exemplo, ao definir um valor de regressão de métrica maior em relação aos valores anteriores. Agora, é possível ampliar a visualização clicando em <b>&amp;lt;Ctrl&amp;gt;</b>, movendo o mouse e passando o cursor sobre o gráfico. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> Esses executáveis agora são assinados digitalmente para garantir que os downloads de software não tenham sido alterados ou corrompidos. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Opções de formato de data </td> 
   <td colname="col2"> Você pode alterar o formato de data com base na sua localidade no arquivo <i>Dimension.cfg</i> de hora padrão. Altere o formato padrão <i>MM/DD/AAAA</i> para o formato <i>DD/MM/AAAA</i> ou escolha outras opções. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Visualização de arquivos dividida </td> 
   <td colname="col2"> A visualização de arquivos (<span class="uicontrol">Admin</span> &gt; <span class="uicontrol">Arquivos</span>) para perfis de base não incluirá diretórios maiores (Logs, Exportações e Consultas removidos) nos relatórios. Isso aumentará a velocidade de exibição do relatório. Os diretórios maiores agora têm seus próprios relatórios individuais (Admin / Arquivos de exportação, Arquivos de pesquisa e Arquivos de log). </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Transformações DeviceAtlas aprimoradas </td> 
   <td colname="col2"> O arquivo DeviceAtlas.bundle agora usa o cache na memória para melhorar consideravelmente o desempenho das pesquisas. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Visualização de Corda atualizada </td> 
   <td colname="col2"> Visibilidade aprimorada ao passar o mouse sobre uma seção ao visualizar a visualização de <b>Corda</b> . </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Arrastar dimensões do Finder para uma Tabela de detalhes </td> 
...
* Correção de um problema nos emails do relatório (anexos [!DNL  .xls] e [!DNL  .csv]) que continham a ID do conjunto de relatórios em vez do nome do conjunto de relatórios no email. Agora, ele mostra o nome do conjunto de relatórios.

### Correções da análise de big data {#fixes_data_workbench}

* A pontuação de propensão não era redefinida ao executar entradas diferentes no mesmo espaço de trabalho. Isso agora é redefinido corretamente.
* Correção de um problema que disponibilizava dimensões não contáveis quando a Matriz de correlação era aberta pela primeira vez.
* A exportação de segmentos de Públicos alvos falhava porque o *`mboxPC`* campo estava ausente. Isso agora está consertado.
* Solicitação de ID formatada corretamente. Using the *`mbox3rdpartyId`* identification instead of default PCIDs caused [!UICONTROL  Adobe Target] to reject requests generated via the Target/Data Workbench integration (using the [!DNL  ExportIntegration.exe]). Essa solicitação de ID está sendo formatada corretamente e o throughput é bem-sucedido.
...
* Foram feitas alterações na lógica comercial Tempo de visita/Hora do site:

   * Use *`visit_start_time_gmt`* as the starting time of a visit. Agora, as visitas que começaram antes do intervalo de datas do relatórios não são afetadas negativamente.
   * Adicionada uma nova categoria de detalhamento *`Group L: No duration`* para classificar visitas que abrangem zero segundos. Agora, essas visitas não são mais incluídas no intervalo de tempo *`Group A: <1 minute`*.
   * As ocorrências da fonte de dados transacional (hit_source=7) não são mais consideradas como tendo uma duração da visita.
   * Ocorrências com carimbo de data e hora designadas como carimbo de data e hora antes do valor absoluto *`visit_start_time_gmt`* aplicado ao delta de hora, de modo que nem sempre serão categorizadas automaticamente como *`Group A: <1 minute`*.
...
* Suporte de estado autenticado. Na ID de visitante da Experience Cloud, a API de visitante aceita várias IDs do cliente para o mesmo visitante, juntamente com um identificador do tipo de cliente para diferenciar o escopo das diferentes IDs do cliente e *`authStates`*.
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Os <span class="wintitle">Controle da exportação de dados</span> impedem que você adicione características aos segmentos ou envie dados para um destino se essa ação violar a privacidade dos dados ou as políticas de uso dos dados. Consulte a <a href="https://docs.adobe.com/content/help/en/audience-manager/user-guide/features/data-export-controls.html" format="https" scope="external">documentação dos Controles da exportação de dados</a> para obter mais informações. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* Estamos aprimorando a documentação da API com o Swagger. See the [Audience Manager API Docs](https://bank.demdex.com/portal/swagger/index.html) section for new and revised methods.
...
See [Release Notes for Adobe Social](https://docs.adobe.com/content/help/pt-BR/social/using/home.html) for more information.
