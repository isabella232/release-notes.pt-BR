...
* Correção de um problema que impedia a disponibilização de novos segmentos criados nos relatórios e análises da Marketing Cloud Audiences. (MAC-25817)
...
Um problema conhecido está causando a criação duplicada de contas geradas automaticamente no Audience Manager e vinculando-as automaticamente à identidade da Marketing Cloud de um usuário. Esse problema ocorre ao tentar navegar para o Audience Manager antes de vincular as contas. A Adobe recomenda vincular suas contas do Audience Manager à Marketing Cloud antes de navegar para o Audience Manager. (MAC-25640)
...
* Os métodos da API da fonte de dados migraram para o Swagger. Consulte [Documentos da API do Audience Manager](https://bank.demdex.com/portal/swagger/index.html) para obter métodos, sintaxe e modelos de código.
