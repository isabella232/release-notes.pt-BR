...
Administradores de soluções, consultem [Usuários e grupos](https://marketing.adobe.com/resources/help/pt_BR/mcloud/?f=user_mgmt_admin) para obter informações importantes sobre como mapear grupos de solução para grupos mais amplos da Adobe e adicionar usuários em massa no [Enterprise Dashboard](http://adminconsole.adobe.html/#).
   ...
   <td colname="col2"> <p>A versão 4.6 de ambas as SDKs (Android e iOS) estão disponíveis. </p> <p>As duas SDKs incluem as seguintes melhorias: </p> <p> <b>Mensagens de push para segmentos do Analytics: </b>o <span class="keyword">Adobe Mobile Services</span> e a SDK <span class="keyword">Adobe Mobile</span> permitem enviar mensagens de push para segmentos do [!DNL Analytics]. O SDK também permite reportar com facilidade os usuários que abriram seu aplicativo como resultado da abertura da mensagem de push. </p> <p> <b>Métodos de aquisição: </b>permite aos desenvolvedores iniciar uma campanha de aquisição de aplicativo como se o usuário tivesse clicado em um link. Isso é útil para criar links de aquisição manuais e manipular o redirecionamento da App Store. </p> <p> <b>Postback:</b> os postback permitem enviar os dados coletados pela SDK a um servidor separado de terceiros. Ao utilizar os mesmos disparadores e características usadas para exibir uma mensagem no aplicativo, é possível configurar o SDK para enviar dados personalizados a um destino de terceiros. </p> <p> <b>Identificadores: </b>os seguintes identificadores foram adicionados: </p> 
    <ul id="ul_3904FD6D41DB4CBE8475B28437E3B804"> 
     ...
     <ul id="ul_0CEA2D739BF54F94A50AA90641DF4453"> 
      <li id="li_64564475E1CE4C1D83F6907C62510553"> <a href="https://marketing.adobe.com/resources/help/en_US/mobile/android/index.html?f=rel_notes" format="https" scope="external"> Notas de versão para Android SDK 4.x para Soluções da Experience Cloud </a></li> 
      <li id="li_09F89AC33E07482DBF73B3F731C9FCFF"> <a href="https://marketing.adobe.com/resources/help/en_US/mobile/ios/index.html?f=rel_notes" format="https" scope="external"> Notas de versão para iOS SDK 4.x para Soluções da Experience Cloud </a></li> 
     </ul></p> </td> 
  </tr> 
 </tbody> 
</table>
...
Administradores do Analytics: se você for um administrador na Experience Cloud, consulte [Usuários e groupos](https://marketing.adobe.com/resources/help/pt_BR/mcloud/?f=user_mgmt_admin) para obter informações atualizadas sobre como mapear grupos do Analytics para grupos mais amplos da Adobe e adicionar usuários em massa no [Enterprise Dashboard](http://adminconsole.adobe.html/#).
...
* Correção de um problema que ocorria após a criação de um grupo de usuários nos Reports &amp; Analytics e selecionava esse grupo como padrão. A tentativa de reverter o grupo padrão para _nenhum_ falhou com uma mensagem de erro. (AN-108270)
...
* A nova documentação descreve como usar arquivos de metadados para substituir IDs numéricas por texto legível nos relatórios de [!UICONTROL Advertising Analytics]. Consulte [Dados e arquivos de metadados para relatórios do Advertising Analytics](https://marketing.adobe.com/resources/help/pt_BR/aam/?f=metadata-files-intro.html).
* Revisão de [Capturar dados de impressão de dados da campanha por meio de chamadas Pixel](https://marketing.adobe.com/resources/help/pt_BR/aam/?f=c_capturing_camp_data.html) para incluir novos pares de valores chave exigidos pelos relatórios do [!UICONTROL Advertising Analytics].
* Revisão de [Capturar dados de cliques da campanha por meio de chamadas Pixel](https://marketing.adobe.com/resources/help/en_US/aam/?f=c_capturing_camp_click_data.html) para incluir novos pares de valores chave exigidos pelos relatórios do Advertising Analytics.
