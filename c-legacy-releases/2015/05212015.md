...
<table id="table_03055471A9624B40B122C0E2CD295AA9"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> Adicionada uma substituição regional do navegador para desktop para links de aquisição. Essa configuração permite selecionar a app store específica da região para a qual você deseja que um link de aquisição seja direcionado quando um usuário clicar no link em um navegador de desktop. </p> <p> Esse recurso pode ser definido somente pelos usuários com privilégios administrativos para criar links de aquisição (administradores de aplicativos móveis). </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> Adicionada a métrica "Instâncias de último toque do Canal de marketing" para o relatórios da Data Warehouse. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Modificação das Fontes de Dados em junho de 2015 </td> 
...
<table id="table_A01098A1EE3A4F1084AB13DD1A0DF1B3"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>O data warehouse suporta a API de Relatórios do Analytics 1.4. </p> <p>Consulte <a href="https://marketing.adobe.com/developer/documentation/data-warehouse/r-report-2" format="https" scope="external">Report.Queue</a> na documentação da API do Data Warehouse no Developer Connection. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_3CA51E873E324FD4B7CF14190F127A77"> 
 ...
 <tbody> 
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>Crie publicações no Facebook que não são exibidas na sua Linha do tempo, mas que podem ser acessadas com links diretos. Essa opção permite que os criadores de conteúdo criem publicações para serem promovidas como anúncios patrocinados (pagos). </p> 
  ...
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>Atualmente, há métricas que recebemos nas redes sociais que não podem ser relatadas no <span class="keyword">Adobe Analytics </span>. New reserved events let you create custom reports in  <span class="wintitle"> Analytics </span> to view social data alongside web data. </p> </td> 
  </tr> 
  <tr valign="top"> 
...
<table id="table_191B769A5A8A405C87A34245BE6B1127"> 
 ...
 <tbody> 
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>Selecione um quadro em qualquer lugar do vídeo para carregar e usar como imagem em miniatura desse vídeo na publicação. Antes, o <span class="keyword">Social</span> selecionava o quadro de abertura que seria usado como a imagem em miniatura. 
  ...
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>Os aprovadores de publicação agora podem aprovar uma publicação de sua pré-visualização. </p> </td> 
  </tr> 
  <tr valign="top"> 
  ...
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>Agora é possível criar um grupo de tags ou uma tag com o mesmo nome de um grupo de tags ou uma tag excluída anteriormente. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* Correção de um problema que fazia um conteúdo inválido (publicações, comentários e respostas) aparecer nos feeds de moderação. As melhorias de código ajudarão nosso sistema de coleta a bloquear com mais eficácia o conteúdo inválido que não corresponde à página.
