...
Consulte o [Histórico de versões do ](https://experienceleague.corp.adobe.com/docs/analytics/implementation/appmeasurement-updates.html) a seguir para obter um histórico das versões do [!DNL  AppMeasurement]AppMeasurement nas seguintes plataformas:
...
<table id="table_3CA51E873E324FD4B7CF14190F127A77"> 
 ...
 <tbody> 
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>Crie publicações no Facebook que não são exibidas na linha do tempo, mas que podem ser acessadas por meio de links diretos. Essa opção permite que os criadores do conteúdo criem publicações para serem promovidas como anúncios patrocinados (pagos). </p> 
...
<table id="table_191B769A5A8A405C87A34245BE6B1127"> 
 ...
 <tbody> 
  ...
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>Em 1º de março de 2015, a Adobe Social descontinuou o suporte para geolocalização de tweets. Depois de trabalhar com o Twitter, a geolocalização está disponível novamente. </p> 
