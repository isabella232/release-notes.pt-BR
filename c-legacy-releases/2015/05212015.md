...
### Interface da Marketing Cloud 15.5.1 {#marketing_cloud_interface}
...
* Corrigido um problema que impedia o uso de texto em japonês nos comentários entre o [!DNL  Creative Cloud] e [!DNL  Marketing Cloud]o.
...
* Foi corrigido um problema que não exibia os relatórios de campanha do [!DNL  Target] nos Relatórios e análises.
* Foi corrigido um problema com caracteres especiais nos nomes de campanha do [!DNL  Target] que impedia a criação de relatórios em Relatórios e análises.
...
Consulte [Implementação do serviço de ID do visitante](https://marketing.adobe.com/resources/help/en_US/mcvid/?f=mcvid_implement) para obter informações sobre essa alteração.

** [!DNL  AppMeasurement] para JavaScript**

**Versão 1.4.5**

* Inclusão da API de serviço de ID do visitante da Marketing Cloud 1.4.
