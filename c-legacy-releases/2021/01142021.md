...
Consulte [Notas de versão da Experience Platform](https://docs.adobe.com/content/help/pt-BR/experience-platform/release-notes/latest.html) para obter as atualizações mais recentes que se aplicam a:
...
| Journey IQ: [!UICONTROL Análise entre canais] | 11 de janeiro de 2021 | QI do Jornada: [!UICONTROL Cross-Channel Analytics] permite rechavear um conjunto de dados de evento Adobe Analytics (ou outro) no Experience Platform data lake de um namespace de ID para outro. Normalmente, você pode redirecionar o conjunto de dados do evento de uma ID com base em cookies para uma ID com base em pessoas. Dessa forma, o conjunto de dados rechaveado pode ser combinado com outros dados com base em pessoas em uma conexão do CJA, permitindo a análise entre dispositivos e entre canais no Analysis Workspace. [Saiba mais](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-connections/cca/overview.html?lang=pt-BR#cja-connections) |
| Analysis Workspace - seleção de componentes | 4 de fevereiro de 2021 | O componente de zona suspensa/de lançamento encontrado em [!UICONTROL Quick Insights] foi adicionado a todas as zonas de lançamento no [!UICONTROL Workspace]. Essa melhoria permite que você escolha em uma lista suspensa de componentes compatíveis ou continue a usar o espaço como uma zona de lançamento. |
