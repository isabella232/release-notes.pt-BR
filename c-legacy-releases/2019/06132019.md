...
| Recurso | Descrição |
| -----------| ---------- |  
| **Segmentação** | Novos modelos de atribuição para dimensões na segmentação:<ul><li>Repetitivo (padrão): inclui instâncias + valores persistentes da dimensão.</li><li>Instância: inclui instâncias da dimensão.</li><li>Instância não repetitiva: inclui instâncias exclusivas (não repetitivas) da dimensão.</li></ul> |
| **Segmentação** | Novos operadores de segmento: **[!UICONTROL Igual a qualquer um]** e **[!UICONTROL Não equivale a nenhum]**. |
...
**[Série de webinars do Construtor de habilidades do Cloud Manager](https://cloudmanagerskillbuilder.experienceleague.adobeevents.com/)**
...
[Nesta série](https://cloudmanagerskillbuilder.experienceleague.adobeevents.com/)mensal, você pode aprender diretamente com a equipe de produtos da Adobe sobre como começar e usar os recursos do Cloud Manager para simplificar o gerenciamento do Adobe Experience Manager na nuvem.
...
| Grade de proteção, robustez e escalonabilidade | Uma série de melhorias foi adicionada ao Campaign Classic. Guardrail, robustness and scalability improvements are listed in [Campaign Classic Release Notes](https://docs.campaign.adobe.com/doc/AC/en/RN.html). |
