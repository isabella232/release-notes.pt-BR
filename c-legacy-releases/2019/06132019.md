...
* Consulte [Experience Platform Launch](https://docs.adobelaunch.com/) para obter as informações mais recentes.
...
| Grade de proteção, robustez e escalonabilidade | Uma série de melhorias foi adicionada ao Campaign Classic. Os aprimoramentos na grade de proteção, robustez e escalonabilidade estão listados nas [Notas de versão do Campaign Classic](https://docs.campaign.adobe.com/doc/AC/en/RN.html). |
...
[Página inicial de ajuda das Notas](http://help.adobe.com/en_US/primetime/release_notes/index.html)de versão do Primetime[Primetime](http://help.adobe.com/en_US/primetime/)
