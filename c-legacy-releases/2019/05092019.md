...
* Consulte [[! Notas de versão do DNL Experience Platform]](https://www.adobe.io/apis/experienceplatform/home/services/release-notes.html#!end-user/markdown/release-notes/release-notes-20190515.md) na Adobe. io para as últimas atualizações.[!DNL Experience Platform]
...
| **Ad Hoc Analysis:** compatibilidade com o Java 11 | A Ad Hoc Analysis agora é compatível com o Java 11. Learn how to run [Ad Hoc Analysis on Java 11](https://marketing.adobe.com/resources/help/en_US/dsc/adhoc-java.html). |
| **Coleta de dados:** Novo cookie s_ecid | Added a new [first-party server cookie](https://docs.adobe.com/content/help/en/core-services/interface/ec-cookies/cookies-analytics.html), s_ecid, in which data collection stores the visitor's ECID. |
...
* [!DNL Campaign Classic] 18.10.4 - compilação 8983
* [!DNL Campaign Classic] 18.10.5 - compilação 8984
