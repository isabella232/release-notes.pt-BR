...
* Consulte as [notas de versão da [!DNL Experience Platform]](https://www.adobe.io/apis/experienceplatform/home/services/release-notes.html#!end-user/markdown/release-notes/release-notes-20190515.md) no Adobe.io para obter as atualizações mais recentes da [!DNL Experience Platform].
...
| **Ad Hoc Analysis:** compatibilidade com o Java 11 | A Ad Hoc Analysis agora é compatível com o Java 11. Saiba como executar a [Ad Hoc Analysis no Java 11](https://marketing.adobe.com/resources/help/pt_BR/dsc/adhoc-java.html). |
| **Coleta de dados:** Novo cookie s_ecid | Adição de um novo [cookie de servidor primário](https://docs.adobe.com/content/help/en/core-services/interface/ec-cookies/cookies-analytics.html), s_ecid, em que a coleta de dados armazena o ECID do visitante. |
...
* [Novidades no Adobe Experience Manager 6.5](https://www.adobe.com/br/marketing/experience-manager/new.html)
...
[versões do AEM Forms](https://helpx.adobe.com/br/aem-forms/kb/aem-forms-releases.html)
...
Consulte [O resultado da descontinuação da versão 2 do AWS Signature para o Amazon S3](https://helpx.adobe.com/br/experience-manager/kb/the-impact-of-aws-signature-version-2-deprecation-for-amazon-s3.html)
...
Consulte [Editor de Rich Text do AEM (RTE) - Informações avançadas](https://helpx.adobe.com/br/experience-manager/kt/eseminars/gems/AEM-Rich-Text-Editor-RTE-Deep-Dive1.html)
...
Consulte as [Notas de versão do Adobe Campaign Classic](http://docs.campaign.adobe.com/doc/AC/br/RN.html) para obter correções e melhorias.
