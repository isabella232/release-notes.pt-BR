...
Consulte [Serviço da Experience Cloud ID](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-release-notes.html) para notas de versão cumulativas.
...
* Atualização da definição da definição de ajuda para [log de sintaxe (X, B)](https://marketing.adobe.com/resources/help/en_US/insight/client/c_syntx_mtrc_exp.html) . (AN-180527)
