...
Consulte Serviço [da](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-release-notes.html) Experience Cloud ID para obter as notas de versão cumulativas.
...
* Atualização da definição de ajuda para a documentação da sintaxe da métrica [log (X, B)](https://marketing.adobe.com/resources/help/en_US/insight/client/c_syntx_mtrc_exp.html) . (AN-180527)
...
Um patch importante do AEM para a invalidação do cache do AEM 6.5 clientlibs está disponível por meio da atualização [do](https://helpx.adobe.com/experience-manager/6-5/release-notes/sp-release-notes.html) AEM 6.5.1.0 ou deste artigo [da](https://helpx.adobe.com/experience-manager/kb/avoid-crx-quickstart-deletion-in-aem-6-5.html)KB.
...
* Adobe Campaign Classic [19.1.2](https://docs.campaign.adobe.com/doc/AC/en/RN.html) - compilação 9029
