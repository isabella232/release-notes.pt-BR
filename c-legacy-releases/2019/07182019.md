...
Consulte [Serviço da Experience Cloud ID](https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid-release-notes.html) para obter as notas de versão cumulativas.
...
* Adobe Campaign Classic [19.1.2](https://docs.adobe.com/content/help/pt-BR/campaign-classic/using/release-notes/latest-release.html) – build 9029
