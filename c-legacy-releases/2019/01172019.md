...
Na versão 8.1, adicionamos a conformidade da DIL com políticas mais restritas de segurança do Google Tag Manager. Essa versão está disponível somente no DTM e como código independente, e não [!DNL Launch] no Módulo de gerenciamento de público-alvo do appmeasurement. As versões futuras incluirão essa alteração. (CORE-24189)
