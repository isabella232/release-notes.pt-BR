...
Na versão 8.1, adicionamos a conformidade da DIL com políticas mais restritas de segurança do Google Tag Manager. This version is only available from DTM and as standalone code, not [!DNL Launch] or AppMeasurement Audience Manager Module. As versões futuras incluirão essa alteração. (CORE-24189)
