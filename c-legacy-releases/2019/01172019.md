...
* Personalize a dimensão de coorte (para agrupar visitantes com base em uma eVar, não apenas no tempo).
...
* Correção de um problema que fazia com que as métricas de participação deixassem de funcionar com variáveis de lista no Ad hoc analysis. (AN-166027)
...
* Suporte para variáveis e campos de metadados em Nomes de site de PDF e AEM.
...
* A coluna de checkout não era exibida corretamente na Visualização de Lista de AEM Assets.
...
* O Editor XML AEM bagunça as colunas encadeadas.
