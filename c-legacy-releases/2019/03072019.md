...
| Alterações na RDC na China | A coleta de dados regionais na China continental permite que os clientes enviem dados diretamente para um centro de coleta de dados na China, em vez de outros locais. Isso melhora o tempo de carregamento da página e a precisão dos dados em comparação ao envio dos dados para os centros de coleta de dados fora da China. [Mais](https://marketing.adobe.com/resources/help/pt_BR/reference/rdc-china.html) |
| Aceleração regional para a China | A opção Aceleração da China agora está disponível nas Configurações do conjunto de relatórios do Analytics. Esta opção melhora a experiência do usuário do Relatórios Adobe Analytics para usuários na China Continental. Cada usuário do Adobe Analytics pode ativar ou desativar essa opção. Não selecione essa opção para usuários fora da China Continental, pois isso afetará negativamente o desempenho. [Mais](https://marketing.adobe.com/resources/help/pt_BR/sc/user/report_settings.html) |
...
* Correção de um problema em que o nome/sobrenome do usuário (migrado) no Analytics era diferente do nome vinculado à Adobe ID do usuário na Experience Cloud. To update the Analytics name with the one in Experience Cloud, go to **[!UICONTROL Admin]** > **[!UICONTROL User Management (Legacy)]** > **[!UICONTROL Edit Users]** and click the User ID. Em seguida, clique em **[!UICONTROL Atualizar do Experience Cloud]**. (AN-172825)
...
Esta versão contém a integração do Adobe Campaign com as versões gerais disponíveis (GA) das extensões Android e iOS para Adobe Campaign Standard no Adobe Experience Platform Launch e Mobile SDKs. Essas extensões suportam mensagens de push, mensagens no aplicativo e atualizações de perfis de aplicativos móveis.

Para obter mais informações, consulte [Uso do Adobe Experience Platform SDK](https://helpx.adobe.com/br/campaign/standard/administration/using/configuring-a-mobile-application.html#main-pars_header_49).
...
Para obter detalhes, consulte [Novidades do Portal](https://helpx.adobe.com/br/experience-manager/brand-portal/using/whats-new.html) de marcas da AEM Assets e [Notas](https://helpx.adobe.com/br/experience-manager/brand-portal/release-notes/brand-portal-release-notes.html)de versão.
