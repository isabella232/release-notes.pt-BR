...
| Aceleração regional para a China | A opção Aceleração da China agora está disponível nas Configurações do conjunto de relatórios do Analytics. Essa opção melhora a experiência do usuário do Relatórios do Adobe Analytics para usuários na China Continental. Cada usuário do Adobe Analytics pode ativar ou desativar essa opção. Não selecione essa opção para usuários fora da China Continental, pois isso afetará negativamente o desempenho. [Mais](https://marketing.adobe.com/resources/help/pt_BR/sc/user/report_settings.html) |
...
| API 2.0: suporte para autenticação JWT | A API do Adobe Analytics 2.0 agora oferece suporte à autenticação JWT. Mais informações sobre a Autenticação JWT podem ser encontradas aqui: [https://github.com/AdobeDocs/analytics-2.0-apis/blob/master/jwt.md](https://github.com/AdobeDocs/analytics-2.0-apis/blob/master/jwt.md) |
...
* Correção de um problema em que o nome/sobrenome do usuário (migrado) no Analytics era diferente do nome vinculado à Adobe ID do usuário na Experience Cloud. Para atualizar o nome do Analytics para o nome usado na Experience Cloud, acesse **[!UICONTROL Admin** > **!UICONTROL Gerenciamento de usuário (herdado)**>**!UICONTROL Editar usuários** e clique na ID do usuário. Em seguida, clique em **!UICONTROL Atualizar na Experience Cloud **. (AN-172825)
...
Esta versão contém a integração do Adobe Campaign com as versões gerais disponíveis (GA) das extensões Android e iOS para o Adobe Campaign Standard no Adobe Experience Platform Launch e SDKs móveis. Essas extensões suportam mensagens de push, mensagens no aplicativo e atualizações de perfis de aplicativos móveis.

Para obter mais informações, consulte [Uso do SDK](https://helpx.adobe.com/br/campaign/standard/administration/using/configuring-a-mobile-application.html#main-pars_header_49)da plataforma Adobe Experience.
...
O lançamento do Cloud Manager 2019.2.0 adiciona o Monitoramento de sistema. Esse novo recurso permite que os clientes visualizações o estado de seus ambientes de serviços gerenciados da Adobe no nível do sistema.
...
Para obter detalhes, consulte [Novidades do AEM Assets Brand Portal](https://helpx.adobe.com/br/experience-manager/brand-portal/using/whats-new.html) e [Notas](https://helpx.adobe.com/br/experience-manager/brand-portal/release-notes/brand-portal-release-notes.html)de versão.
