...
* **Relatórios e análises:** Correção de um problema que impedia os usuários de compartilharem relatórios com outros usuários. (AN-172301)
* **Administrador:** Correção de um problema com a função de edição no Gerenciamento de usuários de administração herdados: Depois de selecionar um usuário e clicar em Editar, nenhum dado sobre o usuário estava visível. (AN-170705)
...
* Correção de um problema que fazia com que os campos de pesquisa para Características, Segmentos, Destinos e Modelos não mostrassem nenhum resultado quando os termos de pesquisa terminavam com um caractere de barra invertida.
