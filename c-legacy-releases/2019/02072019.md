...
Com a atualização para uma nova versão do [Tableau](https://experiencecloud.adobe.com/resources/help/en_US/aam/c_comproc.html), alteramos o método de visualização de dados para relatórios de sobreposição. Consulte a captura de tela no Relatório de sobreposição de característica por característica. Consulte [Relatórios de sobreposição de característica por característica](https://experiencecloud.adobe.com/resources/help/en_US/aam/c_overlap_reports.html).

**Relatório de sobreposição de segmento por característica**

Com a atualização para uma nova versão do Tableau, alteramos o método de visualização de dados para relatórios de sobreposição. Consulte a captura de tela no Relatório de sobreposição de segmento por característica. Consulte [Relatórios de sobreposição de segmento por característica](https://experiencecloud.adobe.com/resources/help/en_US/aam/c_segment_trait_overlap.html)

**Relatório de sobreposição de segmento por segmento**

Com a atualização para uma nova versão do Tableau, alteramos o método de visualização de dados para relatórios de sobreposição. Consulte a captura de tela no Relatório de sobreposição de segmento por segmento. Consulte [Relatórios de sobreposição de segmento por segmento](https://experiencecloud.adobe.com/resources/help/en_US/aam/c_segment_segment_overlap.html)
