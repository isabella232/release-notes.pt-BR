...
>[!NOTE]
>
>Assine a [[!DNL Adobe Priority Product Update]](https://www.adobe.com/subscription/priority-product-update.html) para ser notificado por e-mail sobre versões futuras. Você receberá um aviso três a cinco dias úteis antes do lançamento da versão. Novas informações publicadas após o lançamento serão marcadas com a data da publicação.
...
[Distribuição](https://downloads.experiencecloud.adobe.com/) de software é a nova interface do usuário projetada para simplificar a pesquisa e o download de pacotes AEM. No momento, ela está no status beta e pode ser acessada apenas para clientes do Adobe Managed Services.
...
O [!DNL Digital Publishing Suite Classic] (DPSC) será encerrado em 31 de agosto de 2019. For more information, see the [[!DNL Digital Publishing Suite Classic] End-of-Life FAQ](https://helpx.adobe.com/digital-publishing-suite/help/eol-statement-for-dpsc.html).
...
* [Atualização 19.1.4 do Campaign Classic](https://docs.campaign.adobe.com/doc/AC/en/RN.html#9032) - compilação 9032
* [Atualização 19.1.5 do Campaign Classic](https://docs.campaign.adobe.com/doc/AC/en/RN.html#9033) - compilação 9033
