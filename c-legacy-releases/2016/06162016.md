...
<table id="table_D919A080718349AA83775BEB256B7C4A"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p>Codificação da Marketing Cloud ID (MID) </p> </td> 
   <td colname="col2"> <p>O serviço de ID codifica o valor MID originado do servidor ou quando ele está configurado pela função <span class="codeph">visitor.setMarketingCloudVisitorID()</span>. Para obter mais informações sobre o MID, consulte <a href="https://marketing.adobe.com/resources/help/en_US/mcvid/?f=mcvid_cookies.html" format="https" scope="external">Cookies e Marketing Cloud ID </a>. (AAM-23336) </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<!-- <draft-comment> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Consulte <a href="https://marketing.adobe.com/resources/help/en_US/insight/whatsnew/?f=c_release_notes_insight_62" format="http" scope="external">Atualizações de Data Workbench 6.2</a> para obter mais informações sobre a versão. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* [Captura de dados de impressão da campanha via Pixel Calls](https://marketing.adobe.com/resources/help/en_US/aam/?f=c_doc_updates.html)
* [Ambiente beta](https://marketing.adobe.com/resources/help/en_US/aam/?f=beta_environment.html)
* [URLs de API](https://marketing.adobe.com/resources/help/en_US/aam/?f=r_rest_urls.html)
