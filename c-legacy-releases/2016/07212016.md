...
| Recurso | Descrição |
|---|---|
| Ferramenta de serviço da Marketing Cloud ID | Agora, a opção de ter a ferramenta de serviço da Marketing Cloud ID carregada no DTM na parte superior da página está habilitada por padrão. |

**Correção**

Quando a ferramenta de serviço da Marketing Cloud ID é adicionada, a opção **[!UICONTROL Solicitar ID do visitante automaticamente]será selecionada por padrão.** (DTM-8189)
...
**Avisos importantes sobre o serviço da Marketing Cloud ID**
...
<table id="table_BEDD720754F84255A64598018911E336"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>O CORS permite que os navegadores solicitem recursos de um domínio diferente do atual. O serviço da <span class="keyword">Marketing Cloud</span> ID é compatível com os padrões CORS para permitir solicitações de recursos de várias origens do cliente. O serviço de ID reverte solicitações JSONP em navegadores incompatíveis com CORS. (AAM-23988) </p> <p>Consulte: </p> 
    <ul id="ul_36247A565B5842B3A5F0553440327BC8"> 
     <li id="li_1DBEEFBA4C4B452BAADCE86B102DD337"> <a href="https://marketing.adobe.com/resources/help/en_US/mcvid/?f=mcvid-cors.html" format="https" scope="external"> Suporte para CORS no serviço da Marketing Cloud ID </a> </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Os novos clientes que fizerem logon no <span class="keyword">Analytics</span> por meio da <span class="keyword">Marketing Cloud</span> podem implementar rapidamente o <span class="keyword">Analytics </span>usando a <span class="term">Introdução ao Adobe Analytics </span>e, em seguida, implantar o Analytics usando o Dynamic Tag Management. </p> <p>Esta implantação simplificada é hospedada pelo Dynamic Tag Management e permite que você: </p> 
    <ul id="ul_2479AF2B543E4C2A995A83216A4B4ABE"> 
     ...
     <li id="li_0BF98AA4DF7A4713A9E04583E98E5B6C">Implante o Analytics e o serviço da Marketing Cloud ID. </li> 
...
<table id="table_A51B298EEEB5482383505B8C5A79E1B9"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> <b>Atualizações de conteúdo do Developer Connection</b> (adicionado em 5 de julho de 2016) </p> <p>Atualizações no <a href="https://marketing.adobe.com/developer/documentation/classifications-1-4-saint/r-createexport" format="https" scope="external">Classifications.CreateExport</a>: </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_79999DF08A424BFDA59BDBCD2E738A4C"> 
      ...
      <li id="li_562AFA713CA34C009DC2FB0B4B8A26EF">Administração: corrigido um problema que impedia o controle de atividades para usuários conectados pela Marketing Cloud com a Adobe ID. A correção replica o controle de atividades para usuários conectados tradicionalmente com o nome da empresa, o nome de usuário e a senha. (AN-124792) </li> 
...
<!-- <draft-comment> 
    ...
    </ul> <p> <b>Consulte também:</b> <a href="../../c-legacy-releases/2016/07212016.md#mcvid" format="dita" scope="local"> Serviço de ID da Marketing Cloud</a>(antigo <span class="term">serviço de ID de visitante</span>) </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* Alterado o estilo da linha que divide o logon herdado e a Marketing Cloud. (AAM-24378)
...
<table id="table_8EE2C5FD9964403D91FFBCDF5FECEACE"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Integre o AEM a outras soluções da Adobe Marketing Cloud e serviços de terceiros. </p> </td> 
  </tr> 
  <tr> 
