...
* Alterado o valor padrão de ` loadTimeout`, de 500 milissegundos para 30.000 milissegundos (30 segundos). Consulte [Variáveis usadas pelo serviço de ID da função getInstance](https://marketing.adobe.com/resources/help/pt_BR/mcvid/mcvid_getinstance.html). (MCID-96)
...
* Novo: [Implementação do serviço da Experience Cloud ID para o Analytics e o Audience Manager](https://marketing.adobe.com/resources/help/pt_BR/mcvid/?f=mcvid-setup-aam-analytics.html)
* Revisado: [Testar e verificar o serviço da Experience Cloud ID](https://marketing.adobe.com/resources/help/pt_BR/mcvid/?f=mcvid-test-analytics.html)

Consulte também a documentação do produto [Serviços da Experience Cloud ID](https://marketing.adobe.com/resources/help/pt_BR/mcvid/).
...
* [Relatório de frequência ideal](https://marketing.adobe.com/resources/help/pt_BR/aam/optimal-frequency.html)
* [Conversão entre canais](https://marketing.adobe.com/resources/help/pt_BR/aam/cross-channel-conversion-reporting.html)
* [Segmentação de dispositivo com chaves de nível de plataforma](https://marketing.adobe.com/resources/help/pt_BR/aam/c_tb_device_targeting.html)


Revisado:

* [Introdução ao gerenciamento em massa](https://marketing.adobe.com/resources/help/pt_BR/aam/?f=c_bulk_start.html em massa). Inclui uma nova planilha de gerenciamento em massa.
* [Geolocalização com chaves de nível de plataforma](https://marketing.adobe.com/resources/help/pt_BR/aam/c_tb_platform_vars.html). Inclui uma lista de chaves atualizada que contém os valores mais recentes.
