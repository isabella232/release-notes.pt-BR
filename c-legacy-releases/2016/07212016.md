---
description: Notas de versão julho de 2016
keywords: notas de versão
seo-description: Notas de versão julho de 2016
...
Esta versão aprimora a a versão para 1.6.0. Inclui recursos, correções de bugs e outras alterações descritas a seguir.
  ...
  <tr> 
   ...
   <td colname="col2"> <p>O CORS permite que os navegadores solicitem recursos de um domínio diferente do atual. O serviço da <span class="keyword">Experience Cloud</span> ID é compatível com os padrões CORS para permitir solicitações de recursos de várias origens do cliente. O serviço de ID reverte solicitações JSONP em navegadores incompatíveis com CORS. (AAM-23988) </p> <p>Consulte: </p> 
    <ul id="ul_36247A565B5842B3A5F0553440327BC8"> 
     <li id="li_1DBEEFBA4C4B452BAADCE86B102DD337"> <a href="https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid-cors.html.html" format="https" scope="external"> Suporte para CORS no serviço da Experience Cloud ID </a> </li> 
...
Consulte também a documentação de produto do [serviço da Marketing Cloud ID](https://docs.adobe.com/content/help/en/id-service/using/home.html).
...
<table id="table_1207853963C64C5E95E85E9B34B6FCFE"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Em outubro de 2016, os administradores do Analytics poderão gerenciar configurações de usuários e produtos (grupos) no <span class="wintitle">Enterprise Dashboard </span>. O Enterprise Dashboard é a interface administrativa para Marketing Adobe, Creative e Document Cloud. </p> <p>Você poderá: </p> 
    <ul id="ul_BD8F095B2A2D48379928C1E4D6B86F63"> 
     <li id="li_922FB8DE1BC34567AA5316C230E27779">Criar configurações de produto para produtos, ferramentas, produtos, conjuntos de relatórios (e muito mais). </li> 
     <li id="li_598E3DA610694E13B3B0C2294E8B8096">Crie usuários e os atribua às configurações de produto. </li> 
 ...
 <p>A Adobe lançou uma <a href="https://helpx.adobe.com/br/security/products/analytics/apsb16-13.html" format="https" scope="external">atualização de segurança APSB16-13 </a>para a biblioteca <span class="term">AppMeasurement para Flash</span>. Essa atualização soluciona uma vulnerabilidade importante da biblioteca, aplicável somente quando <span class="codeph">debugTracking</span> está ativado, podendo ser usado para realizar <a href="https://www.owasp.org/index.php/DOM_Based_XSS" format="https" scope="external">ataques de XSS com base em DOM </a>. </p> <p> <p class="important">Observação: esse problema afeta o <span class="term">AppMeasurement para Flash</span> somente quando <span class="codeph">debugTracking</span> foi ativado (<span class="codeph">debugTracking </span>está desativado na configuração padrão). <b>Se for afetada, recomendamos que você desative <span class="codeph">debugTracking</span> imediatamente.</b> Alguns códigos de exemplo: </p> </p> 
  ...
  <tr> 
   <td colname="col1"> <p>Fim da vida útil da API dos Serviços da Web v 1.2 </p> </td> 
   <td colname="col02"> <p>18 de fevereiro de 2016 </p> </td> 
   <td colname="col2"> <p>A versão 1.2 da API do Web Services foi preterida oficialmente em 20 de fevereiro de 2014. Ele será encerrado em 15 de setembro de 2016. Nesse momento, o Adobe removerá a capacidade dos servidores de API de responderem às solicitações da API versão 1.2. Qualquer solicitação da API enviada ao endpoint <span class="filepath">https://api.omniture.com/admin/1.2</span> retornará um erro 404. Os clientes têm até a data do fim da vida para atualizar da API 1.2 para a versão 1.4, a fim de evitar uma interrupção em seus aplicativos de API. 
     <!--https://jira.corp.adobe.com/browse/AN-118670--></p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Código postal do Reino Unido </p> </td> 
   <td colname="col02"> <p>18 de fevereiro de 2016 </p> </td> 
   <td colname="col2"> <p>O fornecedor do serviço Adobe está mudando. Vamos passar da disponibilização de códigos postais truncados do Reino Unido para códigos postais completos em ou por volta de 18 de março. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
Correções e aprimoramentos foram aplicados aos seguintes produtos e serviços:
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> <b>Atualizações de conteúdo do Developer Connection</b> (adicionado em 25 de julho de 2016) </p> <p>Atualizações no <a href="https://marketing.adobe.com/developer/documentation/classifications-1-4-saint/r-createexport" format="https" scope="external">Classifications.CreateExport</a>: </p> 
    ...
    </ul> <p> <b>Aviso de desaprovação</b> </p> <p> A versão 1.2 da API do Web Services foi preterida oficialmente em 20 de fevereiro de 2014. Ele será encerrado em 15 de setembro de 2016. Nesse momento, o Adobe removerá a capacidade dos servidores de API de responderem às solicitações da API versão 1.2. Qualquer solicitação de API feita para o endpoint <span class="filepath">https://api.omniture.com/admin/1.2</span> retornará um erro 404. 
     </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_79999DF08A424BFDA59BDBCD2E738A4C"> 
      ...
      <li id="li_562AFA713CA34C009DC2FB0B4B8A26EF">Administração: corrigido um problema que impedia o controle de atividades para usuários conectados pela Experience Cloud com a Adobe ID. Essa correção replica o rastreamento de atividades para usuários que fazem logon tradicionalmente por meio do nome da empresa, nome de usuário e senha. (AN-124792) </li> 
      ...
      <li id="li_A5B1C8700C56426AACECBFF448DB06B3">Correção de um problema raro que fazia com que os relatórios fossem enviados, mesmo se o relatório não estivesse programado para distribuição. (AN-126552) </li> 
      <li id="li_D1237FEB03554D7793CCF09148F32530">Correção de um problema de logon para usuários cujo logon de produto padrão era o SearchCenter (AN-126281). </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_6F297BE1227F4A09B3B6E69330CE648E"> 
      ...
      <li id="li_413B05B2DE7B4910B80A334A4AD8D26A"> Correção de um erro que ocorria ao baixar projetos em PDF ao visualizá-los no navegador Chrome. (AN-123674) </li> 
      ...
      <li id="li_C6B5C8D3ED38475889EDBBB7DFC0E4F3">Correção de um problema no agendamento semanal de projetos que resultava na não exibição correta do dia da semana na interface. (AN-125760) </li> 
      ...
      <li id="li_D8E69F309E144BCB999B19B59AE502A4">Correção de um problema aleatório que impedia a exibição dos painéis do projeto após o logon. (AN-124635) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_BB48AEAB77574B79A823FBA770449105"> 
      ...
      <li id="li_11C668A5F12F46C0969C279F33F3AC6D">Remoção de métricas de sobreposição não suportadas (Novos visitantes e Novos clientes) do Activity Map. (AN-124056) </li> 
      ...
      <li id="li_7044F2E995024A48873E6209146C1678">Correção de um problema que fazia com que as métricas calculadas não fossem exibidas após recarregar a página. (AN-125900) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Report Builder </td> 
   <td colname="col2"> <p> Suporte aprimorado para pastas de trabalho de agendamento que foram abertas inicialmente na interface da Web do Excel pelo Office 365. (AN-118240 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Data Warehouse </td> 
   <td colname="col2"> <p> 
     <ul id="ul_21AA1745F6154EFAA67D00D9531417D3"> 
      <li id="li_77E57F08C316489D959009967CB160C9"> Adicionar suporte de segmento para exibições de página no Data Warehouse (AN-125067). </li> 
      <li id="li_59787469534B455686696BA9E095D388"> Correção de um problema de lógica de segmento em regras em que um valor de hash "0" estava presente na tabela de pesquisa de classificação (AN-125340). </li> 
      <li id="li_047E532F694B4999BC3EF156FA8029AC">Adição da capacidade de enviar relatórios vazios em vez de responder com "sem dados". (AN-126210) </li> 
      <li id="li_4D264642BB344468A8A6E2D6EB3B7C82">As novas listas de distribuição de email criadas após as alterações do Conjunto de relatórios virtual da interface agora funcionarão no Data Warehouse. (AN-123842) </li> 
      <li id="li_74CFDE5092ED471594A4EE8893D2ADEA">O detalhamento agora fornece tipos MIME adequados em emails produzidos (AN-124243) </li> 
...
<!-- <draft-comment> 
    ...
    </draft-comment> --> <p> <b> <span class="keyword"> AppMeasurement</span> para JavaScript</b> </p> <p> <b>4/8/2016:</b> Versão <b>1.6.3</b></p> <p> Correção de um problema em que o AppMeasurement encerrava prematuramente as conexões de solicitação. (AN-126448) </p> <p> <p class="important">Observação: a versão 1.6.0 do serviço da <span class="keyword">Experience Cloud</span> ID <i>exige</i> o AppMeasurement para a versão 1.6.3 ou superior do JavaScript. Caso queira atualizar para a versão 1.6.0 do serviço da Experience Cloud ID, é preciso que você esteja usando a versão 1.6.3 ou superior do código AppMeasurement. </p> </p> <p> <b> <span class="keyword"> AppMeasurement</span> para JavaScript</b> </p> <p>Versão <b>1.6.2</b></p> <p> 
     <ul id="ul_3AAA9C4D782142DEBC1575283AE90CC5"> 
      ...
      <li id="li_C64B1DCB5679439A8FD77CF03A4D5F3B">Correção de um problema que fazia com que o AppMeasurement chamasse o método ofuscado errado na API do visitante. (AN-126006) </li> 
      <li id="li_B9E05F749D93432C8D5D7A7D1BA0A070">Correção de um problema que causava o erro de JavaScript: "Atributo válido somente em v:image". (AN-124009) </li> 
     </ul> </p> 
<!-- <draft-comment> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>O <span class="wintitle">Relatório de amostragem de erros</span> verifica as taxas de sucesso e falha para registros de processamento em seus arquivos internos de origem de dados. O relatório de erros exibe dados em um gráfico de barras interativo e fornece métricas de resumo em forma de tabela. Além disso, inclui uma opção que coleta arquivos para um intervalo de tempo fixo e exibe os erros mais comuns para cada tipo de erro. </p> <p>A documentação estará disponível quando o recurso for lançado no final de julho. </p> </td> 
  </tr> 
  <tr> 
...
* Correção de um erro em que os relatórios de Regras de mesclagem de perfil exibiam 0. (AAM-24685)
* Correção de um erro em que os clientes não conseguiam editar ou excluir grupos de usuários devido a um erro de chave exclusivo na tabela de auditoria. (AAM-24864)
* Correção de um erro em que nenhum limite estava sendo aplicado em destinos S2S e S2S em massa. (AAM-24905)
* Alterado o estilo da linha que divide o logon herdado e a Experience Cloud. (AAM-24378)
* Correção de um erro em que mensagens de erro incorretas eram exibidas após a exclusão de usuários, grupos ou fontes de dados. (AAM-24638)
...
* Correção de um problema em que os botões de alternância que ativavam determinados encurtadores de links não funcionavam.
...
<table id="table_99BD3F007D164A2AA415E78C633D7927"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>O Gems on AEM é uma série de aprofundamentos técnicos fornecidos por especialistas em Adobe. A série complementa a documentação do produto e os canais técnicos. Também ajuda os desenvolvedores a entrar em contato e explorar um tópico específico em detalhes. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_04819C0464594ECFB211C253C34E69CA"> 
 <thead> 
  <tr> 
   <th colname="col1" class="entry"> <p>Versões de hotfix AEM </p> </th> 
   <th colname="col2" class="entry"> <p>Descrição </p> </th> 
  </tr> 
 </thead>
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <a href="https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/aem-releases-updates.html?lang=pt-BR" format="https" scope="external"> Hot fixes do AEM 6.2 </a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="https://helpx.adobe.com/br/experience-manager/kb/aem61-available-hotfixes.html" format="https" scope="external"> Hot fixes do AEM 6.1 </a> </p> </td> 
...
A tabela a seguir contém uma seleção de links para os tópicos sugeridos. Esses tópicos podem ajudá-lo a aproveitar ao máximo a implementação e o uso do AEM.
...
<table id="table_8EE2C5FD9964403D91FFBCDF5FECEACE"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>AEM inclui a interface otimizada para toque e a interface clássica. Assim, o tópico "Interface do usuário do Recommendations para clientes" pode ajudá-lo a decidir qual interface do usuário é melhor para você usar. Essas informações são úteis durante a implementação do projeto ou quando você atualiza de uma versão anterior. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Informações sobre quando criar índices e quando eles não são necessários. Também inclui dicas para evitar o uso de consultas quando elas não forem necessárias, e dicas para otimizar o desempenho de índices e consultas. </p> </td> 
  </tr> 
  <tr> 
...
A ajuda da Advertising Cloud está disponível no produto em **[!UICONTROL ? > Conteúdo da ajuda]**.
...
<table id="table_D245BAB62A304D5B9018375ABFEFFC09"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> Anúncio importante sobre mudanças de permissão que chegarão no último trimestre de 2016. </p> </td> 
   <td colname="col3"> <p>21 de julho de 2016 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <a href="https://docs.adobe.com/content/docs/en/aem/6-2.html" format="https" scope="external"> Adobe Experience Manager 6.2 </a> </td> 
   <td colname="col2"> <p>O Adobe Experience Manager 6.2 é uma versão de atualização da base de código do Adobe Experience Manager 6.1. Ela fornece funcionalidades novas e aprimoradas, correções essenciais para o cliente, melhorias para clientes de alta prioridade e correções gerais de erros voltadas para a estabilização do produto. Ele também inclui o pacote de recursos do Adobe Experience Manager 6.1, hotfix e versões de service pack. </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Foi adicionada uma tabela de comparação de produto para produtos do Analytics. </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Atualização da documentação do produto Analysis Workspace com descrições de recursos, tarefas para criar projetos, vídeos e casos de uso. </p> </td> 
   <td colname="col3"> <p>17 de setembro de 2015 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Adição de documentação do produto e práticas recomendadas para carimbos opcionais de data e hora. Esse recurso permite integrar dados com e sem carimbos de data e hora em um conjunto de relatórios. Por padrão, todos os novos conjuntos de relatórios terão Carimbos opcionais de data e hora. </p> </td> 
   <td colname="col3"> <p>17 de setembro de 2015 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>O Link de perfil trabalha com fontes de dados de vários dispositivos para identificar e coletar características de visitantes autenticados do site. Inclui o recurso Regras de mesclagem de perfil , que permite segmentar e direcionar usuários com precisão em vários dispositivos. </p> </td> 
   <td colname="col3"> <p>20 de agosto de 2015 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Crie tabelas de dados e arraste e solte métricas, dimensões, segmentos e várias visualizações em um painel do projeto. </p> </td> 
   <td colname="col3"> <p>18 de junho de 2015 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>A documentação do produto Adobe Mobile foi alterada. </p> </td> 
   <td colname="col3"> <p>22 de maio de 2015 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Um resumo de alto nível do que é necessário fazer para modernizar as implementações da solução para os serviços principais. </p> </td> 
