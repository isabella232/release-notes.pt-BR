...
Consulte [Novidades na Experience Cloud - Primeiro trimestre de 2016](https://marketing.adobe.com/resources/help/pt_BR/mcloud/marketing-cloud-interface.html) para obter mais informações.
...
A documentação inclui novo conteúdo de procedimentos para o [!DNL  Target]. Consulte [Implementar o serviço da Experience Cloud ID com o Analytics](https://marketing.adobe.com/resources/help/pt_BR/mcvid/?f=mcvid-setup-target.html).
