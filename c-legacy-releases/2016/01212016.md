---
description: Novos recursos na Analysis Workspace (desfazer ações, "Salvar como" na segmentação, vinculação de projeto, novas visualizações e mais). Função de média cumulativa avançada em Métricas calculadas (Analytics). Experience Cloud SSO (Report Builder). Notificações administrativas para publicações de propriedade (DTM). Feeds de dados sem marca e privados para Audience Marketplace (Audience Manager). Correções gerais e melhorias nas soluções.
...
A versão do gerenciamento dinâmico de tags lançada em 14 de janeiro de 2016 inclui as seguintes alterações:
...
<table id="table_22414D3AA4CE4B199BC88898AADD3903"> 
 ...
 <tbody> 
  <tr valign="top"> 
   <td colname="col1"> <p>Notificações administrativas para publicações de propriedades </p> </td> 
   <td colname="col2"> <p>Agora, os administradores podem receber uma notificação por email quando uma de suas propriedades da Web é publicada. O email contém a hora e o nome da propriedade. </p> </td> 
  </tr> 
  <tr valign="top"> 
   <td colname="col1"> <p>Nomes de host relativos </p> </td> 
   <td colname="col2"> <p>Você pode especificar nomes de host relativos para hospedagem de bibliotecas de preparo e produção. </p> </td> 
  </tr> 
  <tr valign="top"> 
   <td colname="col1"> <p>Ferramenta Nielsen </p> </td> 
   <td colname="col2"> <p>Você pode ativar o rastreamento Nielsen usando o gerenciamento dinâmico de tags, criando a ferramenta Nielsen e configurando o código da página automática ou manualmente. Recomendamos o método automático para a maioria dos usuários. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* Corrigido um problema ao usar várias regras de evento personalizadas que fazia com que somente a primeira regra fosse acionada. (DTM-7026)
* Correção de um problema que impedia o carregamento da biblioteca principal para determinados clientes. (DTM-7130)
* Correção de um problema com o Internet Explorer 9 que fazia com que o contador Nielsen de tempo gasto na página permanecesse pausado depois que o navegador ou a guia do navegador perdesse e recuperasse o foco. (DTM-7033)
* No Internet Explorer 8, o mecanismo de detecção não-humano em formulários apresenta falhas. Como o IE8 não é mais compatível, esse problema não será corrigido. Atualize seu navegador se isso for um problema para você. (DTM-7101)
...
>[!NOTE]
>
>Com a versão de manutenção de julho de 2016, a Ad Hoc Analysis deixará de ser compatível com o Java 6.
...
<table id="table_FDDBAC10B423475289A83A653402E2F3"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> Os prefixos de ID do conjunto de relatórios não podem mais ser alterados. O Atendimento ao cliente ou os Gerentes de conta não podem mais alterar prefixos ou criar conjuntos de relatórios sem prefixos. <a href="https://docs.adobe.com/content/help/pt-BR/analytics/admin/manage-report-suites/new-report-suite/new-report-suite.html" format="https" scope="external"> Mais... </a> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Criador de métricas calculada </td> 
   <td colname="col2"> A Função média cumulativa avançada agora está disponível no Construtor de métricas calculadas. <a href="https://docs.adobe.com/content/help/en/analytics/components/calculated-metrics/calcmetrics-reference/cm-adv-functions.html" format="https" scope="external"> Mais... </a> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Permissões para Criar segmento/Criar métrica </td> 
   <td colname="col2"> Se um usuário não tiver permissões para Criar segmento ou Criar métrica, ele não poderá mais acessar o Construtor de segmentos ou o Construtor de métricas calculadas. <a href="https://docs.adobe.com/content/help/pt-BR/analytics/admin/user-product-management/user-groups/groups.html" format="https" scope="external"> Mais... </a> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Estimar chamadas do servidor e agendar picos </td> 
   <td colname="col2"> Permite obter a média diária de chamadas do servidor do ano passado durante um período específico, além de um aumento esperado no volume de chamadas do servidor para este ano. Você pode, então, agendar um pico de tráfego com base nesse fator de multiplicação. <a href="https://docs.adobe.com/content/help/en/analytics/admin/traffic-management/traffic-spike-estimate-past-server-calls.html" format="https" scope="external"> Mais... </a> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>As novas visualizações incluem: </p> 
    <ul id="ul_5DBEF930ABB64CAEBEF82A7BEBB02890"> 
     ...
     <li id="li_CCD67E6FA0E842FEA7B089C840562666">Mapas de árvore </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Nas <span class="wintitle">Configurações de coluna</span>, a nova opção de <span class="uicontrol">Formatação condicional</span> aplica cores às células, de acordo com os valores de dados: </p> 
    <ul id="ul_6E9C6F908AD84814AF16067644BDF4DA"> 
     ...
     <li id="li_3764E0C2DA9646CE92D860ECCF67ADD6">Amarelo: valores de ponto médio </li> 
...
Para obter mais informações sobre esses recursos, consulte [Novos recursos na Analysis Workspace - Janeiro de 2016](https://docs.adobe.com/content/help/en/analytics/analyze/analysis-workspace/new-features-in-analysis-workspace.html).
...
|---|---|
| Logon único | Adicionado o suporte para o logon único da Experience Cloud. |
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7CC12EBCEBD943B1B329594D13DCF66C"> 
      <li id="li_3E59DBFECA4A4662AB039194F4BF1E9D">As Instâncias do referenciador foram alteradas para que o sistema usasse a primeira ocorrência de uma visita em vez de <span class="varname">visit_page_num</span>. <span class="varname"> visit_page_num </span>não altera os limites do mês quando novos meses são mesclados. (AN-89779)</li> 
      <li id="li_8BCED303EC1E4D008E7D3862142EDF30">(AN-116415) Alterada a forma como as versões do navegador Microsoft Edge são exibidas nos relatórios, para que sigam as versões do mecanismo EdgeHTML subjacente em vez do aplicativo Edge. Por exemplo, os relatórios exibirão o nome esperado do Edge 12 e 13 em vez do Edge 20 ou 25. </li> 
      <li id="li_294227DF6E1346F18F5FA38805A5C2C3">(AN-114795) Corrigidos os problemas que ocorriam quando a página "Meus relatórios recomendados" recuperava itens de widgets provenientes da mesma classificação. </li> 
      <li id="li_FC36644A6F3645F484E296A68EF63139">(AN-114982) Corrigido um problema relacionado ao fuso horário nos relatórios em tempo real. </li> 
      <li id="li_E4909E533B864E948E9E8B27A84D8A15">(AN-114146) Corrigido um problema com permissões que não são de administrador na interface do relatórios. </li> 
      ...
      <li id="li_19FF0A1F7B524FFF998A6EE58F3E1F64">(AN-113792) Corrigido um problema com gráficos que não alinhavam com intervalos de datas selecionados. </li> 
      <li id="li_DC6C29757E034F7BBB2CC6D0AD36075E">(AN-112854) Corrigido um problema com pré-visualizações de segmento inconsistentes que estava relacionado às diferenças de fuso horário. </li> 
      <li id="li_CDA5D6C6F58043EABD08467C80FD7403">(AN-114796) Corrigido um problema com gráficos ilegíveis em painéis. </li> 
      ...
      <li id="li_ABA29425A7C74422A5CF5333ACCA2E73">(AN-116951 + AN-113917) Corrigido um problema que impedia o acesso aos dados do aplicativo móvel. </li> 
      <li id="li_6F60B031FFD94AACA974B029B99DF3AB">(AN-115159) Corrigido um problema que limitava o relatório Próxima página a exibir apenas 10 páginas. </li> 
      <li id="li_8763446953A04599AE0792498655D8A0">(AN-102095) Corrigido um problema no qual as regras de processamento não podiam ser salvas com conjuntos de caracteres multibytes. </li> 
      <li id="li_67706A910F1A4C199B7481B6A2D7C4FA">(AN-116040) Corrigidos problemas com pesquisa, colunas e intervalos de datas no log do relatório. </li> 
      ...
      <li id="li_EE3722FD26634D5D9423ABD9776A59CE">(AN-115887) Corrigido um problema que fazia com que as configurações de segmento compartilhado fossem substituídas ao tentar compartilhar com uma nova pessoa. </li> 
      <li id="li_9420B1CC3404443B911BD7D02010C6CA">(AN-113559) Corrigido um problema com a classificação reversa em reportlets. </li> 
      <li id="li_CF8C511B25064E6681A9E2F07650F952">(AN-101851) Corrigido um problema no qual, em relatórios de tendências e de horas extras, somente o primeiro segmento de vários segmentos era aplicado aos dados. </li> 
      <li id="li_AA338C2388DB46CA99B9F98FF78BCFA9">(AN-114643) Corrigido um problema que impedia o reordenamento de novas regras de processamento. </li> 
      ...
      <li id="li_668850F29FB94B1F8348D34532B9E8BB">(AN-115952) Corrigido um problema no qual configurações exclusivas de gravação de evento para Eventos bem-sucedidos não eram retidas. </li> 
      ...
      <li id="li_A8D3F843405240888BC8686578321008">(AN-116521) Corrigido um problema no qual o tempo de resposta da interface do usuário ficava lento ao editar vários conjuntos de relatórios. </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_EAE1705BFB6E4A6E9A615283D84255BC"> 
     <li id="li_6733014E4EA64040AFD88F0E12DA1BE5"> (AN-113537) Melhoria da interface para permitir larguras de 1/3 e 2/3 para painéis e visualizações (anteriormente, a interface permitia larguras de 1/4 e 1/2). </li> 
     ...
     <li id="li_1734A619577D4F159CB1C710717DA619">(AN-114881) Melhoria no tempo de carregamento do projeto e adição da capacidade de abrir mais painéis e visualizações sem reduzir o desempenho. As visualizações que dependem dos dados do painel não são exibidas antes de os dados do projeto terminarem de ser carregados. </li> 
     <li id="li_73155623CEA94A559125EBAADC95B700">(AN-114551) Melhoria da experiência de curadoria ao adicionar métricas e intervalos de datas personalizados ao menu de detalhamento do botão direito do mouse. </li> 
     <li id="li_E0B8FF4CB5F24EF3A4653A018BF0D6A7">(AN-108368) Os intervalos de datas personalizados agora são exibidos com datas predefinidas. </li> 
     ...
     <li id="li_43DE24B9F71A45EE87B6AFDBE3E4FA0E">(AN-115592) Corrigido um problema de renderização de visualização que impedia que os intervalos de datas personalizados fossem exibidos em gráficos de linha, de modo semelhante ao modo como as dimensões de tempo predefinidas são exibidas. Anteriormente, um erro era emitido na visualização de intervalos de datas personalizados. </li> 
     ...
     <li id="li_377AB2C88D9346EBAA9596C93A9A020A">(AN-115951) Corrigido um problema que causava a exibição de um erro inesperado quando um projeto era aberto e ocorria um tempo limite. </li> 
     <li id="li_EE82BE2DDD854D8A8140FA6211FC805C">(AN-115493) Corrigido um problema que impedia a exibição de linhas cintilantes após salvar e recarregar um projeto. </li> 
     ...
     <li id="li_88E561AC21D940029A899AFF5EA39AF0">(AN-114970) Corrigido um problema que impedia que alguns projetos compartilhados fossem exibidos na lista do projeto. </li> 
     <li id="li_01940AA33CAA427C8DB09CCDE640F5DF">(AN-114957) Corrigidas as dicas de marca de orientação de Curadoria para que elas sejam exibidas para o elemento de interface correto e para usuários com permissões adequadas. </li> 
     ...
     <li id="li_AF9F0A35C9C149F19152BAD81E2CFA58">(AN-114253) Corrigido um problema que fazia com que os gráficos de barras em várias linhas estáticas desaparecessem se uma linha fosse excluída. </li> 
     <li id="li_8BB40B571184438EA75E19B3FBC33533">(AN-107079) Corrigido um problema no qual nenhum dado retornado causava um erro inesperado ao criar um projeto. </li> 
    </ul> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_BCA85EDE14C2445C8C10BDD77ED342A6"> 
      <li id="li_FD1E9A3A72564BE293BBAF1BD13A0339">(AN-114365) Corrigido um problema com Contar instâncias repetidas. </li> 
      <li id="li_7F6FDE746974409FACB9A7CFE72B6C24">(AN-114802) Corrigido um problema de permissões que impedia dimensões de serem visíveis. </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_9A4E12DD7F254411AA9452735D63CA80"> 
      <li id="li_A06DD2F318FF4187A23786FB44E2A8E6">Correção de um problema com valores de Total de segundos gastos. Eles não serão mais reportados como negativos quando as ocorrências com carimbo de data e hora forem recebidas fora de ordem. </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
...
<!-- <draft-comment> 
    ...
    <ul id="ul_84D7A6675B6F4971A04A5D1B3B45DAB9"> 
     <li id="li_FF9A115336C34F4C858BCEE6D8D067B7">(AN-115381) Corrigida a manipulação do módulo Audience Manager quando POSTs são usados para rastrear chamadas. </li> 
     <li id="li_65443DC62F384DFD8EAE9C4E08DC88F2"> (AN-114647) O restante do URL da página ("-g") foi movido para o final da sequência de query da solicitação de rastreamento. </li> 
...
* [Como entender o relatório de cobrança do provedor de dados](https://marketing.adobe.com/resources/help/en_US/aam/marketplace-billing-report.html)
* [Como entender a página de detalhes do plano no Audience Marketplace](https://marketing.adobe.com/resources/help/en_US/aam/marketplace-buyer-details.html)

Revisado:

* [Dados de características e tamanho do segmento no Criador de segmentos](https://docs.adobe.com/content/help/pt-BR/audience-manager/user-guide/features/segments/segment-builder-data.html)
* [Macros de modelo de saída](https://marketing.adobe.com/resources/help/en_US/aam/outbound-template-macros.html)
* [Exemplos de macro de saída](https://marketing.adobe.com/resources/help/en_US/aam/outbound-macro-examples.html)
...
* Aprimoramento da função de pesquisa de tags para permitir pesquisas &quot;difusas&quot;. Por exemplo, para localizar uma tag chamada &quot;Adobe Social&quot;, um usuário pode digitar &quot;Adobe&quot; ou &quot;Social&quot;. (AS-35219)
* Correção de um problema que impedia os usuários de editar nomes de tags com erros ortográficos pressionando Backspace ao mover uma tag de um grupo para outro. (AS-35788)
* Correção de um problema que impedia os usuários de mover ou mesclar tags. (AS-35753, AS-35712)
* Correção de um problema que impedia os usuários de mover um grande número de tags de um grupo para outro grupo. (AS-35724)
...
* Correção de um problema que fazia com que uma notificação de email incorreta fosse enviada para um usuário indicando que o usuário tinha aprovado uma publicação. (AS-35783)
* Correção de um problema que às vezes causava um erro ao segmentar geograficamente postagens do Facebook por cidade. (AS-35711)
...
* Correção de um problema que fazia com que os usuários recebessem uma mensagem de email incorreta indicando falha no rastreamento de campanhas. (AS-35655)
* Correção de um problema que causava a falta de conteúdo de publicação nos feeds de moderação. (AS-35648)
* Correção de um problema que fazia com que a mensagem de email de notificação automática incorreta fosse enviada para mensagens privadas do Facebook. (AS-34376)
