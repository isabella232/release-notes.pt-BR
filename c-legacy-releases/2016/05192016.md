...
<table id="table_D01BAD87E351453EA70A66B3B56F11F6"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Melhorias no rastreamento de aquisição </p> </td> 
...
Esta versão inclui as seguintes alterações, melhorias e correções.

<table id="table_899AD81646E24BE49EB86F7FF75718E1"> 
 <thead> 
  <tr> 
   <th colname="col1" class="entry"> Alterar </th> 
   <th colname="col2" class="entry"> Descrição </th> 
  </tr> 
 </thead>
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_0A126115FB8E4C8B81D0FDBBB63C9F85"> 
     <li id="li_FD2534C49B244AAE9729E99C6FED9E03">1.5.5 (beta): Esta é uma versão de teste para alguns clientes específicos. Não use esta versão. </li> 
     <li id="li_D8226C3FEAF7458BB806EA75370223C9">1.5.6: Use esta versão se precisar atualizar seu código. </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <b>Correções de erros</b> </p> </td> 
   <td colname="col2"> <p>Correção de um bug que retornava o nome de empresa errado se tivesse várias IDs de organização. (AAM-23861) </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <b>Documentação</b> </p> </td> 
   <td colname="col2"> <p>Adição de uma nova documentação que descreve como integrar a Experience Cloud ID no Data Workbench. Consulte <a href="https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid-dwb.html.html" format="https" scope="external">Serviço da Experience Cloud ID e Data Workbench </a>. (AAM-23727) </p> </td> 
  </tr> 
 </tbody> 
</table>

Consulte a documentação do produto dos [Serviços da Marketing Cloud ID](https://docs.adobe.com/content/help/pt-BR/id-service/using/home.html).
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> Analysis Workspace: Tipo de filtro adicionado </td> 
   <td colname="col2"> <p>Adição do tipo de filtro “Falhou” no <span class="wintitle">Gerenciador de projetos programados </span>. Este recurso mostra todos os projetos agendados que não estão mais em execução devido a falhas repetidas. Ela está desmarcada por padrão. Cada instância com falha tem um ícone de aviso que, ao passar o mouse sobre ele, indica o motivo da falha. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Ferramentas administrativas: Metadados de anúncio de vídeo e vídeo </td> 
   <td colname="col2"> <p>Ao editar as configurações de vídeo de um conjunto de relatórios em <span class="uicontrol">Ferramentas administrativas</span> &gt; <span class="uicontrol">Conjuntos de relatórios</span> &gt; <span class="uicontrol">Editar configurações</span> &gt; <span class="uicontrol">Gerenciamento de vídeo</span>, você pode habilitar mais relatórios de vídeo marcando a caixa de seleção Metadados de vídeo e de anúncio de vídeo. Os metadados podem ser anexados a um vídeo e/ou a um anúncio para descrever e classificar ainda mais o vídeo ou anúncio. Os metadados padronizados de vídeo e anúncio são coletados por meio de variáveis e classificações da solução. </p> <p>Os valores incluem: Mostrar, Temporada, Episódio, ID do ativo, Gênero, Primeira data de exibição, Primeira data digital, Classificação do conteúdo, Originador, Rede, Tipo de exibição, Carregamentos de anúncio, MVPD, Autorizado, Parte do dia, ID da sessão de vídeo, Anunciante, ID da Campanha e ID criativa. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_B6AD0D7125EB43A990C9B3D87F9C8A1D"> 
     ...
     <li id="li_7EB1AEF08CB34E10BBBE2E58C1890AC2">Adicionada uma lista de segmentos selecionados na parte inferior do painel suspenso Segmento para que os usuários não precisem rolar por todos os segmentos para ver os selecionados. (AN-122464) </li> 
  ...
  <tr> 
   <td colname="col1"> Relatórios de mensagens para dispositivos móveis </td> 
   <td colname="col2"> <p>Adicionado suporte para notificações locais de mensagens móveis do relatórios. </p> <p>Adicionamos um novo evento em <span class="ignoretag"><span class="uicontrol">Aplicativo móvel</span> &gt; <span class="uicontrol">Relatórios de mensagens</span> &gt; <span class="uicontrol">Impressões de mensagens no aplicativo </span> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7CC12EBCEBD943B1B329594D13DCF66C"> 
      <li id="li_294227DF6E1346F18F5FA38805A5C2C3">Correção de um problema que ocorria ao tentar editar eVars para vários conjuntos de relatórios simultaneamente. O menu não carregava após o eVar 38. (AN-120804) </li> 
      ...
      <li id="li_FA4F75C0A239423B94394E94345D84C3">Correção de um problema que causava a falha de cópia das regras de processamento. (AN-122109) </li> 
      <li id="li_81F059A6216A4026B336FFBDF3AA0670">Corrigido um problema que impedia o compartilhamento de audiências entre o Analytics e o Público alvo. (AN-120472) </li> 
      ...
      <li id="li_B94C4090513D482CBC09A95D6AEE1C87">Correção de um problema que impedia o download e o envio de painéis. (AN-122800) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_9DD79A9FD0014CA285E372FAD2BF9FE2"> 
      ...
      <li id="li_1F32EAB8E7814E02955C0FD545970838">Correção de um problema de incompatibilidade de dados de "Visitantes únicos" entre Coorte e Análise de forma livre. (AN-122449) </li> 
      <li id="li_F26FFE0694804EC3B9FEAC54586DAC93">Correção de um problema de exibição que ocorria ao minimizar os painéis de forma livre com larguras e alturas personalizadas. (AN-122651) </li> 
      ...
      <li id="li_BC5743B301F24B138CF2CB412C0E31A0">Correção de um problema de exibição que impedia que uma lista se ajustasse a uma diminuição no tamanho da tela. (AN-122815) </li> 
      <li id="li_74155E28492C4772A09D66AF12EC278B">Corrigido um erro na caixa de texto quando o tipo de visualização "Texto" era arrastado para um painel de Forma livre. (AN-122801) </li> 
      <li id="li_BB724E9101A8490496A28EA04D7B3D7A">Correção de um problema de exibição com o corpo do email ao receber um projeto agendado como um PDF em um ambiente localizado. (AN-121967) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_3043079A3AAA425683D252708FDD7D19"> 
      <li id="li_1C899F516436470E91C427C3E7CE35DA">Correção de um problema que fazia com que o relatório "Cidades" mostrasse valores desconhecidos em todas as ferramentas do Analytics. (AN-121533) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Activity Map </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_9A4E12DD7F254411AA9452735D63CA80"> 
      <li id="li_A06DD2F318FF4187A23786FB44E2A8E6">Correção de um problema que fazia com que algumas solicitações de Data Warehouse canceladas exibissem o status errado. (AN-122436) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_9A5FC169793F4266922D1352CF0428AE"> 
      ...
      <li id="li_F2D18193EBED47468271054818713392">Correção de um problema em que os arquivos da Fonte de Dados não eram carregados e exibiam 0 linhas na interface do usuário. (AN-120969, AN-120757, AN-120274, AN-114049) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
...
* Correção de um erro nas Regras de mesclagem de Perfis que exibiam um intervalo de datas de 1 dia nas Métricas de identidade autenticadas. (AAM-24100)
* Correção de um bug na interface do usuário administrativa que impedia a desativação de uma conta de usuário quando ela estava em um status pendente. (AAM-16087)
* Correção de um bug que impedia a reativação de um segmento pausado. (AAM-23938)
* Correção de um erro que impedia a limpeza de uma caixa de seleção de Regra de mesclagem de Perfil selecionada. (AAM-23359)
* Correção de um bug que impedia a ativação de um feed de dados privados. (AAM-23395 e relacionado, AAM-23377)
* Correção de um bug que mostrava dados de demonstração no Audience Marketplace. (AAM-23837)
* Correção de um bug na ferramenta de pesquisa Destinos que mantinha os resultados da pesquisa quando você navegava para fora da página e retornava mais tarde. (AAM-23860)
* Correção de um bug que impedia a atualização da navegação estrutural conforme você se movia para telas diferentes. (AAM-24120)
* Correção de um erro que impedia a exibição correta das telas Características e gráficos. (AAM-24141)
* Correção de um erro que impedia a exibição correta das seções Usuários e grupos. Afeta somente usuários com acesso administrativo. (AAM-24144)

**Atualizações de documentação**

## [!DNL Social]

Revisão da seção [Destinos](https://docs.adobe.com/content/help/pt-BR/audience-manager/user-guide/features/destinations/destinations.translate.html#purposes). As alterações incluem documentos de procedimentos simplificados e reorganização de conteúdo.
...
* Correção de um problema que fazia com que mensagens de email de duplicado fossem enviadas durante o fluxo de trabalho de aprovação.
* Correção de um problema que fazia com que os usuários recebessem mensagens de email indicando falha no rastreamento de campanha.
...
<table id="table_04819C0464594ECFB211C253C34E69CA"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Pacote de hot fixes AEM 6.2 </p> </td> 
...
<table id="table_D0FFD1AD5C0D4BAA81BAEC60E8B2290F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>O Gems on Adobe Experience Manager é uma série de soluções técnicas oferecidas por especialistas em Adobe. Esta série complementa a documentação do produto e os canais técnicos, e permite que os desenvolvedores entrem em contato e explorem um tópico específico. </p> <p>A próxima sessão é quarta-feira, 1 de junho de 2016. O tópico é AEM desempenho da Web. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Junte-se a nós em 24 de maio de 2016 para esta sessão de aprofundamento sobre como a funcionalidade da comunidade funciona no Experience Manager. Além da apresentação e demonstração ao vivo, os especialistas em matéria de assunto responderão às suas perguntas relacionadas ao AEM Communities. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_8EE2C5FD9964403D91FFBCDF5FECEACE"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>O Adobe Experience Manager inclui a interface de usuário clássica e a interface otimizada para toque. Dessa forma, o tópico "Interface do usuário Recommendations para clientes" pode ajudá-lo a decidir qual interface é melhor para você usar durante a implementação do projeto ou ao atualizar de uma versão anterior. </p> </td> 
  </tr> 
  <tr> 
