...
Adicionado ` disableThirdPartyCalls` como um sinalizador booleano opcional, que pode ser definido na função ` Visitor.getInstance`. Quando ` disableThirdPartyCalls= true`, o serviço de ID não fará chamadas para outros domínios. Por padrão, ` disableThirdPartyCalls= false` Consulte [disableThirdPartyCalls](https://marketing.adobe.com/resources/help/pt_BR/mcvid/?f=mcvid-disablethirdpartycalls.html). (MCID-51)
...
* Um postagem retuitada do [!DNL  Adobe Social] agora é exibida da mesma forma que uma retuitada nativamente no Twitter.  Para obter mais informações, consulte [Moderar um Tweet individual](https://marketing.adobe.com/resources/help/pt_BR/social/t_mod_individual_tweet.html individual) e [Publicar um Tweet como citação](https://marketing.adobe.com/resources/help/pt_BR/social/t_post-quoted-retweet.html).
* Tags sociais estarão disponíveis no Adobe Analytics após 1 de outubro (data exata a ser definida).
   * Depois de 1° de outubro, os usuários do [!DNL  Adobe Social] poderão usar as [tags sociais](https://marketing.adobe.com/resources/help/pt_BR/social/c_settings_tag_manr.html social) para classificar o conteúdo externo e relatar o conteúdo em questão no [!DNL  Adobe Analytics]. Para acessar este novo recurso, entre em contato com o administrador da sua conta do [!DNL  Adobe Social] ou com o Suporte do Social. Ali você receberá atualizações sobre novas etapas do acesso e ajuda para a ativação.
