...
* Corrigido um problema com senhas técnicas que causava um erro ao compartilhar pasyas entre a Creative Cloud e a Marketing Cloud. (MAC-31067, MAC-32014)
...
>* Ao usar a Biblioteca 2.0.0+ do serviço da Marketing Cloud ID, a sincronização de ID é iniciada para o Adobe Media Optimizer por padrão. Consulte [Entender sincronização de ID e taxas de correspondência](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-match-rates.html).
...
<table frame="all" colsep="1" rowsep="1" id="table_812CAB7DDC364DAABB7CDEDE55532E39"> 
 ...
 <tbody> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> <p>Adicionados carimbo de data e hora e ID de empresa da Marketing Cloud ao parâmetro <span class="codeph">adobe_mc</span>. </p> </td> 
  </tr> 
  <tr rowsep="1"> 
...
<!-- <draft-comment> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Para adquirir uma taxa de correspondência de visitantes mais alta entre o Adobe Analytics e o Adobe Target, aumentamos a quantidade de tempo em que os dados são mantidos para processamento, de 30 para 60 segundos. Essa alteração afeta somente os clientes que estão usando o serviço da Marketing Cloud ID, o AppMeasurement para Analytics e que tiverem o Target implementado em suas páginas. (AN-128584) </p> </td> 
  </tr> 
  <tr> 
...
<!-- <draft-comment> 
    ...
    </draft-comment> --> <p> <b>Consulte também:</b> <a href="../../c-legacy-releases/2016/11102016.md#mcvid" format="dita" scope="local"> Serviço de ID da Marketing Cloud</a>(antigo <span class="term">serviço de ID de visitante</span>) </p> </td> 
  </tr> 
  <tr> 
...
* Se você estiver usando uma conta de usuário da Marketing Cloud para fazer logon no Audience Manager e esquecer a sua senha, acesse a página de logon da Marketing Cloud para redefini-la. Consulte [Requisitos de senha, contas bloqueadas e senhas esquecidas](https://marketing.adobe.com/resources/help/en_US/aam/c_password_requirements.html)
* Alterações mínimas de fluxo de trabalho e interface de usuário no Link de perfil que ajudam no suporte às opções da Adobe Marketing Cloud Co-op. (AAM-25988) Consulte [Link de perfil](https://marketing.adobe.com/resources/help/en_US/aam/profile-link-intro.html).
  ...
  <tr> 
   ...
   <td colname="col3"> <p> 
     <ul id="ul_3DCBB5FCED1D4BFDA444BAEF8A5654BF"> 
      <li id="li_D2215C4F904D4C29A2B9EFEC8A9C5A91"><a href="https://docs.adobe.com/content/docs/en/aem/6-2/administer/integration/marketing-cloud/related-community-articles.html" format="https" scope="external">Artigos da comunidade de integração da Marketing Cloud</a> relacionados vinculados ao conteúdo AEM. </li> 
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>O Facebook interrompeu o Facebook Exchange (FBX) em 1 de novembro de 2016; seus anúncios FBX não são mais executados. Qualquer criação e estratégia de publicidade do FBX criadas anteriormente permanecem em pausa no Media Optimizer para fins de relatório. Você pode excluí-las, mas não pode ativá-las ou editá-las, ou criar novas estratégias de publicidade ou criações FBX. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Agora é possível acessar o fórum da Media Optimizer Community em ? &amp;nbsp; Comunidade na parte superior de qualquer página. </p> </td> 
  </tr> 
 </tbody> 
</table>
