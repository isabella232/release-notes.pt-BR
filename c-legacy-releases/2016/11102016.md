...
>[!IMPORTANT]
>
>**O EnterpriseTV** foi desativado em **9 de dezembro de 2016**. Os vídeos de produtos estão disponíveis no [Adobe Video Learning](https://www.adobe.com/training/video.html). Seja paciente, pois pode haver links de vídeo quebrados enquanto migramos vídeos para o novo local. O conteúdo de vídeo será incorporado às páginas relevantes da documentação do produto quando a migração for concluída.
...
* Corrigido um problema com o upload de certos tipos de arquivo, incluindo PDF, que foi encontrado depois da versão de outubro no Assets Core Service. (MAC -32517) Consulte a [Documentação de produto da Experience Cloud](https://marketing.adobe.com/resources/help/pt_BR/mcloud/) para obter ajuda sobre produtos.
...
>* Ao usar a Biblioteca 2.0.0+ do serviço da Experience Cloud ID, a sincronização de ID é iniciada para o Adobe Media Optimizer por padrão. Consulte [Entendendo a sincronização de ID e as taxas de correspondência](https://marketing.adobe.com/resources/help/pt_BR/mcvid/mcvid-match-rates.html).
...
* Alterações mínimas de fluxo de trabalho e interface de usuário no Link de perfil que ajudam no suporte às opções da Adobe Experience Cloud Co-op. (AAM -25988) Consulte [Link do perfil](https://marketing.adobe.com/resources/help/pt_BR/aam/profile-link-intro.html).

**Melhorias**

* Nova opção de Definição de ID para Fontes de dados entre dispositivos - As IDs em uma fonte de dados entre dispositivos agora pode ser definidas como “Pessoa” ou “Família”. Essa definição indica o relacionamento que a ID entre dispositivos tem com a Audience Manager ID. A opção padrão para todas as Fontes de dados entre dispositivos será Pessoa. Consulte o documento [Criar fontes de dados](https://marketing.adobe.com/resources/help/pt_BR/aam/create-datasource.html). (AAM-25988)

>[!NOTE]
Devido a alterações feitas pelos nossos provedores de dados, a partir de 1 de dezembro de 2016, dados do Wordpress e Disqus não serão mais oferecidos. Para obter mais informações, click[aqui](https://marketing-resource-help.s3.amazonaws.com/resources/help/en_US/social/Data%20Changes_Wordpress_Disqus_FAQ_2016.pdf).
