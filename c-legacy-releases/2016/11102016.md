...
>* Usando a Biblioteca 2.0.0+ do serviço da Marketing Cloud ID, a sincronização de ID será iniciada para a Adobe Advertising Cloud por padrão. Consulte [Entender sincronização de ID e taxas de correspondência](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-match-rates.html).
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>O Facebook interrompeu o Facebook Exchange (FBX) em 1 de novembro de 2016; seus anúncios FBX não são mais executados. Quaisquer criações e estratégias de anúncios do FBX criadas anteriormente permanecem em pausa na Advertising Cloud para fins de relatórios. Você pode excluí-las, mas não pode ativá-las ou editá-las, ou criar novas estratégias de publicidade ou criações FBX. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Agora você pode acessar o fórum da Comunidade da Advertising Cloud em ? &amp;nbsp; Comunidade na parte superior de qualquer página. </p> </td> 
  </tr> 
 </tbody> 
</table>
