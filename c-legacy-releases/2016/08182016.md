...
* Adicionadas funções ao código visitorAPI.js que especificam se o serviço de ID gerou a [!DNL  Marketing Cloud] ID de visitante ou de servidor, ou se as chamadas atingirem o tempo limite. Consulte [Funções de rastreamento de tempo limite](https://marketing.adobe.com/resources/help/en_US/mcvid/?f=mcvid-timeout-functions.html) e [Rastreamento da geração de ID de visitante do lado do cliente](https://marketing.adobe.com/resources/help/en_US/mcvid/?f=mcvid-client-side-id.html). (MCID-116)
