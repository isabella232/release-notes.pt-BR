...
| Alteração do intervalo de sincronização da ID | Agora, o serviço da Experience Cloud ID realiza chamadas de sincronização nos servidores da coleta de dados. Antes, o serviço de ID realizava apenas uma solicitação durante a primeira chamada para a obtenção de uma Experience Cloud ID. (AAM-22934) |

**Documentação**

Revisamos os procedimentos de implementação do serviço de ID para os clientes do [!DNL  Analytics]. Consulte [Configurar o serviço da Experience Cloud ID com o Analytics](https://marketing.adobe.com/resources/help/pt_BR/mcvid/?f=mcvid-setup-analytics.html).
...
* [Notas de versão do Adobe Campaign v6](https://marketing-stage.adobe.com/resources/help/pt_BR/whatsnew/)
