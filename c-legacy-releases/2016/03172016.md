...
Revisamos os procedimentos de implementação do serviço de ID para os clientes do [!DNL  Analytics]. Consulte a [Configuração do serviço Marketing Cloud ID com Analytics](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-setup-analytics.html).
