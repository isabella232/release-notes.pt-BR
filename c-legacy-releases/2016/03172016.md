...
### Serviço da Marketing Cloud ID {#section_5BA06A92D6E54715B025D86C192B2A8B}
...
| Recurso | Descrição |
|--- |--- |
| Suporte para cancelamento | O serviço da Marketing Cloud ID é compatível com solicitações de cancelamento. (AAM-21725) |
| Alteração do intervalo de sincronização da ID | Agora, o serviço da Marketing Cloud ID realiza chamadas de sincronização nos servidores da coleta de dados. Antes, o serviço de ID realizava apenas uma solicitação durante a primeira chamada para a obtenção de uma Marketing Cloud ID. (AAM-22934) |
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_BCA85EDE14C2445C8C10BDD77ED342A6"> 
      <li id="li_FD1E9A3A72564BE293BBAF1BD13A0339">Corrigido um problema que impedia a abertura de Análises ad hoc ao iniciá-las na Adobe Marketing Cloud com uma Adobe ID. (AN-102875) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
