...
| [!UICONTROL Engajamento com o aplicativo móvel] | 1 de junho de 2017 | O caso de uso de envolvimento do aplicativo móvel mostra como integrar seus aplicativos móveis com a Adobe Experience Cloud para medir o envolvimento do usuário e fornecer experiências personalizadas para suas audiências. |
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <b>JavaScript - 3.0.0</b> </p> <p>A Adobe renomeou as seguintes configurações para permitir a desativação de chamadas sincronizadas de terceiros. </p> 
    <ul id="ul_F26FC6F0B49C437AA5FE1C1753C88FF0"> 
     <li id="li_C84362D6F7BA4F27838548DF57A0CD65"> <span class="codeph"> idSyncDisableSyncs</span> para <span class="codeph"><a href="https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid-disableidsync.html" format="html" scope="external">disableIdSyncs </a> </span> </li> 
     <li id="li_D0C446A5AAB24AE8B437ED943E5FC681"> <span class="codeph"> idSyncDisable3rdPartySyncing</span> para <span class="codeph"><a href="https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid-disable-cookies.html" format="html" scope="external">disableThirdPartyCookies </a> </span> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Suporte ao Internet Explorer </p> </td> 
   <td colname="col2"> <p> O serviço de ID não oferece mais suporte ao Internet Explorer 6, 7, 8 e 9. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> Atualização da documentação de <span class="codeph">getInstance</span> </p> </td> 
   <td colname="col2"> <p>Adicionou um aviso à função <a href="https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid_getinstance.html" format="html" scope="external">Visitor</a> para que ela não seja instanciada com <span class="codeph">var visitor = new Visitor </span>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col01"> </td> 
   <td colname="col1"> <p>Mais opções de filtragem de tabela de forma livre </p> </td> 
   <td colname="col2"> <p>Essas opções de filtragem de dimensão foram adicionadas: </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Agora você pode clicar com o botão direito do mouse e copiar uma visualização ou painel e colar (inserir) o elemento copiado em outro lugar dentro do projeto ou em um projeto diferente. </p> <p>Você pode usar esse recurso para criar blocos de construção (visualizações/painéis predefinidos) que podem ser copiados para outros projetos para iniciá-los mais rapidamente, com dados específicos de sua empresa. </p> <p> <a href="https://marketing.adobe.com/resources/help/pt_BR/analytics/analysis-workspace/freeform-analysis-visualizations.html" format="html" scope="external"> Mais... </a> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> </td> 
  ...
  <tr> 
   <td colname="col01"> </td> 
   <td colname="col1"> <p>Melhoria no redimensionamento da coluna </p> </td> 
   <td colname="col2"> <p>Ao redimensionar a coluna mais à esquerda, o Workspace agora mantém as porcentagens de largura do resto das colunas (não ajusta apenas a largura da próxima coluna à direita). Essa alteração acelera a criação de tabelas para análise e compartilhamento. </p> <p> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> </td> 
   <td colname="col1"> <p>Exibir 400 linhas em uma tabela </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Previously, when you copied a project or used <i>save as</i>, all the intra-links saved in the project pointed to the original project, not the copied project. </p> <p>Os links internos agora são relativos ao projeto em que eles vivem, depois que você copia ou salva como. </p> <p> <a href="https://marketing.adobe.com/resources/help/pt_BR/analytics/analysis-workspace/t_freeform_project.html" format="html" scope="external"> Mais... </a> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> </td> 
   <td colname="col1"> <p>Análise de contribuição: notificação de tokens </p> </td> 
   <td colname="col2"> <p>If your company has a limited number of Contribution Analysis tokens, the  <span class="uicontrol"> Analysis Workspace </span> UI now shows a notification when you consume a token. Isso permite que você saiba quantos tokens ainda tem.&amp;nbsp; </p> <p>(Usuários administradores: vocês podem restringir quem pode usar estes tokens ao editar as permissões do grupo.)&amp;nbsp; </p> <p> <a href="https://marketing.adobe.com/resources/help/pt_BR/analytics/contribution/ca_main.html" format="html" scope="external"> Mais... </a> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> </td> 
   <td colname="col1"> <p>Arquivos CSV com caracteres de vários bytes </p> </td> 
   <td colname="col2"> Arquivos CSV enviados por email contendo caracteres multibyte agora podem ser abertos no MS Excel. </td> 
  </tr> 
  <tr> 
   <td colname="col01"> </td> 
   <td colname="col1"> <p>Alterações em evento#, eVar# e prop# </p> </td> 
   <td colname="col2"> <p>Evento#, eVar# e prop#, que foram adicionados aos nomes de dimensão no painel esquerdo (em 2017), só aparecerão quando você pesquisar pelo componente. </p> <p>(Também se aplica ao construtor do Conjunto de relatórios virtuais.) </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>There is no longer a need to <b>share</b> curated components (segments, calculated metrics, date ranges). Eles sempre estarão visíveis na Workspace se tiverem curadoria para o conjunto de relatórios virtual, mesmo se não forem compartilhados. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> </td> 
  ...
  <tr> 
   <td colname="col01"> </td> 
   <td colname="col1"> <p> <b>Construtor</b>de segmentos: Adicionado um tipo de compatibilidade de produto <span class="uicontrol"> Analysis Workspace </span> </p> </td> 
   <td colname="col2"> <p>In the <a href="https://marketing.adobe.com/resources/help/pt_BR/analytics/segment/seg_build.html" format="html" scope="external"> Segment Builder </a>, we added an  <span class="uicontrol"> Analysis Workspace </span> product compatibility type. </p> <p>Segments with embedded date ranges will continue to operate differently in <span class="uicontrol"> Analysis Workspace</span> versus <span class="uicontrol"> Reports &amp; Analytics</span>: In Workspace, a segment with an embedded date range overrides the panel date range. Ao contrário, o <span class="uicontrol">Reports &amp; Analytics</span> gera a interseção entre intervalo de datas do relatório e o intervalo de datas inserido do segmento. </p> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_049F6A23A21F4EF583A62D7C64759295"> 
      <li id="li_FA20387188F347B6A63C400BCABBC1FD"> Solução de um problema em que a métrica de Pessoas e a métrica Contagem distinta estimada relatavam números invulgarmente baixos. (AN-154510) </li> 
      <li id="li_4C15473CA8134605AB25D568C5F5541B">Correção de um problema que resultava erroneamente em um aviso "conjunto de relatórios incompatível". (AN-154791, AN-154706) </li> 
      <li id="li_3BFD3E2E8E2D4DCCA4CC2168D5A3F64B">Correção de um problema que fazia com que as tags de projeto agendadas desaparecessem depois que o projeto agendado era atualizado. (AN-153794) </li> 
      <li id="li_306069B2F1414A809B181EB723FDE3AF">Correção de um problema que impedia o carregamento completo ou o download de um PDF de projeto. (AN-152760) </li> 
      <li id="li_89069FCB9FDB4BAC92168A53643AC615">Correção de um problema em que os números do eixo Y sempre mostravam pelo menos um número decimal. A partir de agora, as casas decimais só serão apresentadas quando necessário. (AN-152685) </li> 
      <li id="li_A38AEC6152294BA282964357D95C6CA7">Correção de um problema que impedia detalhamentos de atualizar corretamente ao alterar um intervalo de datas e ao usar <i>Detalhamento por posição</i>. (AN-152275) </li> 
      <li id="li_9028E65C2330440D98D42F95224F5BB2">Correção de um problema que impedia os usuários de enviarem projetos para endereços de email que continham apóstrofos. (AN-151837) </li> 
      <li id="li_BF00F9A67C9746E3A548F138B023A196">Correção de um problema que impedia que colunas de período de tempo fossem adicionadas a uma tabela de forma livre, em algumas situações. (AN-150614) </li> 
      <li id="li_3AC4C0CDC1894C83B14317CDD45E5069">Correção de um problema que ocorria ao alterar o conjunto de relatórios de um projeto e salvar o projeto. Na caixa de diálogo do projeto agendado, um conjunto de relatórios incorreto foi exibido ao se referir às informações de fuso horário. (AN-150570) </li> 
      <li id="li_274DB6E81EF141AAA25B8E90D373390C">Correção de um problema na tabela de coorte que exibia <i>NaN</i> (Não é um número) em determinadas instâncias. A tabela de coorte agora exibirá <i>inválido</i> . (AN-146403) </li> 
      <li id="li_11696FA6ECA946D3A3BDEEBB680B0A43">Correção de um problema que ocorria ao criar comparações de segmentos com segmentos inválidos. Agora, exibiremos uma mensagem de erro mais descritiva. (AN-145953) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_D8C419C29A7B4184802AC44AFF26F271"> 
      <li id="li_421869B6AD854ABFBA09B554B2A042D6">Correção de um problema que resultava em links gerados pela opção <i>Vincular ao relatório</i> que não funcionavam quando o usuário se conectava usando a opção <i>Lembrar-me</i>. (AN-153261, AN-153038) </li> 
      <li id="li_B36206B9AFBD4A67A2F7A2E3CE826620"> <b>Marcadores</b>: corrigiu um problema que ocasionalmente exibia relatórios marcados mesmo se o usuário não tivesse mais direitos ao conjunto de relatórios onde ele estava. Nesse caso, uma mensagem de "Acesso negado" será exibida. (AN-153970) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_1EC0B858C95740D8AE039A40F7DF728A"> 
     <li id="li_0559C0464EA94BE493BA2A93E8BB2C23">Relatórios de Data Warehouse grandes não devem mais falhar com um erro de gateway 500. Em vez disso, eles serão quebrados e paginados. (AN-150062) </li> 
     <li id="li_3B01A07E75DA4E1BB75981E35CBB8AB9">Mensagens de email aprimoradas para falhas de transferência de arquivos. (AN-150162) </li> 
    </ul> </td> 
  </tr> 
  <tr> 
...
<!-- <draft-comment> 
    ...
    <ul id="ul_00E41A39A19F4EDE920FF835A06C9631"> 
     <li id="li_6D5A30F39BA24AB39FCE2E8CE4CDAC1E">Soltando o suporte para o IE 6 a 9 </li> 
     <li id="li_AC8BD2DC70FE464982EC3517126A6F2F">Inclusão da API do Visitante v3.0.0 </li> 
     <li id="li_6E543E790E4A41F0B7705005C5268B0D"> Inclusão do DIL v7.00 para o módulo [!DNL Audience Manager] </li> 
...
* Correção de um bug na página Criar / Editar destinos, no qual os botões Mapeamentos de segmentos não respondiam nos navegadores Safari. (AAM-33558)
* Corrigido um erro na página Sinais derivados em que, nos navegadores Firefox, os botões de ação (Editar, Excluir) não respondiam. (AAM-33573)
* Correção de um bug nos navegadores Internet Explorer. Ao tentar editar um destino na página de visualização, o botão Editar não acionava um evento. (AAM-33625)
* Correção de um erro nas Regras de mesclagem de Perfis nos navegadores Internet Explorer 11, onde as opções de Perfil Autenticado eram exibidas incorretamente. (AAM-33628)
* Correção de um bug no Adressable Audiência nos navegadores Internet Explorer 11, onde o modal da ajuda era exibido incorretamente. (AAM-33631)
* Correção de um problema no Laboratório de Audiências em que alguns clientes recebiam um erro 500 ao tentar baixar o arquivo CSV com características de conversão. (AAM-33775)
* Correção de um problema encontrado ao excluir segmentos usando o botão Remover selecionados, em que os segmentos não eram realmente excluídos. (AAM-33815)
* Correção de um problema relatado pelos clientes que recebiam um erro ao tentar remover um mapeamento de segmento do destino do Google DBM. (AAM-34056)
* Correção de um problema em que os clientes não conseguiam modificar o operador em uma regra de característica sem excluir a condição ou usar a visualização de código. (AAM-34112)
...
<table id="table_885F194180FE42EFA04220C9299969E4"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> Relatórios para gerenciamento de fadiga </p> </td> 
   <td colname="col2"> <p> O relatórios para gerenciamento de fadiga é um relatório dedicado e configurável que exibe o impacto das regras de fadiga nos delivery de email, push, SMS e mala direta dentro de um intervalo de datas especificado antes do envio. Com o insight adicional de poder ver rapidamente todas as campanhas conflitantes em uma única visualização, os profissionais de marketing são capazes de planejar campanhas de marketing de acordo com a definição mais eficiente das regras de fadiga e priorizar as comunicações. </p> <p>Para obter mais informações, consulte a <a href="https://helpx.adobe.com/campaign/standard/administration/using/working-with-typology-rules.html#viewing-the-fatigue-rule-summary-report" format="html" scope="external">documentação detalhada</a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Compartilhamento de relatórios </p> </td> 
   <td colname="col2"> <p> O Compartilhamento de relatórios permite que você compartilhe seus relatórios com usuários do Adobe Campaign como um anexo de email e de forma recorrente automatizada. Os usuários que recebem relatórios recorrentes têm a capacidade de cancelar a inscrição dessas comunicações por meio de um link dedicado em cada email. </p> <p>Para obter mais informações, consulte a <a href="https://helpx.adobe.com/campaign/standard/reporting/using/reporting-interface.html#share-tab" format="html" scope="external">documentação detalhada</a>. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> <b>Visualização das mensagens de push</b>: visualize as notificações das mensagens de push em dispositivos iOS e Android de dentro do editor de conteúdo de notificações de mensagens de push para ver exatamente o que os destinatários verão antes de testar ou executar o envio. </p> <p>Para obter mais informações, consulte a <a href="https://helpx.adobe.com/campaign/standard/channels/using/creating-and-sending-a-push-notification.html#previewing-the-notification" format="html" scope="external">documentação detalhada</a>. </p> <p> <b> Conteúdo disponível</b>: quando aplicativos não são abertos por longos períodos de tempo, seus dados podem se tornar obsoletos. Isso resulta na atualização ou substituição dos dados no momento em que um usuário finalmente abre o aplicativo, o que pode causar atrasos no uso do aplicativo. Com o suporte adicional de Conteúdo disponível, os usuários da Adobe Campaign podem acordar seu aplicativo para atualizar seus dados em segundo plano ao enviar uma notificação por push, permitindo maior consistência e controle sobre a experiência do usuário no aplicativo. </p> <p> <b>Conteúdo variável</b>: com a ajuda adicional do conteúdo variável, os usuários do Adobe Campaign agora podem aproveitar as extensões de aplicativos para dispositivos móveis para modificar ainda mais o conteúdo ou a apresentação de notificações de mensagens de push enviadas pelo Adobe Campaign. Por exemplo, os usuários podem aproveitar o Conteúdo variável para: </p> 
    <ul id="ul_3EF9A2749F3B4D6ABD8DBF459D5533EE"> 
     <li id="li_157AE9CA180749118F100810A756046E"> Descriptografar dados que foram entregues em formato criptografado </li> 
     ...
     <li id="li_D464555FEC3E446A85E791FE657AE2CB"> Adicionar um identificador de thread a uma notificação </li> 
  ...
  <tr> 
   <td colname="col1"> <p> Delivery otimizados para fuso horário </p> </td> 
   <td colname="col2"> <p> Agende notificações recorrentes por email, SMS e Push para serem entregues em um dia e hora específicos em cada fuso horário do recipient, garantindo que suas mensagens sejam entregues no horário certo sem configurar vários delivery. </p> <p>Para obter mais informações, consulte a <a href="https://helpx.adobe.com/campaign/standard/automating/using/scheduler.html" format="html" scope="external">documentação detalhada</a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> Acionamento da atividade de sinal por API </p> </td> 
   <td colname="col2"> <p> It is now possible to trigger a signal activity for your workflows directly from  <span class="wintitle"> Adobe Campaign </span> Standard API. </p> <p>Para obter mais informações, consulte a <a href="https://docs.campaign.adobe.com/doc/standard/en/api/ACS_API.html#triggering-a-signal-activity" format="html" scope="external">documentação detalhada</a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_F4E7F10923004BF1AD49BACE86D4982E"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col3"> <p> O Brand Portal 6.3.1 oferece uma melhor experiência do usuário, desempenho, novas melhorias em metadados, pesquisa, relatórios e gerenciamento de direitos digitais. </p> <p> 
     <ul id="ul_445D216D5F674C079E2816AF1AA5C8BD"> 
      <li id="li_483696B31B634B20B6B5F138268F43DB"> <a href="https://helpx.adobe.com/br/experience-manager/brand-portal/release-notes/brand-portal-release-notes.html" format="https" scope="external"> Notas de versão </a> </li> 
      <li id="li_FA5CC8D13EDD48C7BD43C6325073AADC"> <a href="https://helpx.adobe.com/br/experience-manager/brand-portal/using/whats-new.html" format="https" scope="external"> Novidades do AEM Assets Brand Portal </a> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p>Pacote de recursos do Dynamic Media AEM 6.3 </p> </td> 
   <td colname="col3"> <p>O pacote de recursos do Dynamic Media 6.3 AEM agora é compatível com o AEM 6.3.1.0. </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>AEM Desktop App 1.7 foca em melhorias na estabilidade e na lógica de cache, melhor suporte para proxy de rede e capacidade de limpar arquivos internos após a desinstalação. </p> <p> 
     <ul id="ul_529FEC1E204640249E4AE5D370570CFB"> 
      ...
      <li id="li_F5428913D5D0470DAC68A8C7EA2CCC11"> <a href="https://helpx.adobe.com/br/experience-manager/6-3/release-notes/desktop-app-release-notes.html" format="https" scope="external"> Notas de versão </a> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col3"> <p>O AEM 6.3 SP1–CFP2 (6.3.1.2), lançado em 8 de janeiro de 2018, é uma atualização importante que inclui correções essenciais voltadas para o cliente e melhorias lançadas desde a disponibilização geral do AEM 6.3 em abril de 2017. </p> <p> 
     <ul id="ul_5E37F844028C4EBA810DD60FA7988A93"> 
      <li id="li_F4A42388096A4DF0BB336E8561A9F07A"> <a href="https://helpx.adobe.com/br/experience-manager/release-notes—aem-6-3-cumulative-fix-pack.html" format="https" scope="external"> Notas de versão </a> </li> 
      <li id="li_D4299C6C7703461D9A63DABCA75E00FC"> <a href="https://helpx.adobe.com/br/aem-forms/kb/aem-forms-releases.html" format="https" scope="external"> Versões de AEM Forms </a> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Os campos de anúncio de texto padrão não são mais editáveis nos modelos de feed de inventário do Bing Ads, Google AdWords e Yahoo Japão. </p> <p>Em modelos de publicidade em texto, agora é possível adicionar classificações por rótulos aos modelos para variações de anúncios individuais. Adicione as classificações abaixo do modelo de variação de anúncio na guia Anúncios. </p> <p>Em modelos de anúncios comerciais, você pode adicionar classificações de etiquetas aos grupos de produtos gerados. Adicione as classificações da guia Classificações de etiquetas. As classificações por rótulos para grupos de produtos são aplicadas ao nível da unidade (mais granular). </p> </td> 
  </tr> 
  <tr> 
