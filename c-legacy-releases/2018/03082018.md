  ...
  <tr> 
   ...
   <td colname="col2"> <p>Uma alteração feita ao mecanismo de pesquisa (back-end) afetará o uso de relatórios em várias maneiras. Estas alterações entraram em vigor no <b>final de fevereiro de 2018</b>: </p> 
    <ul id="ul_7515E2E79FD94B8F8DFF4C2DBB9E6A84"> 
     ...
     <li id="li_E46207F194134AEA86F5CB2C8F26C76C"> Category reports for rollups and current data in <span class="uicontrol">Reports &amp; Analytics</span> are no longer provided. Contudo, a substituição de relatórios de pacotes de categoria na API de serviço da Web foi adiada até a Versão de manutenção de abril </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Nos modelos personalizados lançados recentemente, nós </p> 
    <ul id="ul_787F48253F454163B99F6DD50F199FE2"> 
     ...
     <li id="li_EEAA4D115CB74A57BABD524B2561E0CC">Permitimos que não administradores criem (usando a opção de salvar como) e editem modelos de projeto da Workspace, previsto que tenham a permissão para <span class="uicontrol">Criar/Preparar projetos na Analysis Workspace</span>. ( 
      <span class="ignoretag"> 
       <span class="uicontrol"> Admin</span> &gt; <span class="uicontrol">Gerenciamento de usuários</span> &gt; <span class="uicontrol">Grupos</span> &gt; <span class="uicontrol">Editar todo o acesso a relatórios</span> &gt; <span class="uicontrol">Personalizar ferramentas do Analytics</span> &gt; <span class="uicontrol">Criar/Preparar projetos na Analysis Workspace </span> 
      </span>). </li> 
    </ul> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_B3810CF9DA584DDDB811F1D0F91B78F2"> 
      ...
      <li id="li_F15E1A5F9EBB4A1AA5A7233D94051187"> <b><span class="uicontrol"> Relatórios e análises</span></b>: corrigido um problema com os relatórios do Target que não relatavam corretamente os totais Trimestrais. (AN-153933) </li> 
