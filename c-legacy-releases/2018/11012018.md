...
| Adobe [!DNL Analytics]e o Regulamento Geral sobre a Proteção de Dados (GDPR) | [!DNL Analytics] suporta um novo método para transmitir a ID de visitante herdada [!DNL Analytics] a uma solicitação RAID (consulte [AAID](https://marketing.adobe.com/resources/help/en_US/analytics/gdpr/gdpr_namespaces.html)). Also, [!DNL Analytics] now supports [deleting (anonymizing) the Purchase ID value](https://marketing.adobe.com/resources/help/en_US/analytics/gdpr/gdpr_labels.html) as part of a delete request. |
