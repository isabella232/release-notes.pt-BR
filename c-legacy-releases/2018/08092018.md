...
| Recurso | Descrição |
|--- |--- |
| [Supressão instantânea entre dispositivos](https://marketing.adobe.com/resources/help/pt_BR/aam/instant-cross-device-suppression.html Cross-Device) | A Supressão instantânea entre dispositivos é a capacidade de omitir usuários entre vários dispositivos conectados a eles quando uma experiência em particular ocorrer em um desses dispositivos. Use o recurso de Supressão instantânea entre dispositivos para fornecer uma experiência consistente entre dispositivos para seus usuários.  A experiência é disponibilizada pelos recursos não segmentados em tempo real do [!DNL Audience Manager]. |
...
A versão 2.1.0 dos [componentes principais](https://helpx.adobe.com/experience-manager/core-components/user-guide.html) está disponível, apresentando melhorias no componente [Imagem](https://helpx.adobe.com/experience-manager/core-components/using/image.html), um novo componente [Teaser](https://helpx.adobe.com/experience-manager/core-components/using/teaser.html) e várias correções de erros.
...
Você pode comprar ingressos sob demanda para ter acesso ilimitado a mais de 90 sessões. Acesse [aqui](https://immerse18.adobe-devs.adobeevents.com/register/) e use o código de desconto He7B52.
...
Veja sessões futuras ou assista a sessões anteriores [aqui](https://helpx.adobe.com/experience-manager/kt/eseminars/gems/aem-index.html).
...
Veja sessões futuras ou assista a sessões anteriores [aqui](https://helpx.adobe.com/experience-manager/kt/eseminars/ask-the-expert/atace-index.html).
...
Mais informações disponíveis [aqui](https://evolve.3sharecorp.com/).
...
 Descubra reuniões de grupo de usuários local [aqui](https://www.meetup.com/pro/aem/). Caso não haja um grupo local, mas você tenha interesse em criar um, envie um email para [aemusers@adobe.com.](mailto:aemusers@adobe.com)
