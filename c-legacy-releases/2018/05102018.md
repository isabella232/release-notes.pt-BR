...
* Correção de um bug na exibição de código do [Construtor de relatórios](https://marketing.adobe.com/resources/help/pt_BR/aam/c_segment_builder.html) em que expressões contendo parênteses tirariam os parênteses se os clientes editassem o segmento novamente. (AAM-36393)
