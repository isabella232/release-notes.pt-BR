...
## API do Regulamento geral de proteção de dados
...
<table id="table_09C086041AB5447093588F9B197214A6"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> O Data Workbench oferece suporte a processos RGPD para tornar as informações de identificação pessoal anônimas. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Como permitir que os clientes excluam dados em seus Perfis de visitante do [!DNL Target]. </p> </td> 
  </tr> 
  <tr> 
...
Notas de versão referentes à interface dos principais serviços, incluindo [!UICONTROL Assets], [!UICONTROL Feed], [!UICONTROL Notificações], Pessoas, [!UICONTROL Mobile] Services, Launch e Dynamic Tag Management. Além disso, inclui informações de versão do Serviço da Experience Cloud ID (conhecido no Analytics como *` Visitor ID service`* e *` Visitor API`*, e *` Marketing Cloud ID service`*).
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>O Conversor de projeto da Ad Hoc Analysis converte os projetos da Ad Hoc Analysis para a [!UICONTROL Analysis Workspace], basta clicar em um botão. </p> <p>Os projetos copiados podem, então, ser usados, modificados e agendados conforme necessário na [!UICONTROL Analysis Workspace.] </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p>Aprimoramentos na [!UICONTROL Analysis Workspace] </p> </td> 
   <td colname="col2"> 
  ...
  <tr> 
   <td colname="col1"> <p>Atualizações a <a href="https://marketing.adobe.com/resources/help/en_US/analytics/gdpr/index.html" format="html" scope="external">Analytics e o RGPD </a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><b>Versão planejada efetiva em 15 de maio de 2018</b> </p> <p> <span class="term"> A coluna mc_ audiences </span> foi adicionada. <span class="term"> mc_audiences</span> é a lista de ID de segmento da análise de público-alvo do Adobe [!DNL Audience Manager]. </p> <p>Observação: isso não inclui nomes amigáveis pois eles são uma classificação da ID. </p> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Conforme nos aproximamos de 25 de maio de 2018, data em que o Regulamento geral de proteção de dados europeia (RGPD) entrará em vigor, preparamos uma documentação para auxiliá-lo no gerenciamento de dados do cliente no [!DNL Audience Manager] de forma a atender as obrigações do RGPD. Leia em: </p> <p> 
     <ul id="ul_542C0E9F27804307AED8FCE933135A43"> 
      <li id="li_853306663308434CAF8F63EFC7895817"> <p> <a href="https://marketing.adobe.com/resources/help/en_US/aam/aam-gdpr-details.html" format="https" scope="external"> RGPD no [!DNL Audience Manager] </a> </p> </li> 
      <li id="li_C52BF49842114AF08B292CDCF330A19C"> <p> <a href="https://marketing.adobe.com/resources/help/en_US/aam/aam-gdpr-faq.html" format="https" scope="external"> Perguntas frequentes sobre o RGPD </a> </p> </li> 
      <li id="li_9873DB17A8C04497B0DD63AD87085F82"> <p> <a href="https://marketing.adobe.com/resources/help/en_US/aam/aam-gdpr-partners.html" format="https" scope="external"> Remoção de parceiro do RGPD </a> </p> </li> 
     </ul> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_F4E7F10923004BF1AD49BACE86D4982E"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>AEM e o RGPD </p> </td> 
   <td colname="col3"> <p>O RGPD da União Europeia sobre direitos de privacidade de dados entra em vigor em maio de 2018. Saiba mais sobre o AEM e a <a href="https://helpx.adobe.com/experience-manager/6-4/managing/using/gdpr-compliance.html" format="https" scope="external">conformidade com o RGPD </a>. </p> </td> 
  </tr> 
  <tr> 
