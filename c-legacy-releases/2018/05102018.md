...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><b>Versão planejada efetiva em 15 de maio de 2018</b> </p> <p> <span class="term"> A coluna mc_ audiences </span> foi adicionada. <span class="term"> mc_audiences </span> é a lista de ID de segmento do Audience Analytics do Adobe <span class="wintitle"> Audience Manager </span>. </p> <p>Observação: isso não inclui nomes amigáveis pois eles são uma classificação da ID. </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_A50A05631E574C83AD7075579B14ACF1"> 
      <li id="li_227327CC9233438688BF7F593027C1DE">Fixed an issue that occurred when opening the Calculated Metric Builder from <span class="uicontrol">Analysis Workspace</span>. Isso fazia com que a lista suspensa de funcionamento não exibisse opções. (AN-160698) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_666BB742E5BE4CC9BE95E697DA5DBB67"> 
      ...
      <li id="li_DB39E7BF56304FAB8B8C452CEDCF589B">Correção de um problema nas classificações do Analytics para o Target: prosseguindo, ao criar um conjunto de relatórios copiando suas configurações de outro conjunto que possua classificações do Target, essas classificações serão mapeadas para o novo conjunto de relatórios. (AN-156702) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>As we approach the May 25th, 2018 date at which the European General Data Protection Regulation (GDPR) comes into law, we have prepared documentation to assist you in managing consumer data in  <span class="wintitle"> Audience Manager </span> to meet GDPR obligations. Leia em: </p> <p> 
     <ul id="ul_542C0E9F27804307AED8FCE933135A43"> 
      <li id="li_853306663308434CAF8F63EFC7895817"> <p> <a href="https://marketing.adobe.com/resources/help/en_US/aam/aam-gdpr-details.html" format="https" scope="external"> RGPD no Audience Manager </a> </p> </li> 
