...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>O Attribution IQ permite que você realize análises mais sofisticadas e inteligentes do desempenho de marketing. Novos modelos de atribuição podem ser usados em métricas na <span class="uicontrol"> Analysis Workspace </span> (em qualquer tabela ou em qualquer detalhamento) e em métricas calculadas. Um novo painel Atribuição permite uma melhor visualização e comparação. </p> <p>O Attribution IQ está disponível para todos os clientes nos SKUs Ultimate, Prime, Select e Foundation. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Adicionadas «Últimas 13 semanas completas» às predefinições de intervalo de datas na <span class="uicontrol"> Analysis Workspace </span>. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>A otimização de público-alvo para editores pode ajudá-lo a identificar oportunidades de desempenho potencial para <span class="wintitle"> os segmentos do Audience Manager </span> em seu conteúdo próprio e operado. Esses relatórios combinam dados de desempenho de campanhas no nível do registro com as métricas do [!DNL Audience Manager] para identificar otimizações de público-alvo e oportunidades de monetização. </p> <p>Esses relatórios não estão disponíveis por padrão. Entre em contato com o seu consultor do [!DNL Audience Manager] ou com o Atendimento ao cliente para começar. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Antes que <span class="wintitle"> o Audience Manager </span> possa ativar a Otimização de público-alvo para editores, você deve garantir que todos os pré-requisitos descritos neste artigo sejam cumpridos. Entre em contato com o Atendimento ao cliente após verificar todos os pré-requisitos. </p> </td> 
  </tr> 
 </tbody> 
</table>
