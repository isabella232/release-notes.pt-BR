...
* Correção de um problema em que [o cookie AMCV](https://marketing.adobe.com/resources/help/pt_BR/mcvid/mcvid_cookies.html) não estava sendo definido em iFrames. (CORE-14119)
...
Para obter as notas de versão cumulativas, consulte [Notas de versão do serviço da Experience Cloud ID](https://marketing.adobe.com/resources/help/pt_BR/mcvid/mcvid-release-notes.html).
