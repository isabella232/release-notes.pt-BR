...
* API DCS: adicionamos um novo código de erro: 198 - As solicitações deste país estão bloqueadas pelo parceiro. Leia mais na [Referência à API DCS](https://marketing.adobe.com/resources/help/pt_BR/aam/dcs_error_codes.html).
