...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Os logs de uso do Analytics agora rastreiam quando alguém abre um projeto na [!UICONTROL Analysis Workspace] (além do rastreamento já existente de ações de criação, atualização, cancelamento, compartilhamento e exclusão). Isso permite melhor visibilidade de quem está usando a Workspace e com que frequência. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> </td> 
...
<table id="table_E08D11345DD64677B46629651A0FFDBF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col02"> <p>10 de maio de 2018 </p> </td> 
   <td colname="col2"> <p>Devido ao fim do suporte para TLS 1.0, recomendamos que os usuários do Adobe [!UICONTROL Report Builder] (ARB) baixem o ARB v5.6.21 antes de 13 de setembro de 2018. Após essa data, as versões anteriores do ARB não terão mais suporte. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Em junho de 2018, a Adobe descontinuará o suporte para o protocolo TLS 1.0. A funcionalidade do Adobe [!DNL Audience Manager] não funcionará para os usuários finais que usam navegadores compatíveis apenas com TLS 1.0. Coletamos para você uma lista de navegadores, versões e suporte TLS. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Agora é possível criar listas de remarketing do Google AdWords (RLSAs) a partir de segmentos compartilhados do Analytics. Anteriormente, era necessário que o profissional de publicidade também possuísse o Adobe [!DNL Audience Manager]. Para se qualificar, um profissional de publicidade deve implementar o serviço da Adobe Experience Cloud ID, fornecer sua ID de Organização IMS e implantar uma tag em seus sites. </p> </td> 
  </tr> 
  <tr> 
