  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_666BB742E5BE4CC9BE95E697DA5DBB67"> 
      ...
      <li id="li_88ABBF7D4F424A8A9FD284E87A8E1886">Correção de um problema que fazia com que as classificações do Analytics para o Target mostrassem valores “desconhecidos” ao alternar conjuntos de relatórios. (AN-156702) </li> 
      ...
      <li id="li_EFC5176579F244828E3680B9F9BDA71B">Correção de um problema com segmentos do Analytics não publicados corretamente no Audience Manager. (AN-162536) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Uma alteração feita ao mecanismo de pesquisa (back-end) afetará o uso de relatórios em várias maneiras. Estas alterações entraram em vigor no <b>final de fevereiro de 2018</b>: </p> 
    <ul id="ul_7515E2E79FD94B8F8DFF4C2DBB9E6A84"> 
     ...
     <li id="li_E46207F194134AEA86F5CB2C8F26C76C">(<b>Atualizado em 11 de abril de 2018</b><span class="uicontrol">) Relatórios de categoria para pacotes e dados atuais em Reports &amp; Analytics não são mais fornecidos. </span> A desaprovação de relatórios de pacote de categoria na API do serviço de Web entrará em vigor na versão de manutenção do Adobe Analytics de 10 de maio de 2018. </li> 
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Agora é possível criar listas de remarketing do Google AdWords (RLSAs) a partir de segmentos compartilhados do Analytics. Previously, the advertiser also had to have Adobe  <span class="wintitle"> Audience Manager </span>. Para se qualificar, um profissional de publicidade deve implementar o serviço da Adobe Experience Cloud ID, fornecer sua ID de Organização IMS e implantar uma tag em seus sites. </p> </td> 
  </tr> 
  <tr> 
