...
* **Configuração do Dynamic Media - Modo Scene7**
   ...
   Consulte [Criação de uma configuração do Dynamic Media](https://experienceleague.adobe.com/docs/experience-manager-65/assets/dynamic/config-scene7-mode/config-dms7.html?lang=en).
