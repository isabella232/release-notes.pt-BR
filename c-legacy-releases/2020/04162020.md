...
* [[!DNL Analytics]](#analytics) **(Alteração da data de lançamento - consulte atualização em 15 de abril)**
...
| [Introdução ao Java Content Repository (JCR)](https://docs.adobe.com/content/help/en/experience-manager-learn/cloud-service/underlying-technology/introduction-jcr.html) | Uma introdução ao Java Content Repository (JCR) usado pela Adobe Experience Manager. |
