...
* **AEM as a Cloud Service**
   ...
   * **Cloud Readiness Analyzer**
      ...
      * O CRA (Cloud Readiness Analyzer) tem um console de estado de início que exibe um botão **[!UICONTROL Gerar relatório]** explícito para o usuário selecionar para executar o CRA.
