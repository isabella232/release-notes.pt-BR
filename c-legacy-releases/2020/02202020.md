...
* **Navegador Microsoft® Edge baseado em Chromium:** Esta versão inclui alterações para reconhecer o navegador Microsoft® Edge baseado em Chromium (versão 79 e posterior) para fins de relatório.
...
| EOL (fim da vida útil) da opção **[!UICONTROL Exibir arquivo]** | 30 de outubro de 2019 | Anúncio do fim da vida útil do evento em janeiro de 2020 **[!UICONTROL Visualizar Arquivo]** no Gerenciador de painel (**[!UICONTROL Componentes > Painéis]**). |
| EOL (fim da vida útil) da opção **[!UICONTROL Impor restrições de logon de IP]** | 30 de outubro de 2019 | Anúncio do fim da vida útil da Lista de permissões do IP em janeiro de 2020 (**[!UICONTROL Impor restrições de logon de IP]**) sob a **[!UICONTROL Administração > Configurações da empresa > Segurança]** menu. |
...
* **Tutorials para Experience Manager as a Cloud Service**
   ...
   Comece rapidamente com o [tutoriais do Experience Manager as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/overview.html?lang=en).
...
* Adobe Campaign Classic: [Documentação](https://experienceleague.adobe.com/docs/campaign-classic.html) - [Vídeos tutoriais](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/overview.html?lang=en)
