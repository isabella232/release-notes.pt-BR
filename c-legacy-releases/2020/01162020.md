...
Agora a Orquestração da jornada é GA. [Ler mais](https://docs.adobe.com/content/help/pt-BR/journeys/using/release-notes/release-notes.html#ga-release---december-2019)
...
| EOL (fim da vida útil) da opção **[!UICONTROL Impor restrições de logon de IP]** | 30 de outubro de 2019 | Anunciando a data de janeiro de 2020 para o fim da vida útil para a funcionalidade Lista de permissões de IP (**[!UICONTROL Impor restrições de logon de IP]**) no menu **[!UICONTROL Admin > Configurações da empresa > Segurança]**. |
...
* **NOVO: AEM as a Cloud Service**
   ...
   [O Adobe Experience Manager](https://www.adobe.com/br/marketing/experience-manager.html) (AEM) agora está disponível as a Cloud Service.
...
* [Campaign Classic 19.2](https://docs.adobe.com/content/help/pt-BR/campaign-classic/using/release-notes/previous-releases/release--19-2.html#release-19-2-build-9080)
...
* [Campaign Standard 19.4](https://docs.adobe.com/content/help/pt-BR/campaign-standard/using/release-notes/previous-releases/release-notes-2019.html#release-19-4---october-2019)
