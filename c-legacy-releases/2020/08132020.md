...
| ----------- | ---------- | ------- |
| [!UICONTROL Cross-Device Analytics]: disponibilidade nas regiões da EMEA e APAC | 31 de agosto de 2020 | O [Cross-Device Analytics](https://experienceleague.adobe.com/docs/analytics/components/cda/overview.html) e o gráfico privado estarão disponíveis para clientes nas regiões da EMEA e APAC. |
...
* **AEM as a Cloud Service**
   ...
   * Os pipelines do Cloud Manager agora oferecem suporte a variáveis e segredos definidos pelo cliente. Consulte [Variáveis de pipeline.](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/onboarding/getting-access/creating-aem-application-project.html#pipeline-variables)
...
| 21 de julho de 2020 | [Criar uma Cópia de idioma](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/multi-site-management/create-launguage-copy.html) | Tutorial | Aprenda a criar uma [!UICONTROL Cópia de idioma] para o site do AEM usando o [!UICONTROL assistente Criar cópia de idioma]. |
