...
| Recurso | Descrição |
| -----------| ---------- |
| Transparência e estrutura de consentimento do RGPD | A Advertising Cloud está atualizando seu suporte para a Estrutura de Transparência e Consentimento do IAB para a versão 2.0 até 15 de agosto de 2020. No momento, nenhuma alteração é necessária no lado do cliente.  Como processador de dados para cada um de nossos clientes, a Adobe Advertising Cloud tem os recursos disponíveis para que os clientes cumpram suas obrigações no RGPD que se aplicam ao uso de nossos produtos e serviços. |
| Integração de Audience Manager | (Beta para clientes Adobe Audience Manager com Adobe Experience Platform apenas) DSP pode enviar arquivos de registro acionáveis contendo dados de envolvimento de publicidade de um anunciante para o Audience Manager por meio do Adobe Experience Platform. No Audience Manager, os anunciantes podem usar os dados para segmentação avançada e uso em ferramentas de insights, como Relatórios de Audience Optimization. |
| Segmentação de gráfico entre dispositivos com base em pessoas | Clientes de DSP de autoatendimento podem usar um gráfico de dispositivo (Adobe Device Co-op ou LiveRamp) para direcionamento baseado em pessoas e gerenciamento de frequência em novas campanhas. Isso garante que os anunciantes possam atingir suas audiências em seus dispositivos, mas limita a exposição. Além disso, a edição em massa das configurações de definição de metas entre dispositivos em disposições agora está em beta. Para ativar o beta para sua conta, entre em contato com seu gerente de conta do Adobe. |
| Definição de metas do site | &quot;Listas negras&quot; e &quot;listas brancas&quot; foram renomeadas para os termos mais equitativos &quot;bloqueados (sites)&quot; e &quot;direcionados (sites)&quot;.&quot; |
| Anúncios em Flash talk | DSP agora insere automaticamente macros de clique para todas as tags de anúncio do Flashtalk por meio da criação de um único anúncio e de workflows de criação de anúncios de terceiros em massa. |
| Relatórios | (Beta somente para clientes Adobe Experience Platform) Um novo relatório entre Canais no Advertising Cloud Search fornece uma visualização unificada de gastos com mídia em DSP e pesquisa, com métricas principais diárias para disposições DSP e campanhas de pesquisa. |
