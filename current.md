...
| Dimensões [!UICONTROL Dispositivo] e [!UICONTROL Geografia] | 30 de outubro de 2020 | As dimensões [!UICONTROL Dispositivo] e [!UICONTROL Geografia] agora estão disponíveis por padrão como parte do projeto [Suporte à pesquisa global](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-usecases/global-lookups.html?lang=pt-BR#cja-usecases) no conector do Adobe Analytics Source. Essa adição muito solicitada aumenta a [paridade entre o Adobe Analytics e o CJA](https://docs.adobe.com/content/help/pt-BR/analytics-platform/using/cja-overview/cja-aa.html). |
