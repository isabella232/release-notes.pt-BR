...
As atualizações mais recentes do Status do sistema da Adobe são encontradas em [Status do sistema da Adobe - 21 de maio de 2020](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/previous/2020/05212020.html?lang=en) para obter as informações de lançamento mais recentes.
...
| Abril de 2021 | [Índices de propriedades ordenadas obsoletas](https://experienceleague.adobe.com/docs/experience-manager-pattern-detection/table-of-contents/dopi.html?lang=pt-BR) | Artigo | O projeto herdado tem tipos de índice de Propriedade ordenada não compatíveis. Como sugerem as limitações atuais, o gerenciamento de índice em [!UICONTROL AEM como Cloud Service] só é compatível com índices do tipo _lucene_. |
...
| Abril de 2021 | [[!UICONTROL Configuração de Modo de Execução Não Suportado]](https://experienceleague.adobe.com/docs/experience-manager-pattern-detection/table-of-contents/urc.html?lang=pt-BR) | Referência | Como você pode tornar [!UICONTROL runmode] configurações compatíveis com o Experience Manager como Cloud Service, pois agora somente Autor e Publicação são [!UICONTROL runmodes]. |
...
| 12 de abril de 2021 | [Configurar mensagens transacionais usando dados de evento em tempo real](https://experienceleague.adobe.com/docs/campaign-standard-learn/tutorials/integrations/triggers/configure-transactional-messages-using-realtime-event-data.html?lang=pt-BR) | Campaign Standard | Saiba como configurar mensagens transacionais usando dados de evento em tempo real provenientes de acionadores. |
...
| 12 de abril de 2021 | [Criar um acionador na Experience Cloud](https://experienceleague.adobe.com/docs/campaign-standard-learn/tutorials/integrations/triggers/create-a-trigger-in-experience-cloud.html?lang=pt-BR) | Campaign Standard | Saiba como configurar acionadores no Experience Cloud. |
...
| Inventário privado | (Versão de 15 de outubro) Todos os usuários agora podem configurar e editar informações da ID de negócios usando um novo formulário, que é uma versão simplificada do formulário antigo de Veiculação de anúncios inteligentes. Para configurar as informações da nova ID de negócios, acesse **[!UICONTROL Inventário]** > **[!UICONTROL Vendas]** > **[!UICONTROL Criar]** e depois clique em **[!UICONTROL ID de venda Beta]**. |
...
| Abril de 2021 | [Adicionar tabelas e tags de lista](https://experienceleague.adobe.com/docs/document-services/tutorials/docgen/docgentemplates/taggertables.html?lang=pt-BR) | Vídeo | Saiba como adicionar facilmente tabelas e tags de lista a modelos do Microsoft® Word usando o Adobe Document Generation Tagger para adicionar dinamicamente linhas de tabela ou de lista com base em dados usando a API de geração de documento do Adobe. |
| Abril de 2021 | [Adicionar tags de imagem](https://experienceleague.adobe.com/docs/document-services/tutorials/docgen/docgentemplates/taggeraddimagetags.html?lang=pt-BR) | Vídeo | Saiba como adicionar facilmente tags de imagem a modelos do Microsoft® Word usando o Adobe Document Generation Tagger para enviar imagens de forma dinâmica a documentos usando a API Adobe Document Generation. |
| Abril de 2021 | [Adição de tags de texto](https://experienceleague.adobe.com/docs/document-services/tutorials/docgen/docgentemplates/taggeraddtexttags.html?lang=pt-BR) | Vídeo | Saiba como adicionar tags facilmente a modelos do Microsoft® Word usando o Adobe Document Generation Tagger para uso com a API Adobe Document Generation. |
| Abril de 2021 | [Visão geral do Adobe Document Generation Tagger](https://experienceleague.adobe.com/docs/document-services/tutorials/docgen/docgentemplates/taggeroverview.html?lang=pt-BR) | Vídeo | Saiba como marcar modelos [!DNL Word] usando o Tagger de geração de documento do Adobe para uso com a API de geração de documento do Adobe. |
