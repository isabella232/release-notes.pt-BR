...
Procurando a página principal da ajuda? Consulte [Aprendizagem e suporte da Experience Cloud](https://helpx.adobe.com/br/support/experience-cloud.html).
...
| -----------| ---------- | ---------- |
| Atualizar para rótulos de dimensão "Mês" e "Trimestre" | 26 de novembro de 2019 | Em 16 de janeiro de 2020, os rótulos de dimensão Mês e Trimestre serão atualizadas para refletir o ano civil padrão. As configurações do calendário personalizado (definidas em **[!UICONTROL Admin &gt; Conjunto de relatórios &gt; Editar configurações &gt; Geral)** continuarão a determinar quais meses são retornados em um relatório.<br>Por exemplo, se seu calendário personalizado para 2020 estiver definido como outubro de 2019-setembro de 2020, os meses e trimestres serão exibidos da seguinte maneira no relatório:<ul><li>Trimestres - outubro de 2019-dezembro de 2019, janeiro de 2020-março de 2020, abril de 2020-junho de 2020, julho de 2020-setembro de 2020</li><li>Meses - outubro de 2019, novembro de 2019, dezembro de 2019, janeiro de 2020, fevereiro de 2020, etc.</li><li>Anteriormente, todos os itens acima refletiam o ano de 2019, o que causou confusão para os usuários finais.</li></ul>Se você tiver filtros de relatório ou segmentos que estão procurando por esses valores, não será necessário tomar providências. Eles serão atualizados para refletir a nova convenção de nomenclatura. |
| EOL (fim da vida útil) da opção **[!UICONTROL Impor restrições de logon de IP]** | 21 de novembro de 2019 | Anunciando a data de *outubro de 2020* para o fim da vida útil para a funcionalidade Lista de permissões do login de IP (**[!UICONTROL Impor restrições de login de IP]**) no menu **[!UICONTROL Admin &gt; Configurações da empresa &gt; Segurança]**. (Isso foi anunciado originalmente como ocorrendo em janeiro de 2020.) |
...
* [Notas de versão do Livefyre](https://docs.adobe.com/content/help/pt-BR/livefyre/using/release-notes/c-rn.translate.html)
...
* Adobe Campaign Classic: [Documentação](https://helpx.adobe.com/br/support/campaign/classic.html) - [Notas de versão](https://docs.campaign.adobe.com/doc/AC/br/RN.html) - [Vídeos explicativos](https://docs.adobe.com/content/help/en/campaign-learn/campaign-classic-tutorials/overview.html)
