...
| Recurso | Descrição |
| -----------| ---------- |
| Analysis Workspace - Melhorias na interface do usuário | Em 16 de janeiro de 2020, a Analysis Workspace começará a experimentar melhorias na interface do usuário que se estenderão por vários meses. O objetivo dessas alterações é tornar o aplicativo mais acessível para nossos usuários, bem como fornecer uma experiência mais consistente na Adobe Experience Cloud. |
