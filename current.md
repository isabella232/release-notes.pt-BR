...
>[!NOTE]
>
>Assine a [[!DNL Atualização de produto prioritária da Adobe]](https://www.adobe.com/subscription/priority-product-update.html) para ser notificado por email sobre versões futuras. Você receberá um aviso três a cinco dias úteis antes do lançamento da versão. Novas informações publicadas após o lançamento serão marcadas com a data da publicação.
...
* [!DNL Primetime](https://helpx.adobe.com/br/support/primetime.html) (links para a ajuda da solução)
...
Para obter a documentação do produto, consulte [Experience Cloud](https://docs.adobe.com/content/help/pt-BR/core-services/interface/experience-cloud.html).
...
Consulte [Notas de versão do AppMeasurement para Javascript](https://docs.adobe.com/content/help/pt-BR/analytics/implementation/appmeasurement-release-notes/c-release-notes-mjs.html).
...
* [Configuração do AEM para o Adobe Asset Link de pré-lançamento](https://helpx.adobe.com/br/enterprise/using/configure-aem-for-aal-prerelease.html)
...
Saiba como atualizar um certificado depois que ele expirar [aqui](https://helpx.adobe.com/br/experience-manager/6-5/assets/using/config-smart-tagging.html#Obtainpubliccertificate).

**Guia do usuário do AEM 6.5 Screens**

Agora está disponível uma nova documentação sobre as _Diretrizes de implantação de rede_. Consulte o [Guia do usuário](https://helpx.adobe.com/br/experience-manager/6-5/screens/user-guide.html).

**Serviço de conversão de formulários automatizado**

A documentação do serviço de conversão automatizada dos formulários do AEM Forms agora está disponível. Consulte [Introdução ao serviço de conversão automatizada de formulários](https://helpx.adobe.com/br/experience-manager/Automated-Forms-Conversion-Service/introduction-to-automated-form-conversion-service.html).
...
* [Tela inicial de ajuda do Dynamic Media Classic](https://docs.adobe.com/content/help/en/dynamic-media-classic/using/home.html)
...
O [!DNL Digital Publishing Suite Classic] (DPSC) será encerrado em 31 de agosto de 2019. Para obter mais informações, consulte as [perguntas frequentes sobre o fim de vida do [!DNL Digital Publishing Suite Classic]](https://helpx.adobe.com/br/digital-publishing-suite/help/eol-statement-for-dpsc.html).
...
* [Campaign Classic atualização 19.1.4](https://docs.campaign.adobe.com/doc/AC/pt/RN.html#9032) – build 9032
* [Campaign Classic atualização 19.1.5](https://docs.campaign.adobe.com/doc/AC/pt/RN.html#9033) – build 9033

### [!UICONTROL Painel de controle] do Adobe Campaign

Adicionamos novos recursos para administradores incluírem endereços de IP na lista de permissões para que acessem ocorrências do Campaign Classic.
Além disso, os administradores agora podem exibir a lista de ocorrências e qualificação para atualizações de compilação. Para saber mais, consulte a [documentação específica](https://helpx.adobe.com/br/campaign/kb/control-panel-instance-settings.html).
...
* Adobe Campaign Standard: [Documentação](https://helpx.adobe.com/br/support/campaign/standard.html) - [Notas de versão](https://docs.adobe.com/content/help/pt-BR/campaign-standard/using/release-notes/release-notes.html) - [Tutoriais em vídeo](https://docs.adobe.com/content/help/en/campaign-learn/campaign-standard-tutorials/overview.html)
* Adobe Campaign Classic: [Documentação](https://helpx.adobe.com/br/support/campaign/classic.html) - [Notas de versão](https://docs.campaign.adobe.com/doc/AC/br/RN.html) - [Tutoriais em vídeo](https://docs.adobe.com/content/help/en/campaign-learn/campaign-classic-tutorials/overview.html)
