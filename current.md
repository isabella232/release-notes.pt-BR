...
| 2 de novembro de 2020 | [Configurar e relatar públicos-alvo preditivos](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/build-and-manage-audiences/algorithmic-models/configure-and-report-on-predictive-audiences.html?lang=pt-BR#build-and-manage-audiences) | Vídeo | Neste vídeo, abordamos a configuração de Públicos-alvo preditivos na interface do Audience Manager. Também veremos os relatórios que mostram os resultados do modelo. |
