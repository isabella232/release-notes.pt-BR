...
Usando sua Adobe ID, você pode assinar notificações de eventos de status, com base nos produtos, na região e nas preferências do evento.

| Recurso | Descrição |
| -----------| ---------- |
| Assinar notificações por email em tempo real | <ul><li>Suporte para Experience Cloud, Creative Cloud, Document Cloud, AEP e Adobe Services</li><li>Suporte para preferências de região e tipo de evento</li><li>Suporte UX para superfícies da Web, móveis e tablets</li></ul> |
